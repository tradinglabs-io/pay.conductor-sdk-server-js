...
public class BoletoExpirationInDays extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(BoletoExpirationInDays.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!BoletoExpirationInDays.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'BoletoExpirationInDays' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<Integer> adapterInteger = gson.getDelegateAdapter(this, TypeToken.get(Integer.class));

            return (TypeAdapter<T>) new TypeAdapter<BoletoExpirationInDays>() {
                @Override
                public void write(JsonWriter out, BoletoExpirationInDays value) throws IOException {
                ...
                @Override
                public BoletoExpirationInDays read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        BoletoExpirationInDays ret = new BoletoExpirationInDays();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for BoletoExpirationInDays: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public BoletoExpirationInDays() {
        super("anyOf", Boolean.FALSE);
    }

    public BoletoExpirationInDays(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return BoletoExpirationInDays.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to BoletoExpirationInDays
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for BoletoExpirationInDays with anyOf schemas: Integer. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of BoletoExpirationInDays given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of BoletoExpirationInDays
     * @throws IOException if the JSON string is invalid with respect to BoletoExpirationInDays
     */
    public static BoletoExpirationInDays fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, BoletoExpirationInDays.class);
    }

    /**
     * Convert an instance of BoletoExpirationInDays to an JSON string
     *
     * @return JSON string
     */
