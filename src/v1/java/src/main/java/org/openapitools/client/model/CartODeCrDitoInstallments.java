...
public class CartODeCrDitoInstallments extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CartODeCrDitoInstallments.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CartODeCrDitoInstallments.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CartODeCrDitoInstallments' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<Integer> adapterInteger = gson.getDelegateAdapter(this, TypeToken.get(Integer.class));

            return (TypeAdapter<T>) new TypeAdapter<CartODeCrDitoInstallments>() {
                @Override
                public void write(JsonWriter out, CartODeCrDitoInstallments value) throws IOException {
                ...
                @Override
                public CartODeCrDitoInstallments read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        CartODeCrDitoInstallments ret = new CartODeCrDitoInstallments();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CartODeCrDitoInstallments: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CartODeCrDitoInstallments() {
        super("anyOf", Boolean.FALSE);
    }

    public CartODeCrDitoInstallments(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return CartODeCrDitoInstallments.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to CartODeCrDitoInstallments
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for CartODeCrDitoInstallments with anyOf schemas: Integer. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of CartODeCrDitoInstallments given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CartODeCrDitoInstallments
     * @throws IOException if the JSON string is invalid with respect to CartODeCrDitoInstallments
     */
    public static CartODeCrDitoInstallments fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CartODeCrDitoInstallments.class);
    }

    /**
     * Convert an instance of CartODeCrDitoInstallments to an JSON string
     *
     * @return JSON string
     */
