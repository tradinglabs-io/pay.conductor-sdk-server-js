...
class MerchantInput(BaseModel):
    ...
    """ # noqa: E501
    document: Annotated[str, Field(strict=True)] = Field(description="CPF ou CNPJ do merchant sem formatação")
    email: StrictStr = Field(description="Email do merchant")
    name: Annotated[str, Field(min_length=2, strict=True, max_length=255)] = Field(description="Nome do merchant")
    __properties: ClassVar[List[str]] = ["document", "email", "name"]

    @field_validator('document')
    def document_validate_regular_expression(cls, value):
