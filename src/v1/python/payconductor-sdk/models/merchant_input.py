...
class MerchantInput(BaseModel):
    ...
    """ # noqa: E501
    document: Annotated[str, Field(strict=True)] = Field(description="Merchant CPF or CNPJ without formatting")
    email: StrictStr = Field(description="Merchant email")
    name: Annotated[str, Field(min_length=2, strict=True, max_length=255)] = Field(description="Merchant name")
