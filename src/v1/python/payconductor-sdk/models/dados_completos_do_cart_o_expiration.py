...
class DadosCompletosDoCartOExpiration(BaseModel):
    """
    DadosCompletosDoCartOExpiration
    """ # noqa: E501
    month: Union[Annotated[float, Field(le=12, strict=True, ge=1)], Annotated[int, Field(le=12, strict=True, ge=1)]] = Field(description="Mês de expiração do cartão")
    year: Union[Annotated[float, Field(le=2046, strict=True, ge=2025)], Annotated[int, Field(le=2046, strict=True, ge=2025)]] = Field(description="Ano de expiração do cartão")
