...
class PostOrders200ResponseOrderItemsInner(BaseModel):
    ...
    """ # noqa: E501
    external_id: Optional[StrictStr] = Field(description="ID externo do item", alias="externalId")
    id: StrictStr = Field(description="ID do item no pedido")
    name: StrictStr = Field(description="Nome do produto/serviço")
    qty: Union[StrictFloat, StrictInt] = Field(description="Quantidade")
    total_amount: Union[StrictFloat, StrictInt] = Field(description="Valor total do item (quantidade × preço unitário)", alias="totalAmount")
    total_net_amount: Union[StrictFloat, StrictInt] = Field(description="Valor líquido total do item", alias="totalNetAmount")
    unity_price: Union[StrictFloat, StrictInt] = Field(description="Preço unitário", alias="unityPrice")
