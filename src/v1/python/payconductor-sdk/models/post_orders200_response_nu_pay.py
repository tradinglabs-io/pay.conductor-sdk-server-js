...
class PostOrders200ResponseNuPay(BaseModel):
    """
    PostOrders200ResponseNuPay
    """ # noqa: E501
    payment_url: StrictStr = Field(description="URL de pagamento NuPay", alias="paymentUrl")
    __properties: ClassVar[List[str]] = ["paymentUrl"]
