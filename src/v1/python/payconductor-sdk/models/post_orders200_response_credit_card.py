...
class PostOrders200ResponseCreditCard(BaseModel):
    """
    PostOrders200ResponseCreditCard
    """ # noqa: E501
    authorization_code: Optional[StrictStr] = Field(default=None, description="Código de autorização da transação", alias="authorizationCode")
    __properties: ClassVar[List[str]] = ["authorizationCode"]
