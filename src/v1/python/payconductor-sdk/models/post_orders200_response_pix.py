...
class PostOrders200ResponsePix(BaseModel):
    ...
    PIX data
    """ # noqa: E501
    copy_and_paste_code: StrictStr = Field(description="PIX copy and paste code", alias="copyAndPasteCode")
    qr_code_url: StrictStr = Field(description="PIX QR Code image URL", alias="qrCodeUrl")
    end_to_end_id: Optional[StrictStr] = Field(description="PIX E2E ID", alias="endToEndId")
