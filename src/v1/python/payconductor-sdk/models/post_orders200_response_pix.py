...
class PostOrders200ResponsePix(BaseModel):
    """
    Dados do PIX
    """ # noqa: E501
    copy_and_paste_code: StrictStr = Field(description="Código copia e cola do PIX", alias="copyAndPasteCode")
    qr_code_url: StrictStr = Field(description="URL da imagem do QR Code PIX", alias="qrCodeUrl")
    end_to_end_id: Optional[StrictStr] = Field(description="E2E ID do PIX", alias="endToEndId")
    __properties: ClassVar[List[str]] = ["copyAndPasteCode", "qrCodeUrl", "endToEndId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "copyAndPasteCode": obj.get("copyAndPasteCode"),
