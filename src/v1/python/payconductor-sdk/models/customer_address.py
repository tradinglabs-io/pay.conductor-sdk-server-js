...
class CustomerAddress(BaseModel):
    ...
    country: Annotated[str, Field(min_length=2, strict=True, max_length=2)] = Field(description="Country code in ISO 3166-1 alpha-2 format")
    neighborhood: StrictStr = Field(description="Neighborhood name")
    number: StrictStr = Field(description="Address number")
    state: Annotated[str, Field(min_length=2, strict=True, max_length=2)] = Field(description="State code in ISO 3166-2 format")
