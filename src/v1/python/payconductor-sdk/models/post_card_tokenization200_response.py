...
class PostCardTokenization200Response(BaseModel):
    """
    PostCardTokenization200Response
    """ # noqa: E501
    customer_id: StrictStr = Field(description="ID of the customer associated with the created card", alias="customerId")
    token: StrictStr = Field(description="Token of the created card for future transactions")
    __properties: ClassVar[List[str]] = ["customerId", "token"]
