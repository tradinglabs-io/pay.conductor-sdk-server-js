...
class CartOTokenizado(BaseModel):
    """
    CartOTokenizado
    """ # noqa: E501
    first_six_card_number: Optional[StrictStr] = Field(default=None, description="Primeiros 6 dígitos do cartão de crédito", alias="firstSixCardNumber")
    token: StrictStr = Field(description="Token do cartão de crédito gerado anteriormente")
