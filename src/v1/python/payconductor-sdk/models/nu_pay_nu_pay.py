...
class NuPayNuPay(BaseModel):
    """
    Dados específicos para pagamento via NuPay
    """ # noqa: E501
    cancel_url: StrictStr = Field(description="URL de cancelamento do pagamento", alias="cancelUrl")
    merchant_name: StrictStr = Field(description="Nome do comerciante", alias="merchantName")
    return_url: StrictStr = Field(description="URL de retorno após a conclusão do pagamento", alias="returnUrl")
    store_name: Optional[StrictStr] = Field(default=None, description="Nome da loja", alias="storeName")
    __properties: ClassVar[List[str]] = ["cancelUrl", "merchantName", "returnUrl", "storeName"]
