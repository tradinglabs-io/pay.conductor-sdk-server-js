...
class PostOrders200ResponsePicPay(BaseModel):
    """
    PostOrders200ResponsePicPay
    """ # noqa: E501
    copy_and_paste_code: StrictStr = Field(description="Código copia e cola do PicPay", alias="copyAndPasteCode")
    qr_code_url: StrictStr = Field(description="URL da imagem do QR Code PicPay", alias="qrCodeUrl")
    __properties: ClassVar[List[str]] = ["copyAndPasteCode", "qrCodeUrl"]
