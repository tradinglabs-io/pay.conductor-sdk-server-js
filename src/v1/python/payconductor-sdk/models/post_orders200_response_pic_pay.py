...
class PostOrders200ResponsePicPay(BaseModel):
    ...
    """ # noqa: E501
    copy_and_paste_code: StrictStr = Field(description="PicPay copy and paste code", alias="copyAndPasteCode")
    qr_code_url: StrictStr = Field(description="PicPay QR Code image URL", alias="qrCodeUrl")
