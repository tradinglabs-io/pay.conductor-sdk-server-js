...
class EndereODoCliente(BaseModel):
    """
    Schema para criação de um novo endereço
    """ # noqa: E501
    city: StrictStr = Field(description="Nome da cidade")
    country: Annotated[str, Field(min_length=2, strict=True, max_length=2)] = Field(description="Código do país no formato ISO 3166-1 alpha-2")
    neighborhood: StrictStr = Field(description="Nome do bairro")
    number: StrictStr = Field(description="Número do endereço")
    state: Annotated[str, Field(min_length=2, strict=True, max_length=2)] = Field(description="Código do estado no formato ISO 3166-2")
    street: StrictStr = Field(description="Nome da rua")
    zip_code: StrictStr = Field(description="CEP sem formatação", alias="zipCode")
    __properties: ClassVar[List[str]] = ["city", "country", "neighborhood", "number", "state", "street", "zipCode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "city": obj.get("city"),
            "country": obj.get("country") if obj.get("country") is not None else 'BR',
