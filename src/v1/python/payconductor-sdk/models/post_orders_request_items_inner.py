...
class PostOrdersRequestItemsInner(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Product or service ID in your system")
    is_physical: StrictBool = Field(description="Defines if the item is a physical product or a service", alias="isPhysical")
    name: StrictStr = Field(description="Product or service name")
    qty: Union[StrictFloat, StrictInt] = Field(description="Quantity of the product or service")
