...
class CompleteCardDataExpiration(BaseModel):
    """
    CompleteCardDataExpiration
    """ # noqa: E501
    month: Union[Annotated[float, Field(le=12, strict=True, ge=1)], Annotated[int, Field(le=12, strict=True, ge=1)]] = Field(description="Card expiration month")
    year: Union[Annotated[float, Field(le=2046, strict=True, ge=2025)], Annotated[int, Field(le=2046, strict=True, ge=2025)]] = Field(description="Card expiration year")
