...
class PostOrdersRequestFingerprints(BaseModel):
    """
    PostOrdersRequestFingerprints
    """ # noqa: E501
    threat_metrix_fingerprint_id: Optional[StrictStr] = Field(default=None, description="ID de fingerprint do ThreatMetrix para análise de fraude", alias="threatMetrixFingerprintId")
    __properties: ClassVar[List[str]] = ["threatMetrixFingerprintId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "threatMetrixFingerprintId": obj.get("threatMetrixFingerprintId")
        })
        return _obj
