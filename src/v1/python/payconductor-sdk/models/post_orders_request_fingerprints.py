...
class PostOrdersRequestFingerprints(BaseModel):
    ...
    """ # noqa: E501
    threat_metrix_fingerprint_id: Optional[StrictStr] = Field(default=None, description="ThreatMetrix fingerprint ID for fraud analysis", alias="threatMetrixFingerprintId")
