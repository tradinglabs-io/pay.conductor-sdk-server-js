...
class PostOrders200ResponseSession(BaseModel):
    """
    PostOrders200ResponseSession
    """ # noqa: E501
    session_id: StrictStr = Field(description="ID of the checkout session associated with the order", alias="sessionId")
