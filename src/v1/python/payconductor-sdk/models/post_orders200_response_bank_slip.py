...
class PostOrders200ResponseBankSlip(BaseModel):
    ...
    """ # noqa: E501
    bar_code: StrictStr = Field(description="Bank slip bar code", alias="barCode")
    digitable_line: StrictStr = Field(description="Bank slip digitable line", alias="digitableLine")
    pdf_url: Optional[StrictStr] = Field(default=None, description="Bank slip PDF URL", alias="pdfUrl")
