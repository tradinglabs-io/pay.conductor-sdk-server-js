...
class PostOrders200ResponseBankSlip(BaseModel):
    """
    PostOrders200ResponseBankSlip
    """ # noqa: E501
    bar_code: StrictStr = Field(description="Código de barras do boleto", alias="barCode")
    digitable_line: StrictStr = Field(description="Linha digitável do boleto", alias="digitableLine")
    pdf_url: Optional[StrictStr] = Field(default=None, description="URL do PDF do boleto", alias="pdfUrl")
    __properties: ClassVar[List[str]] = ["barCode", "digitableLine", "pdfUrl"]
