...
from payconductor-sdk.configuration import Configuration
from payconductor-sdk.api_response import ApiResponse, T as ApiResponseT
import payconductor-sdk.models
from payconductor-sdk import rest
from payconductor-sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(payconductor-sdk.models, klass)
