...
from payconductor-sdk.api.withdrawals_and_transfers_api import WithdrawalsAndTransfersApi


class TestWithdrawalsAndTransfersApi(unittest.TestCase):
    """WithdrawalsAndTransfersApi unit test stubs"""

    def setUp(self) -> None:
        self.api = WithdrawalsAndTransfersApi()
