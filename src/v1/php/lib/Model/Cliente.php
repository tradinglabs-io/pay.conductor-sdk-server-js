 ...
 */
class Cliente implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cliente';
    ...
    protected static $openAPITypes = [
        'address' => '\OpenAPI\Client\Model\EndereODoCliente',
    ...
    */
     ...
     * Gets address
     *
     * @return \OpenAPI\Client\Model\EndereODoCliente|null
     */
     ...
     * Sets address
     *
     * @param \OpenAPI\Client\Model\EndereODoCliente|null $address address
     *
     * @return self
     */
     ...
     *
     * @param string $document_number CPF ou CNPJ do cliente sem formatação
     *
     * @return self
     */
    public function setDocumentNumber($document_number)
    {
        ...
        if ((!preg_match("/^\\d{11}$|^\\d{14}$/", ObjectSerializer::toString($document_number)))) {
            throw new \InvalidArgumentException("invalid value for \$document_number when calling Cliente., must conform to the pattern /^\\d{11}$|^\\d{14}$/.");
        }
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number Número de telefone do cliente no formato +55 DD 9XXXXXXXX
     *
     * @return self
     */
    public function setPhoneNumber($phone_number)
    {
        ...
        if ((!preg_match("/^\\+(\\d{1,2}) (\\d{2}) (\\d{8,9})$/", ObjectSerializer::toString($phone_number)))) {
            throw new \InvalidArgumentException("invalid value for \$phone_number when calling Cliente., must conform to the pattern /^\\+(\\d{1,2}) (\\d{2}) (\\d{8,9})$/.");
        }
