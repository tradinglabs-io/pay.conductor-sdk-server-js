...
/**
 * DadosCompletosDoCartO Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DadosCompletosDoCartO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Dados_completos_do_cart_o';
    ...
    */
    ...
    public function setCvv($cvv)
    {
        ...
        if ((mb_strlen($cvv) > 4)) {
            throw new \InvalidArgumentException('invalid length for $cvv when calling DadosCompletosDoCartO., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($cvv) < 3)) {
            throw new \InvalidArgumentException('invalid length for $cvv when calling DadosCompletosDoCartO., must be bigger than or equal to 3.');
        }
