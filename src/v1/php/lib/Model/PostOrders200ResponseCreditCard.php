...
/**
 * PostOrders200ResponseCreditCard Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostOrders200ResponseCreditCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postOrders_200_response_creditCard';
    ...
    */
     ...
     *
     * @param string|null $authorization_code Código de autorização da transação
     *
     * @return self
     */
