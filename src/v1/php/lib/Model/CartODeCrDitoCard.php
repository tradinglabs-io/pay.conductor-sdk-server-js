...
/**
 * CartODeCrDitoCard Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CartODeCrDitoCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cart_o_de_cr_dito_card';
    ...
    protected static $openAPITypes = [
        ...
        'token' => 'string',
        'cvv' => 'string',
        'expiration' => '\OpenAPI\Client\Model\DadosCompletosDoCartOExpiration',
        'holder_name' => 'string',
        'number' => 'string'
    ];
    ...
    */
     ...
     *
     * @param string|null $first_six_card_number Primeiros 6 dígitos do cartão de crédito
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string $token Token do cartão de crédito gerado anteriormente
     *
     * @return self
     */
     ...
     * Sets cvv
     *
     * @param string $cvv Código de segurança do cartão (CVV)
     *
     * @return self
     */
    public function setCvv($cvv)
    {
        ...
        if ((mb_strlen($cvv) > 4)) {
            throw new \InvalidArgumentException('invalid length for $cvv when calling CartODeCrDitoCard., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($cvv) < 3)) {
            throw new \InvalidArgumentException('invalid length for $cvv when calling CartODeCrDitoCard., must be bigger than or equal to 3.');
        }
     ...
     * Gets expiration
     *
     * @return \OpenAPI\Client\Model\DadosCompletosDoCartOExpiration
     */
     ...
     * Sets expiration
     *
     * @param \OpenAPI\Client\Model\DadosCompletosDoCartOExpiration $expiration expiration
     *
     * @return self
     */
     ...
     * Sets holder_name
     *
     * @param string $holder_name Nome do titular do cartão
     *
     * @return self
     */
