 ...
 *
 * @category Class
 * @description Caso o externalSessionId ou sessionId sejam fornecidos e houver uma sessão existente, ela será atualizada com os novos dados. Caso contrário, uma nova sessão será criada.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class PostOrdersRequestSession implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param float|null $expires_in_minutes Tempo em minutos para expiração da sessão do checkout
     *
     * @return self
     */
     ...
     * Sets checkout_url
     *
     * @param string|null $checkout_url URL do checkout para que possamos redirecionar
     *
     * @return self
     */
     ...
     * Sets session_id
     *
     * @param string|null $session_id Id gerado pelo nosso serviço para identificar a sessão de checkout
     *
     * @return self
     */
     ...
     *
     * @param string|null $external_session_id Id da sessão de checkout gerado pelo lado do cliente. O id deve ser único para cada sessão de carrinho
     *
     * @return self
     */
