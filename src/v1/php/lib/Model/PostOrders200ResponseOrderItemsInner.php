...
class PostOrders200ResponseOrderItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets external_id
     *
     * @param string|null $external_id ID externo do item
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id ID do item no pedido
     *
     * @return self
     */
     ...
     * Sets total_amount
     *
     * @param float $total_amount Valor total do item (quantidade × preço unitário)
     *
     * @return self
     */
     ...
     *
     * @param float $total_net_amount Valor líquido total do item
     *
     * @return self
     */
     ...
     * Sets unity_price
     *
     * @param float $unity_price Preço unitário
     *
     * @return self
     */
