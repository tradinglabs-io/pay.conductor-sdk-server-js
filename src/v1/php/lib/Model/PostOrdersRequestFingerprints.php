...
/**
 * PostOrdersRequestFingerprints Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostOrdersRequestFingerprints implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postOrders_request_fingerprints';
    ...
    */
     ...
     *
     * @param string|null $threat_metrix_fingerprint_id ID de fingerprint do ThreatMetrix para análise de fraude
     *
     * @return self
     */
