...
class PostOrders200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string $id ID do pedido no sistema
     *
     * @return self
     */
     ...
     * Sets external_id
     *
     * @param string|null $external_id ID externo do pedido (fornecido pela sua integração)
     *
     * @return self
     */
     ...
     *
     * @param string $external_integration_key Provedor utilizada para processar o pedido
     *
     * @return self
     */
     ...
     *
     * @param string|null $external_integration_id ID do pedido no provedor de pagamento
     *
     * @return self
     */
     ...
     * Sets cost_fee
     *
     * @param float $cost_fee Taxa de custo aplicada ao pedido
     *
     * @return self
     */
     ...
     * Sets payed_at
     *
     * @param string|null $payed_at Data e hora em que o pedido foi pago (ISO 8601)
     *
     * @return self
     */
     ...
     * Sets error_code
     *
     * @param string|null $error_code Código de erro, se houver
     *
     * @return self
     */
     ...
     * Sets error_message
     *
     * @param string|null $error_message Mensagem de erro, se houver
     *
     * @return self
     */
