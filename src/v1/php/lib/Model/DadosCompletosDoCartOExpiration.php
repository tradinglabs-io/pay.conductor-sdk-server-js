...
/**
 * DadosCompletosDoCartOExpiration Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DadosCompletosDoCartOExpiration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Dados_completos_do_cart_o_expiration';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['year'] > 2046)) {
            $invalidProperties[] = "invalid value for 'year', must be smaller than or equal to 2046.";
        }

        if (($this->container['year'] < 2025)) {
            $invalidProperties[] = "invalid value for 'year', must be bigger than or equal to 2025.";
        }
     ...
     * Sets month
     *
     * @param float $month Mês de expiração do cartão
     *
     * @return self
     */
    public function setMonth($month)
    {
        ...
        if (($month > 12)) {
            throw new \InvalidArgumentException('invalid value for $month when calling DadosCompletosDoCartOExpiration., must be smaller than or equal to 12.');
        }
        if (($month < 1)) {
            throw new \InvalidArgumentException('invalid value for $month when calling DadosCompletosDoCartOExpiration., must be bigger than or equal to 1.');
        }
     ...
     * Sets year
     *
     * @param float $year Ano de expiração do cartão
     *
     * @return self
     */
    public function setYear($year)
    {
        ...
        if (($year > 2046)) {
            throw new \InvalidArgumentException('invalid value for $year when calling DadosCompletosDoCartOExpiration., must be smaller than or equal to 2046.');
        }
        if (($year < 2025)) {
            throw new \InvalidArgumentException('invalid value for $year when calling DadosCompletosDoCartOExpiration., must be bigger than or equal to 2025.');
        }
