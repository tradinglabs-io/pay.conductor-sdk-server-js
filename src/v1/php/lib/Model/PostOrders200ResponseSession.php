...
/**
 * PostOrders200ResponseSession Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostOrders200ResponseSession implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postOrders_200_response_session';
    ...
    */
     ...
     * Sets session_id
     *
     * @param string $session_id ID of the checkout session associated with the order
     *
     * @return self
     */
