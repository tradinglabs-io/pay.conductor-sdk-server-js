...
/**
 * CartODeCrDito Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CartODeCrDito implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cart_o_de_cr_dito';
    ...
    */
    ...
    public function setSoftDescriptor($soft_descriptor)
    {
        ...
        if ((mb_strlen($soft_descriptor) > 22)) {
            throw new \InvalidArgumentException('invalid length for $soft_descriptor when calling CartODeCrDito., must be smaller than or equal to 22.');
        }
        if ((mb_strlen($soft_descriptor) < 1)) {
            throw new \InvalidArgumentException('invalid length for $soft_descriptor when calling CartODeCrDito., must be bigger than or equal to 1.');
        }
