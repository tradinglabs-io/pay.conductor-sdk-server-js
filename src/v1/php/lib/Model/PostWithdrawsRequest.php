...
/**
 * PostWithdrawsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostWithdrawsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postWithdraws_request';
    ...
    protected static $openAPITypes = [
        ...
        'payout_account' => '\OpenAPI\Client\Model\PostWithdrawsRequestPayoutAccount'
    ];
    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling PostWithdrawsRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets payout_account
     *
     * @return \OpenAPI\Client\Model\PostWithdrawsRequestPayoutAccount
     */
     ...
     * Sets payout_account
     *
     * @param \OpenAPI\Client\Model\PostWithdrawsRequestPayoutAccount $payout_account payout_account
     *
     * @return self
     */
