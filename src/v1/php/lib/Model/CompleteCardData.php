...
/**
 * CompleteCardData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CompleteCardData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Complete_card_data';
    ...
    */
    ...
    public function setCvv($cvv)
    {
        ...
        if ((mb_strlen($cvv) > 4)) {
            throw new \InvalidArgumentException('invalid length for $cvv when calling CompleteCardData., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($cvv) < 3)) {
            throw new \InvalidArgumentException('invalid length for $cvv when calling CompleteCardData., must be bigger than or equal to 3.');
        }
