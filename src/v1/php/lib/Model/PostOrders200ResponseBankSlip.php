...
/**
 * PostOrders200ResponseBankSlip Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostOrders200ResponseBankSlip implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postOrders_200_response_bankSlip';
    ...
    protected static $setters = [
        'bar_code' => 'setBarCode',
        'digitable_line' => 'setDigitableLine',
        'pdf_url' => 'setPdfUrl'
    ];
    ...
    protected static $getters = [
        'bar_code' => 'getBarCode',
        'digitable_line' => 'getDigitableLine',
        'pdf_url' => 'getPdfUrl'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('digitable_line', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bar_code'] === null) {
            $invalidProperties[] = "'bar_code' can't be null";
        }
        if ($this->container['digitable_line'] === null) {
            $invalidProperties[] = "'digitable_line' can't be null";
        }
     ...
     * Sets bar_code
     *
     * @param string $bar_code Código de barras do boleto
     *
     * @return self
     */
    ...
    {
        return $this->container['digitable_line'];
    }

    /**
     * Sets digitable_line
     *
     * @param string $digitable_line Linha digitável do boleto
     *
     * @return self
     */
    public function setDigitableLine($digitable_line)
    {
        if (is_null($digitable_line)) {
            throw new \InvalidArgumentException('non-nullable digitable_line cannot be null');
        }
        $this->container['digitable_line'] = $digitable_line;
     ...
     * Sets pdf_url
     *
     * @param string|null $pdf_url URL do PDF do boleto
     *
     * @return self
     */
