...
class PostWithdraws200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Identificador único do saque
     *
     * @return self
     */
     ...
     * Sets external_id
     *
     * @param string|null $external_id ID do saque no sistema no seu sistema
     *
     * @return self
     */
     ...
     *
     * @param string $external_integration_key Chave do provedor utilizado para o saque
     *
     * @return self
     */
     ...
     *
     * @param string|null $external_integration_id ID do saque no provedor de pagamento
     *
     * @return self
     */
     ...
     * Sets cost_fee
     *
     * @param float $cost_fee Taxa de custo aplicada ao saque
     *
     * @return self
     */
     ...
     * Sets error_code
     *
     * @param string|null $error_code Código do erro, se houver
     *
     * @return self
     */
     ...
     * Sets error_message
     *
     * @param string|null $error_message Mensagem descritiva do erro, se houver
     *
     * @return self
     */
