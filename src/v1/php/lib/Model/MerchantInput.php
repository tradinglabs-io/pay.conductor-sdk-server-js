...
class MerchantInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets document
     *
     * @param string $document CPF ou CNPJ do merchant sem formatação
     *
     * @return self
     */
     ...
     * Sets email
     *
     * @param string $email Email do merchant
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Nome do merchant
     *
     * @return self
     */
