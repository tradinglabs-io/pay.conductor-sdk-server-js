...
class PostOrdersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'charge_amount' => 'float',
        'client_ip' => 'string',
        'customer' => '\OpenAPI\Client\Model\Cliente',
    ...
    */
     ...
     * Sets charge_amount
     *
     * @param float $charge_amount Valor total a ser cobrado no pedido em valor flutuante
     *
     * @return self
     */
     ...
     * Sets client_ip
     *
     * @param string $client_ip Endereço IP do cliente
     *
     * @return self
     */
     ...
     * Gets customer
     *
     * @return \OpenAPI\Client\Model\Cliente
     */
     ...
     * Sets customer
     *
     * @param \OpenAPI\Client\Model\Cliente $customer customer
     *
     * @return self
     */
     ...
     * Sets external_id
     *
     * @param string $external_id ID da ordem no seu sistema
     *
     * @return self
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\PostOrdersRequestItemsInner[]|null $items Lista de produtos ou serviços do pedido
     *
     * @return self
     */
     ...
     *
     * @param float|null $split_amount_total Valor total do split a ser pago ao merchant (Sendo usado apenas para fins de relatório, ou seja não gera split real)
     *
     * @return self
     */
     ...
     * Sets shipping_fee
     *
     * @param float $shipping_fee Valor do frete
     *
     * @return self
     */
     ...
     * Sets tax_fee
     *
     * @param float $tax_fee Taxas adicionais
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param object|null $metadata Metadados adicionais para o pedido como pares chave-valor. Não deve ter espaços ou caracteres especiais nas chaves
     *
     * @return self
     */
