...
/**
 * CompleteCardDataExpiration Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CompleteCardDataExpiration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Complete_card_data_expiration';
    ...
    */
     ...
     * Sets month
     *
     * @param float $month Card expiration month
     *
     * @return self
     */
    public function setMonth($month)
    {
        ...
        if (($month > 12)) {
            throw new \InvalidArgumentException('invalid value for $month when calling CompleteCardDataExpiration., must be smaller than or equal to 12.');
        }
        if (($month < 1)) {
            throw new \InvalidArgumentException('invalid value for $month when calling CompleteCardDataExpiration., must be bigger than or equal to 1.');
        }
     ...
     * Sets year
     *
     * @param float $year Card expiration year
     *
     * @return self
     */
    public function setYear($year)
    {
        ...
        if (($year > 2046)) {
            throw new \InvalidArgumentException('invalid value for $year when calling CompleteCardDataExpiration., must be smaller than or equal to 2046.');
        }
        if (($year < 2025)) {
            throw new \InvalidArgumentException('invalid value for $year when calling CompleteCardDataExpiration., must be bigger than or equal to 2025.');
        }
