...
#'
#' @docType class
#' @title SaquesETransferncias operations
#' @description SaquesETransfernciasApi
...
#' @export
SaquesETransfernciasApi <- R6::R6Class(
  "SaquesETransfernciasApi",
  public = list(
    api_client = NULL,

    #' @description
    #' Initialize a new SaquesETransfernciasApi.
    #'
    ...
    GetWithdrawsWithHttpInfo = function(period, page, page_size, end_date = NULL, start_date = NULL, id = NULL, ...) {
      ...
      if (!missing(`period`) && is.null(`period`)) {
        stop("Invalid value for `period` when calling SaquesETransfernciasApi$GetWithdraws, `period` is not nullable")
      }

      if (!missing(`page`) && is.null(`page`)) {
        stop("Invalid value for `page` when calling SaquesETransfernciasApi$GetWithdraws, `page` is not nullable")
      }
      if (!is.null(`page`) && `page` <  1) {
        stop("Invalid value for `page` when calling SaquesETransfernciasApi$GetWithdraws, must be bigger than or equal to 1.")
      }

      if (!missing(`page_size`) && is.null(`page_size`)) {
        stop("Invalid value for `page_size` when calling SaquesETransfernciasApi$GetWithdraws, `page_size` is not nullable")
      }
      if (!is.null(`page_size`) && `page_size` >  100) {
        stop("Invalid value for `page_size` when calling SaquesETransfernciasApi$GetWithdraws, must be smaller than or equal to 100.")
      }
      if (!is.null(`page_size`) && `page_size` <  1) {
        stop("Invalid value for `page_size` when calling SaquesETransfernciasApi$GetWithdraws, must be bigger than or equal to 1.")
      }

      if (!missing(`end_date`) && is.null(`end_date`)) {
        stop("Invalid value for `end_date` when calling SaquesETransfernciasApi$GetWithdraws, `end_date` is not nullable")
      }

      if (!missing(`start_date`) && is.null(`start_date`)) {
        stop("Invalid value for `start_date` when calling SaquesETransfernciasApi$GetWithdraws, `start_date` is not nullable")
      }

      if (!missing(`id`) && is.null(`id`)) {
        stop("Invalid value for `id` when calling SaquesETransfernciasApi$GetWithdraws, `id` is not nullable")
      }

      if (!is.null(`period`) && !(`period` %in% c("Today", "Yesterday", "Last7Days", "Last30Days", "ThisMonth", "LastMonth", "ThisYear", "Custom"))) {
        stop("Invalid value for period when calling SaquesETransfernciasApi$GetWithdraws. Must be [Today, Yesterday, Last7Days, Last30Days, ThisMonth, LastMonth, ThisYear, Custom].")
      }
    ...
    GetWithdrawsByIdWithHttpInfo = function(id, ...) {
      ...
      if (!missing(`id`) && is.null(`id`)) {
        stop("Invalid value for `id` when calling SaquesETransfernciasApi$GetWithdrawsById, `id` is not nullable")
      }
    ...
    PostWithdrawsWithHttpInfo = function(post_withdraws_request, data_file = NULL, ..., .parse = TRUE) {
      ...
      if (!missing(`post_withdraws_request`) && is.null(`post_withdraws_request`)) {
        stop("Invalid value for `post_withdraws_request` when calling SaquesETransfernciasApi$PostWithdraws, `post_withdraws_request` is not nullable")
      }
