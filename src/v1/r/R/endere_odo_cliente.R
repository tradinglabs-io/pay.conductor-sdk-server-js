#' Create a new EndereODoCliente
#'
#' @description
#' Schema para criação de um novo endereço
#'
#' @docType class
#' @title EndereODoCliente
#' @description EndereODoCliente Class
#' @format An \code{R6Class} generator object
#' @field city Nome da cidade character
#' @field country Código do país no formato ISO 3166-1 alpha-2 character
#' @field neighborhood Nome do bairro character
#' @field number Número do endereço character
#' @field state Código do estado no formato ISO 3166-2 character
#' @field street Nome da rua character
#' @field zipCode CEP sem formatação character
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
EndereODoCliente <- R6::R6Class(
  "EndereODoCliente",
  public = list(
    `city` = NULL,
    `country` = NULL,
    ...
    #' @description
    #' Initialize a new EndereODoCliente class.
    #'
    ...
    #'
    #' @return EndereODoCliente as a base R list.
    #' @examples
    #' # convert array of EndereODoCliente (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert EndereODoCliente to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      EndereODoClienteObject <- list()
      if (!is.null(self$`city`)) {
        EndereODoClienteObject[["city"]] <-
          self$`city`
      }
      if (!is.null(self$`country`)) {
        EndereODoClienteObject[["country"]] <-
          self$`country`
      }
      if (!is.null(self$`neighborhood`)) {
        EndereODoClienteObject[["neighborhood"]] <-
          self$`neighborhood`
      }
      if (!is.null(self$`number`)) {
        EndereODoClienteObject[["number"]] <-
          self$`number`
      }
      if (!is.null(self$`state`)) {
        EndereODoClienteObject[["state"]] <-
          self$`state`
      }
      if (!is.null(self$`street`)) {
        EndereODoClienteObject[["street"]] <-
          self$`street`
      }
      if (!is.null(self$`zipCode`)) {
        EndereODoClienteObject[["zipCode"]] <-
          self$`zipCode`
      }
      return(EndereODoClienteObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of EndereODoCliente
    #'
    #' @param input_json the JSON input
    #' @return the instance of EndereODoCliente
    ...
    #' @return EndereODoCliente in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to EndereODoCliente and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`city`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for EndereODoCliente: the required field `city` is missing."))
      }
      ...
      if (!is.null(input_json$`country`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for EndereODoCliente: the required field `country` is missing."))
      }
      ...
      if (!is.null(input_json$`neighborhood`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for EndereODoCliente: the required field `neighborhood` is missing."))
      }
      ...
      if (!is.null(input_json$`number`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for EndereODoCliente: the required field `number` is missing."))
      }
      ...
      if (!is.null(input_json$`state`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for EndereODoCliente: the required field `state` is missing."))
      }
      ...
      if (!is.null(input_json$`street`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for EndereODoCliente: the required field `street` is missing."))
      }
      ...
      if (!is.null(input_json$`zipCode`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for EndereODoCliente: the required field `zipCode` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of EndereODoCliente
    toString = function() {
      self$toJSONString()
    },
...
# EndereODoCliente$unlock()
#
## Below is an example to define the print function
# EndereODoCliente$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# EndereODoCliente$lock()
