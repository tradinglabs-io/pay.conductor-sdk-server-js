...
#include "PedidosAPI.h"

#define MAX_NUMBER_LENGTH 16
#define MAX_BUFFER_LENGTH 4096
#define MAX_NUMBER_LENGTH_LONG 21

// Functions for enum PERIOD for PedidosAPI_getOrders
...
// Functions for enum STATUS for PedidosAPI_getOrders
...
//
void
PedidosAPI_getOrders(apiClient_t *apiClient, payconductor_api_getOrders_period_e period, double page, double pageSize, char endDate, char startDate, char *id, payconductor_api_getOrders_status_e status)
{
...
//
void
PedidosAPI_getOrdersById(apiClient_t *apiClient, char *id)
{
...
PedidosAPI_postOrders(apiClient_t *apiClient, post_orders_request_t *post_orders_request)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *PedidosAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = post_orders_200_response_parseFromJSON(PedidosAPIlocalVarJSON);
        cJSON_Delete(PedidosAPIlocalVarJSON);
...
//
void
PedidosAPI_postOrdersByIdRefund(apiClient_t *apiClient, char *id)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
