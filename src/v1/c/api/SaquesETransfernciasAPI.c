...
#include "SaquesETransfernciasAPI.h"

#define MAX_NUMBER_LENGTH 16
#define MAX_BUFFER_LENGTH 4096
#define MAX_NUMBER_LENGTH_LONG 21

// Functions for enum PERIOD for SaquesETransfernciasAPI_getWithdraws
...
SaquesETransfernciasAPI_postWithdraws(apiClient_t *apiClient, post_withdraws_request_t *post_withdraws_request)
{
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *SaquesETransfernciasAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = post_withdraws_200_response_parseFromJSON(SaquesETransfernciasAPIlocalVarJSON);
        cJSON_Delete(SaquesETransfernciasAPIlocalVarJSON);
