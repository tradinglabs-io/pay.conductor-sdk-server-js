...
namespace payconductor-sdk.Client
{
    ...
    public class BasicToken : TokenBase
    {
        ...
        {
            request.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Basic", payconductor-sdk.Client.ClientUtils.Base64Encode(_username + ":" + _password));
        }
    }
}
