...
--[[
Unit tests for payconductor-sdk.model.bank_slip_expiration_in_days
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("bank_slip_expiration_in_days", function()
  local payconductor-sdk_bank_slip_expiration_in_days = require "payconductor-sdk.model.bank_slip_expiration_in_days"
