...
--[[
Unit tests for payconductor-sdk.model.pix_expiration_in_seconds
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("pix_expiration_in_seconds", function()
  local payconductor-sdk_pix_expiration_in_seconds = require "payconductor-sdk.model.pix_expiration_in_seconds"
