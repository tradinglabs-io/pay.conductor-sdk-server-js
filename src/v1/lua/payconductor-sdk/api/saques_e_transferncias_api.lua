...
local saques_e_transferncias_api = {}
local saques_e_transferncias_api_mt = {
	__name = "saques_e_transferncias_api";
	__index = saques_e_transferncias_api;
}

local function new_saques_e_transferncias_api(authority, basePath, schemes)
	local schemes_map = {}
	...
	return setmetatable({
		...
		api_key = {};
		access_token = nil;
	}, saques_e_transferncias_api_mt)
end

function saques_e_transferncias_api:get_withdraws(period, page, page_size, end_date, start_date, id)
...
function saques_e_transferncias_api:get_withdraws_by_id(id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
...
function saques_e_transferncias_api:post_withdraws(post_withdraws_request)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
...
return {
	new = new_saques_e_transferncias_api;
}
