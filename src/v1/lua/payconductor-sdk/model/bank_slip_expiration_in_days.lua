...
-- bank_slip_expiration_in_days class
local bank_slip_expiration_in_days = {}
local bank_slip_expiration_in_days_mt = {
	__name = "bank_slip_expiration_in_days";
	__index = bank_slip_expiration_in_days;
}

local function cast_bank_slip_expiration_in_days(t)
	return setmetatable(t, bank_slip_expiration_in_days_mt)
end

local function new_bank_slip_expiration_in_days()
	return cast_bank_slip_expiration_in_days({
	})
end

return {
	cast = cast_bank_slip_expiration_in_days;
	new = new_bank_slip_expiration_in_days;
}
