...
-- post_orders_request_session class
local post_orders_request_session = {}
local post_orders_request_session_mt = {
	__name = "post_orders_request_session";
	__index = post_orders_request_session;
}

local function cast_post_orders_request_session(t)
	return setmetatable(t, post_orders_request_session_mt)
end

local function new_post_orders_request_session(expires_in_minutes, checkout_url, session_id, external_session_id)
	return cast_post_orders_request_session({
...
return {
	cast = cast_post_orders_request_session;
	new = new_post_orders_request_session;
}
