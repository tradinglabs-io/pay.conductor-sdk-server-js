...
-- tokenized_card class
local tokenized_card = {}
local tokenized_card_mt = {
	__name = "tokenized_card";
	__index = tokenized_card;
}

local function cast_tokenized_card(t)
	return setmetatable(t, tokenized_card_mt)
end

local function new_tokenized_card(first_six_card_number, token)
	return cast_tokenized_card({
...
return {
	cast = cast_tokenized_card;
	new = new_tokenized_card;
}
