...
-- dados_completos_do_cart_o class
local dados_completos_do_cart_o = {}
local dados_completos_do_cart_o_mt = {
	__name = "dados_completos_do_cart_o";
	__index = dados_completos_do_cart_o;
}

local function cast_dados_completos_do_cart_o(t)
	return setmetatable(t, dados_completos_do_cart_o_mt)
end

local function new_dados_completos_do_cart_o(cvv, expiration, holder_name, Number_)
	return cast_dados_completos_do_cart_o({
		["cvv"] = cvv;
...
return {
	cast = cast_dados_completos_do_cart_o;
	new = new_dados_completos_do_cart_o;
}
