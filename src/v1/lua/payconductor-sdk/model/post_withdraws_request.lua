...
-- post_withdraws_request class
local post_withdraws_request = {}
local post_withdraws_request_mt = {
	__name = "post_withdraws_request";
	__index = post_withdraws_request;
}

local function cast_post_withdraws_request(t)
	return setmetatable(t, post_withdraws_request_mt)
end

local function new_post_withdraws_request(amount, external_id, merchant, payout_account)
	return cast_post_withdraws_request({
		["amount"] = amount;
...
return {
	cast = cast_post_withdraws_request;
	new = new_post_withdraws_request;
}
