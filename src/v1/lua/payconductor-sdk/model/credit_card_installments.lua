...
-- credit_card_installments class
local credit_card_installments = {}
local credit_card_installments_mt = {
	__name = "credit_card_installments";
	__index = credit_card_installments;
}

local function cast_credit_card_installments(t)
	return setmetatable(t, credit_card_installments_mt)
end

local function new_credit_card_installments()
	return cast_credit_card_installments({
	})
end

return {
	cast = cast_credit_card_installments;
	new = new_credit_card_installments;
}
