...
-- post_orders_200_response_session class
local post_orders_200_response_session = {}
local post_orders_200_response_session_mt = {
	__name = "post_orders_200_response_session";
	__index = post_orders_200_response_session;
}

local function cast_post_orders_200_response_session(t)
	return setmetatable(t, post_orders_200_response_session_mt)
end

local function new_post_orders_200_response_session(session_id)
	return cast_post_orders_200_response_session({
		["sessionId"] = session_id;
	})
end

return {
	cast = cast_post_orders_200_response_session;
	new = new_post_orders_200_response_session;
}
