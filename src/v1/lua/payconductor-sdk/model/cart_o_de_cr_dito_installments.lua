...
-- cart_o_de_cr_dito_installments class
local cart_o_de_cr_dito_installments = {}
local cart_o_de_cr_dito_installments_mt = {
	__name = "cart_o_de_cr_dito_installments";
	__index = cart_o_de_cr_dito_installments;
}

local function cast_cart_o_de_cr_dito_installments(t)
	return setmetatable(t, cart_o_de_cr_dito_installments_mt)
end

local function new_cart_o_de_cr_dito_installments()
	return cast_cart_o_de_cr_dito_installments({
	})
end

return {
	cast = cast_cart_o_de_cr_dito_installments;
	new = new_cart_o_de_cr_dito_installments;
}
