...
-- cart_o_tokenizado class
local cart_o_tokenizado = {}
local cart_o_tokenizado_mt = {
	__name = "cart_o_tokenizado";
	__index = cart_o_tokenizado;
}

local function cast_cart_o_tokenizado(t)
	return setmetatable(t, cart_o_tokenizado_mt)
end

local function new_cart_o_tokenizado(first_six_card_number, token)
	return cast_cart_o_tokenizado({
...
return {
	cast = cast_cart_o_tokenizado;
	new = new_cart_o_tokenizado;
}
