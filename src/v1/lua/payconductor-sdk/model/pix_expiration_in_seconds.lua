...
-- pix_expiration_in_seconds class
local pix_expiration_in_seconds = {}
local pix_expiration_in_seconds_mt = {
	__name = "pix_expiration_in_seconds";
	__index = pix_expiration_in_seconds;
}

local function cast_pix_expiration_in_seconds(t)
	return setmetatable(t, pix_expiration_in_seconds_mt)
end

local function new_pix_expiration_in_seconds()
	return cast_pix_expiration_in_seconds({
	})
end

return {
	cast = cast_pix_expiration_in_seconds;
	new = new_pix_expiration_in_seconds;
}
