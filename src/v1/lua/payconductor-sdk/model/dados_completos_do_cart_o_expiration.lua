...
-- dados_completos_do_cart_o_expiration class
local dados_completos_do_cart_o_expiration = {}
local dados_completos_do_cart_o_expiration_mt = {
	__name = "dados_completos_do_cart_o_expiration";
	__index = dados_completos_do_cart_o_expiration;
}

local function cast_dados_completos_do_cart_o_expiration(t)
	return setmetatable(t, dados_completos_do_cart_o_expiration_mt)
end

local function new_dados_completos_do_cart_o_expiration(month, year)
	return cast_dados_completos_do_cart_o_expiration({
		["month"] = month;
		["year"] = year;
	})
end
...
return {
	cast = cast_dados_completos_do_cart_o_expiration;
	new = new_dados_completos_do_cart_o_expiration;
}
