...
-- post_orders_200_response_nu_pay class
local post_orders_200_response_nu_pay = {}
local post_orders_200_response_nu_pay_mt = {
	__name = "post_orders_200_response_nu_pay";
	__index = post_orders_200_response_nu_pay;
}

local function cast_post_orders_200_response_nu_pay(t)
	return setmetatable(t, post_orders_200_response_nu_pay_mt)
end

local function new_post_orders_200_response_nu_pay(payment_url)
	return cast_post_orders_200_response_nu_pay({
		["paymentUrl"] = payment_url;
	})
end

return {
	cast = cast_post_orders_200_response_nu_pay;
	new = new_post_orders_200_response_nu_pay;
}
