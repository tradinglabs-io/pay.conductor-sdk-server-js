...
-- credit_card class
local credit_card = {}
local credit_card_mt = {
	__name = "credit_card";
	__index = credit_card;
}

local function cast_credit_card(t)
	return setmetatable(t, credit_card_mt)
end

local function new_credit_card(payment_method, card, installments, soft_descriptor)
	return cast_credit_card({
