...
-- post_card_tokenization_request_customer_any_of class
local post_card_tokenization_request_customer_any_of = {}
local post_card_tokenization_request_customer_any_of_mt = {
	__name = "post_card_tokenization_request_customer_any_of";
	__index = post_card_tokenization_request_customer_any_of;
}

local function cast_post_card_tokenization_request_customer_any_of(t)
	return setmetatable(t, post_card_tokenization_request_customer_any_of_mt)
end

local function new_post_card_tokenization_request_customer_any_of(id)
	return cast_post_card_tokenization_request_customer_any_of({
		["id"] = id;
	})
end

return {
	cast = cast_post_card_tokenization_request_customer_any_of;
	new = new_post_card_tokenization_request_customer_any_of;
}
