...
-- post_card_tokenization_request class
local post_card_tokenization_request = {}
local post_card_tokenization_request_mt = {
	__name = "post_card_tokenization_request";
	__index = post_card_tokenization_request;
}

local function cast_post_card_tokenization_request(t)
	return setmetatable(t, post_card_tokenization_request_mt)
end

local function new_post_card_tokenization_request(card, save_card, customer)
	return cast_post_card_tokenization_request({
		["card"] = card;
		["saveCard"] = save_card;
		["customer"] = customer;
	})
...
return {
	cast = cast_post_card_tokenization_request;
	new = new_post_card_tokenization_request;
}
