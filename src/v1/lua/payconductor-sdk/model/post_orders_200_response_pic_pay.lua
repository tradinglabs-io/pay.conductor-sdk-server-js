...
-- post_orders_200_response_pic_pay class
local post_orders_200_response_pic_pay = {}
local post_orders_200_response_pic_pay_mt = {
	__name = "post_orders_200_response_pic_pay";
	__index = post_orders_200_response_pic_pay;
}

local function cast_post_orders_200_response_pic_pay(t)
	return setmetatable(t, post_orders_200_response_pic_pay_mt)
end

local function new_post_orders_200_response_pic_pay(copy_and_paste_code, qr_code_url)
	return cast_post_orders_200_response_pic_pay({
...
return {
	cast = cast_post_orders_200_response_pic_pay;
	new = new_post_orders_200_response_pic_pay;
}
