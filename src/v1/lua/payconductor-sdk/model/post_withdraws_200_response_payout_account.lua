...
-- post_withdraws_200_response_payout_account class
local post_withdraws_200_response_payout_account = {}
local post_withdraws_200_response_payout_account_mt = {
	__name = "post_withdraws_200_response_payout_account";
	__index = post_withdraws_200_response_payout_account;
}

local function cast_post_withdraws_200_response_payout_account(t)
	return setmetatable(t, post_withdraws_200_response_payout_account_mt)
end

local function new_post_withdraws_200_response_payout_account(id, owner_document, owner_name, pix_key, pix_type)
	return cast_post_withdraws_200_response_payout_account({
		["id"] = id;
...
return {
	cast = cast_post_withdraws_200_response_payout_account;
	new = new_post_withdraws_200_response_payout_account;
}
