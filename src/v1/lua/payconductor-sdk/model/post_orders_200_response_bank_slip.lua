...
-- post_orders_200_response_bank_slip class
local post_orders_200_response_bank_slip = {}
local post_orders_200_response_bank_slip_mt = {
	__name = "post_orders_200_response_bank_slip";
	__index = post_orders_200_response_bank_slip;
}

local function cast_post_orders_200_response_bank_slip(t)
	return setmetatable(t, post_orders_200_response_bank_slip_mt)
end

local function new_post_orders_200_response_bank_slip(bar_code, digitable_line, pdf_url)
	return cast_post_orders_200_response_bank_slip({
		["barCode"] = bar_code;
...
return {
	cast = cast_post_orders_200_response_bank_slip;
	new = new_post_orders_200_response_bank_slip;
}
