...
-- customer_2_document_type class
local customer_2_document_type = {}
local customer_2_document_type_mt = {
	__name = "customer_2_document_type";
	__index = customer_2_document_type;
}

local function cast_customer_2_document_type(t)
	return setmetatable(t, customer_2_document_type_mt)
end

local function new_customer_2_document_type()
	return cast_customer_2_document_type({
	})
end

return {
	cast = cast_customer_2_document_type;
	new = new_customer_2_document_type;
}
