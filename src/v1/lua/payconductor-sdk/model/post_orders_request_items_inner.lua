...
-- post_orders_request_items_inner class
local post_orders_request_items_inner = {}
local post_orders_request_items_inner_mt = {
	__name = "post_orders_request_items_inner";
	__index = post_orders_request_items_inner;
}

local function cast_post_orders_request_items_inner(t)
	return setmetatable(t, post_orders_request_items_inner_mt)
end

local function new_post_orders_request_items_inner(id, is_physical, name, qty, unit_price)
	return cast_post_orders_request_items_inner({
		["id"] = id;
...
return {
	cast = cast_post_orders_request_items_inner;
	new = new_post_orders_request_items_inner;
}
