...
-- endere_o_do_cliente class
local endere_o_do_cliente = {}
local endere_o_do_cliente_mt = {
	__name = "endere_o_do_cliente";
	__index = endere_o_do_cliente;
}

local function cast_endere_o_do_cliente(t)
	return setmetatable(t, endere_o_do_cliente_mt)
end

local function new_endere_o_do_cliente(city, country, neighborhood, Number_, state, street, zip_code)
	return cast_endere_o_do_cliente({
		["city"] = city;
		["country"] = country;
...
return {
	cast = cast_endere_o_do_cliente;
	new = new_endere_o_do_cliente;
}
