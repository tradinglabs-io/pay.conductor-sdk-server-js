...
-- complete_card_data_expiration class
local complete_card_data_expiration = {}
local complete_card_data_expiration_mt = {
	__name = "complete_card_data_expiration";
	__index = complete_card_data_expiration;
}

local function cast_complete_card_data_expiration(t)
	return setmetatable(t, complete_card_data_expiration_mt)
end

local function new_complete_card_data_expiration(month, year)
	return cast_complete_card_data_expiration({
		["month"] = month;
		["year"] = year;
	})
end
...
return {
	cast = cast_complete_card_data_expiration;
	new = new_complete_card_data_expiration;
}
