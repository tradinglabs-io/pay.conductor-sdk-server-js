...
-- merchant_input class
local merchant_input = {}
local merchant_input_mt = {
	__name = "merchant_input";
	__index = merchant_input;
}

local function cast_merchant_input(t)
	return setmetatable(t, merchant_input_mt)
end

local function new_merchant_input(document, email, name)
	return cast_merchant_input({
		["document"] = document;
		["email"] = email;
		["name"] = name;
	})
...
return {
	cast = cast_merchant_input;
	new = new_merchant_input;
}
