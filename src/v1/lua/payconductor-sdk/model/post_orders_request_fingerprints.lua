...
-- post_orders_request_fingerprints class
local post_orders_request_fingerprints = {}
local post_orders_request_fingerprints_mt = {
	__name = "post_orders_request_fingerprints";
	__index = post_orders_request_fingerprints;
}

local function cast_post_orders_request_fingerprints(t)
	return setmetatable(t, post_orders_request_fingerprints_mt)
end

local function new_post_orders_request_fingerprints(threat_metrix_fingerprint_id)
	return cast_post_orders_request_fingerprints({
		["threatMetrixFingerprintId"] = threat_metrix_fingerprint_id;
	})
end

return {
	cast = cast_post_orders_request_fingerprints;
	new = new_post_orders_request_fingerprints;
}
