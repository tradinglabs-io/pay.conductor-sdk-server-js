...
-- post_orders_200_response_credit_card class
local post_orders_200_response_credit_card = {}
local post_orders_200_response_credit_card_mt = {
	__name = "post_orders_200_response_credit_card";
	__index = post_orders_200_response_credit_card;
}

local function cast_post_orders_200_response_credit_card(t)
	return setmetatable(t, post_orders_200_response_credit_card_mt)
end

local function new_post_orders_200_response_credit_card(authorization_code)
	return cast_post_orders_200_response_credit_card({
		["authorizationCode"] = authorization_code;
	})
end

return {
	cast = cast_post_orders_200_response_credit_card;
	new = new_post_orders_200_response_credit_card;
}
