...
-- nu_pay_nu_pay class
local nu_pay_nu_pay = {}
local nu_pay_nu_pay_mt = {
	__name = "nu_pay_nu_pay";
	__index = nu_pay_nu_pay;
}

local function cast_nu_pay_nu_pay(t)
	return setmetatable(t, nu_pay_nu_pay_mt)
end

local function new_nu_pay_nu_pay(cancel_url, merchant_name, return_url, store_name)
	return cast_nu_pay_nu_pay({
...
return {
	cast = cast_nu_pay_nu_pay;
	new = new_nu_pay_nu_pay;
}
