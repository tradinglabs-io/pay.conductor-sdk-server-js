...
-- boleto_expiration_in_days class
local boleto_expiration_in_days = {}
local boleto_expiration_in_days_mt = {
	__name = "boleto_expiration_in_days";
	__index = boleto_expiration_in_days;
}

local function cast_boleto_expiration_in_days(t)
	return setmetatable(t, boleto_expiration_in_days_mt)
end

local function new_boleto_expiration_in_days()
	return cast_boleto_expiration_in_days({
	})
end

return {
	cast = cast_boleto_expiration_in_days;
	new = new_boleto_expiration_in_days;
}
