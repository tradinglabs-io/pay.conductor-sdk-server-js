...
-- post_card_tokenization_200_response class
local post_card_tokenization_200_response = {}
local post_card_tokenization_200_response_mt = {
	__name = "post_card_tokenization_200_response";
	__index = post_card_tokenization_200_response;
}

local function cast_post_card_tokenization_200_response(t)
	return setmetatable(t, post_card_tokenization_200_response_mt)
end

local function new_post_card_tokenization_200_response(customer_id, token)
	return cast_post_card_tokenization_200_response({
...
return {
	cast = cast_post_card_tokenization_200_response;
	new = new_post_card_tokenization_200_response;
}
