...
-- complete_card_data class
local complete_card_data = {}
local complete_card_data_mt = {
	__name = "complete_card_data";
	__index = complete_card_data;
}

local function cast_complete_card_data(t)
	return setmetatable(t, complete_card_data_mt)
end

local function new_complete_card_data(cvv, expiration, holder_name, Number_)
	return cast_complete_card_data({
		["cvv"] = cvv;
...
return {
	cast = cast_complete_card_data;
	new = new_complete_card_data;
}
