...
-- post_orders_200_response_pix class
local post_orders_200_response_pix = {}
local post_orders_200_response_pix_mt = {
	__name = "post_orders_200_response_pix";
	__index = post_orders_200_response_pix;
}

local function cast_post_orders_200_response_pix(t)
	return setmetatable(t, post_orders_200_response_pix_mt)
end

local function new_post_orders_200_response_pix(copy_and_paste_code, qr_code_url, end_to_end_id)
	return cast_post_orders_200_response_pix({
...
return {
	cast = cast_post_orders_200_response_pix;
	new = new_post_orders_200_response_pix;
}
