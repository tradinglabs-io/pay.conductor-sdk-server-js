...
-- post_withdraws_200_response_payed_at class
local post_withdraws_200_response_payed_at = {}
local post_withdraws_200_response_payed_at_mt = {
	__name = "post_withdraws_200_response_payed_at";
	__index = post_withdraws_200_response_payed_at;
}

local function cast_post_withdraws_200_response_payed_at(t)
	return setmetatable(t, post_withdraws_200_response_payed_at_mt)
end

local function new_post_withdraws_200_response_payed_at()
	return cast_post_withdraws_200_response_payed_at({
	})
end

return {
	cast = cast_post_withdraws_200_response_payed_at;
	new = new_post_withdraws_200_response_payed_at;
}
