...
-- cart_o_de_cr_dito class
local cart_o_de_cr_dito = {}
local cart_o_de_cr_dito_mt = {
	__name = "cart_o_de_cr_dito";
	__index = cart_o_de_cr_dito;
}

local function cast_cart_o_de_cr_dito(t)
	return setmetatable(t, cart_o_de_cr_dito_mt)
end

local function new_cart_o_de_cr_dito(payment_method, card, installments, soft_descriptor)
	return cast_cart_o_de_cr_dito({
...
return {
	cast = cast_cart_o_de_cr_dito;
	new = new_cart_o_de_cr_dito;
}
