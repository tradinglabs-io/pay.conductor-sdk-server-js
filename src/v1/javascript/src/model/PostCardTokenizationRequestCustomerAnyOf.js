...
/**
 * The PostCardTokenizationRequestCustomerAnyOf model module.
 * @module model/PostCardTokenizationRequestCustomerAnyOf
 * @version 1.0.0
 */
class PostCardTokenizationRequestCustomerAnyOf {
    /**
     * Constructs a new <code>PostCardTokenizationRequestCustomerAnyOf</code>.
     * @alias module:model/PostCardTokenizationRequestCustomerAnyOf
     * @param id {String} ID do cliente existente
     */
    constructor(id) { 
        
        PostCardTokenizationRequestCustomerAnyOf.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>PostCardTokenizationRequestCustomerAnyOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostCardTokenizationRequestCustomerAnyOf} obj Optional instance to populate.
     * @return {module:model/PostCardTokenizationRequestCustomerAnyOf} The populated <code>PostCardTokenizationRequestCustomerAnyOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostCardTokenizationRequestCustomerAnyOf();
    ...
    /**
     * Validates the JSON data with respect to <code>PostCardTokenizationRequestCustomerAnyOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostCardTokenizationRequestCustomerAnyOf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PostCardTokenizationRequestCustomerAnyOf.RequiredProperties) {
...
PostCardTokenizationRequestCustomerAnyOf.RequiredProperties = ["id"];

/**
 * ID do cliente existente
 * @member {String} id
 */
PostCardTokenizationRequestCustomerAnyOf.prototype['id'] = undefined;
...
export default PostCardTokenizationRequestCustomerAnyOf;
