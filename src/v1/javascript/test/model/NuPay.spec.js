...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.NuPay();
  });
  ...
  describe('NuPay', function() {
    it('should create an instance of NuPay', function() {
      // uncomment below and update the code to test NuPay
      //var instance = new PayconductorSdk.NuPay();
      //expect(instance).to.be.a(PayconductorSdk.NuPay);
    });
