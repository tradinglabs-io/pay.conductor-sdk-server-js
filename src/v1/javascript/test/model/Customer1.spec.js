...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.Customer1();
  });
  ...
  describe('Customer1', function() {
    it('should create an instance of Customer1', function() {
      // uncomment below and update the code to test Customer1
      //var instance = new PayconductorSdk.Customer1();
      //expect(instance).to.be.a(PayconductorSdk.Customer1);
    });
