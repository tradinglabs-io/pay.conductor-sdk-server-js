...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.BankSlip();
  });
  ...
  describe('BankSlip', function() {
    it('should create an instance of BankSlip', function() {
      // uncomment below and update the code to test BankSlip
      //var instance = new PayconductorSdk.BankSlip();
      //expect(instance).to.be.a(PayconductorSdk.BankSlip);
    });
