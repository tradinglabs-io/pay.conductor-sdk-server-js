...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.CartODeCrDitoCard();
  });
  ...
  describe('CartODeCrDitoCard', function() {
    it('should create an instance of CartODeCrDitoCard', function() {
      // uncomment below and update the code to test CartODeCrDitoCard
      //var instance = new PayconductorSdk.CartODeCrDitoCard();
      //expect(instance).to.be.a(PayconductorSdk.CartODeCrDitoCard);
    });
