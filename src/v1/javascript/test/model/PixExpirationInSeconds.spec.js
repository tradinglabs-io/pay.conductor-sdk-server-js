...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.PixExpirationInSeconds();
  });
  ...
  describe('PixExpirationInSeconds', function() {
    it('should create an instance of PixExpirationInSeconds', function() {
      // uncomment below and update the code to test PixExpirationInSeconds
      //var instance = new PayconductorSdk.PixExpirationInSeconds();
      //expect(instance).to.be.a(PayconductorSdk.PixExpirationInSeconds);
    });
