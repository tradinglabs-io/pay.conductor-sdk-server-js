...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.CreditCardCard();
  });
  ...
  describe('CreditCardCard', function() {
    it('should create an instance of CreditCardCard', function() {
      // uncomment below and update the code to test CreditCardCard
      //var instance = new PayconductorSdk.CreditCardCard();
      //expect(instance).to.be.a(PayconductorSdk.CreditCardCard);
    });
