...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.PostCardTokenizationRequestCustomerAnyOf();
  });
  ...
  describe('PostCardTokenizationRequestCustomerAnyOf', function() {
    it('should create an instance of PostCardTokenizationRequestCustomerAnyOf', function() {
      // uncomment below and update the code to test PostCardTokenizationRequestCustomerAnyOf
      //var instance = new PayconductorSdk.PostCardTokenizationRequestCustomerAnyOf();
      //expect(instance).to.be.a(PayconductorSdk.PostCardTokenizationRequestCustomerAnyOf);
    });
