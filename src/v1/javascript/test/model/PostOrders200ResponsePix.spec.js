...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.PostOrders200ResponsePix();
  });
  ...
  describe('PostOrders200ResponsePix', function() {
    it('should create an instance of PostOrders200ResponsePix', function() {
      // uncomment below and update the code to test PostOrders200ResponsePix
      //var instance = new PayconductorSdk.PostOrders200ResponsePix();
      //expect(instance).to.be.a(PayconductorSdk.PostOrders200ResponsePix);
    });
