...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.DadosCompletosDoCartO();
  });
  ...
  describe('DadosCompletosDoCartO', function() {
    it('should create an instance of DadosCompletosDoCartO', function() {
      // uncomment below and update the code to test DadosCompletosDoCartO
      //var instance = new PayconductorSdk.DadosCompletosDoCartO();
      //expect(instance).to.be.a(PayconductorSdk.DadosCompletosDoCartO);
    });
