...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.Customer2DocumentType();
  });
  ...
  describe('Customer2DocumentType', function() {
    it('should create an instance of Customer2DocumentType', function() {
      // uncomment below and update the code to test Customer2DocumentType
      //var instance = new PayconductorSdk.Customer2DocumentType();
      //expect(instance).to.be.a(PayconductorSdk.Customer2DocumentType);
    });
