...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.BankSlipExpirationInDays();
  });
  ...
  describe('BankSlipExpirationInDays', function() {
    it('should create an instance of BankSlipExpirationInDays', function() {
      // uncomment below and update the code to test BankSlipExpirationInDays
      //var instance = new PayconductorSdk.BankSlipExpirationInDays();
      //expect(instance).to.be.a(PayconductorSdk.BankSlipExpirationInDays);
    });
