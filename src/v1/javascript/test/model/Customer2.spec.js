...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.Customer2();
  });
  ...
  describe('Customer2', function() {
    it('should create an instance of Customer2', function() {
      // uncomment below and update the code to test Customer2
      //var instance = new PayconductorSdk.Customer2();
      //expect(instance).to.be.a(PayconductorSdk.Customer2);
    });
