...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.CartOTokenizado();
  });
  ...
  describe('CartOTokenizado', function() {
    it('should create an instance of CartOTokenizado', function() {
      // uncomment below and update the code to test CartOTokenizado
      //var instance = new PayconductorSdk.CartOTokenizado();
      //expect(instance).to.be.a(PayconductorSdk.CartOTokenizado);
    });
