...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.MerchantInput();
  });
  ...
  describe('MerchantInput', function() {
    it('should create an instance of MerchantInput', function() {
      // uncomment below and update the code to test MerchantInput
      //var instance = new PayconductorSdk.MerchantInput();
      //expect(instance).to.be.a(PayconductorSdk.MerchantInput);
    });
