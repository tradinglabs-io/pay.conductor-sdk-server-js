...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.PostCardTokenization200Response();
  });
  ...
  describe('PostCardTokenization200Response', function() {
    it('should create an instance of PostCardTokenization200Response', function() {
      // uncomment below and update the code to test PostCardTokenization200Response
      //var instance = new PayconductorSdk.PostCardTokenization200Response();
      //expect(instance).to.be.a(PayconductorSdk.PostCardTokenization200Response);
    });
