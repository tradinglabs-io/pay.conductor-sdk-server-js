...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.PostOrders200ResponseCreditCard();
  });
  ...
  describe('PostOrders200ResponseCreditCard', function() {
    it('should create an instance of PostOrders200ResponseCreditCard', function() {
      // uncomment below and update the code to test PostOrders200ResponseCreditCard
      //var instance = new PayconductorSdk.PostOrders200ResponseCreditCard();
      //expect(instance).to.be.a(PayconductorSdk.PostOrders200ResponseCreditCard);
    });
