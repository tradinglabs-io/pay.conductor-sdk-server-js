...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.PostWithdraws200ResponsePayoutAccount();
  });
  ...
  describe('PostWithdraws200ResponsePayoutAccount', function() {
    it('should create an instance of PostWithdraws200ResponsePayoutAccount', function() {
      // uncomment below and update the code to test PostWithdraws200ResponsePayoutAccount
      //var instance = new PayconductorSdk.PostWithdraws200ResponsePayoutAccount();
      //expect(instance).to.be.a(PayconductorSdk.PostWithdraws200ResponsePayoutAccount);
    });
    ...
    it('should have the property ownerDocument (base name: "ownerDocument")', function() {
      // uncomment below and update the code to test the property ownerDocument
      //var instance = new PayconductorSdk.PostWithdraws200ResponsePayoutAccount();
      //expect(instance).to.be();
    });
    ...
    it('should have the property pixKey (base name: "pixKey")', function() {
      // uncomment below and update the code to test the property pixKey
      //var instance = new PayconductorSdk.PostWithdraws200ResponsePayoutAccount();
      //expect(instance).to.be();
    });

    it('should have the property pixType (base name: "pixType")', function() {
      // uncomment below and update the code to test the property pixType
      //var instance = new PayconductorSdk.PostWithdraws200ResponsePayoutAccount();
      //expect(instance).to.be();
    });
