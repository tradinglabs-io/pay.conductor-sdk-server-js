...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.CompleteCardDataExpiration();
  });
  ...
  describe('CompleteCardDataExpiration', function() {
    it('should create an instance of CompleteCardDataExpiration', function() {
      // uncomment below and update the code to test CompleteCardDataExpiration
      //var instance = new PayconductorSdk.CompleteCardDataExpiration();
      //expect(instance).to.be.a(PayconductorSdk.CompleteCardDataExpiration);
    });
