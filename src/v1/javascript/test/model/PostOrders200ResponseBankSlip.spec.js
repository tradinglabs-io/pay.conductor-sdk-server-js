...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.PostOrders200ResponseBankSlip();
  });
  ...
  describe('PostOrders200ResponseBankSlip', function() {
    it('should create an instance of PostOrders200ResponseBankSlip', function() {
      // uncomment below and update the code to test PostOrders200ResponseBankSlip
      //var instance = new PayconductorSdk.PostOrders200ResponseBankSlip();
      //expect(instance).to.be.a(PayconductorSdk.PostOrders200ResponseBankSlip);
    });
    ...
    it('should have the property digitableLine (base name: "digitableLine")', function() {
      // uncomment below and update the code to test the property digitableLine
      //var instance = new PayconductorSdk.PostOrders200ResponseBankSlip();
      //expect(instance).to.be();
    });
