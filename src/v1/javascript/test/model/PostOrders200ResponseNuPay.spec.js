...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.PostOrders200ResponseNuPay();
  });
  ...
  describe('PostOrders200ResponseNuPay', function() {
    it('should create an instance of PostOrders200ResponseNuPay', function() {
      // uncomment below and update the code to test PostOrders200ResponseNuPay
      //var instance = new PayconductorSdk.PostOrders200ResponseNuPay();
      //expect(instance).to.be.a(PayconductorSdk.PostOrders200ResponseNuPay);
    });
