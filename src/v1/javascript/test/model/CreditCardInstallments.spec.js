...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.CreditCardInstallments();
  });
  ...
  describe('CreditCardInstallments', function() {
    it('should create an instance of CreditCardInstallments', function() {
      // uncomment below and update the code to test CreditCardInstallments
      //var instance = new PayconductorSdk.CreditCardInstallments();
      //expect(instance).to.be.a(PayconductorSdk.CreditCardInstallments);
    });
