...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.Pix();
  });
  ...
  describe('Pix', function() {
    it('should create an instance of Pix', function() {
      // uncomment below and update the code to test Pix
      //var instance = new PayconductorSdk.Pix();
      //expect(instance).to.be.a(PayconductorSdk.Pix);
    });
