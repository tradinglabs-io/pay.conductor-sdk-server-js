...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.EndereODoCliente();
  });
  ...
  describe('EndereODoCliente', function() {
    it('should create an instance of EndereODoCliente', function() {
      // uncomment below and update the code to test EndereODoCliente
      //var instance = new PayconductorSdk.EndereODoCliente();
      //expect(instance).to.be.a(PayconductorSdk.EndereODoCliente);
    });
