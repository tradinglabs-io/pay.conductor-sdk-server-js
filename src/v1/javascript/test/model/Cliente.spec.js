...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.Cliente();
  });
  ...
  describe('Cliente', function() {
    it('should create an instance of Cliente', function() {
      // uncomment below and update the code to test Cliente
      //var instance = new PayconductorSdk.Cliente();
      //expect(instance).to.be.a(PayconductorSdk.Cliente);
    });
