...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.PostCardTokenizationRequest();
  });
  ...
  describe('PostCardTokenizationRequest', function() {
    it('should create an instance of PostCardTokenizationRequest', function() {
      // uncomment below and update the code to test PostCardTokenizationRequest
      //var instance = new PayconductorSdk.PostCardTokenizationRequest();
      //expect(instance).to.be.a(PayconductorSdk.PostCardTokenizationRequest);
    });
