...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.PostOrders200ResponseSession();
  });
  ...
  describe('PostOrders200ResponseSession', function() {
    it('should create an instance of PostOrders200ResponseSession', function() {
      // uncomment below and update the code to test PostOrders200ResponseSession
      //var instance = new PayconductorSdk.PostOrders200ResponseSession();
      //expect(instance).to.be.a(PayconductorSdk.PostOrders200ResponseSession);
    });
