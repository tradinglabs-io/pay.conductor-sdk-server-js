...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.TokenizedCard();
  });
  ...
  describe('TokenizedCard', function() {
    it('should create an instance of TokenizedCard', function() {
      // uncomment below and update the code to test TokenizedCard
      //var instance = new PayconductorSdk.TokenizedCard();
      //expect(instance).to.be.a(PayconductorSdk.TokenizedCard);
    });
