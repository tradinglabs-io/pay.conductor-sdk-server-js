...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.DadosCompletosDoCartOExpiration();
  });
  ...
  describe('DadosCompletosDoCartOExpiration', function() {
    it('should create an instance of DadosCompletosDoCartOExpiration', function() {
      // uncomment below and update the code to test DadosCompletosDoCartOExpiration
      //var instance = new PayconductorSdk.DadosCompletosDoCartOExpiration();
      //expect(instance).to.be.a(PayconductorSdk.DadosCompletosDoCartOExpiration);
    });
