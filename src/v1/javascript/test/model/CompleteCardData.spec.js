...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.CompleteCardData();
  });
  ...
  describe('CompleteCardData', function() {
    it('should create an instance of CompleteCardData', function() {
      // uncomment below and update the code to test CompleteCardData
      //var instance = new PayconductorSdk.CompleteCardData();
      //expect(instance).to.be.a(PayconductorSdk.CompleteCardData);
    });
