...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.CartODeCrDitoInstallments();
  });
  ...
  describe('CartODeCrDitoInstallments', function() {
    it('should create an instance of CartODeCrDitoInstallments', function() {
      // uncomment below and update the code to test CartODeCrDitoInstallments
      //var instance = new PayconductorSdk.CartODeCrDitoInstallments();
      //expect(instance).to.be.a(PayconductorSdk.CartODeCrDitoInstallments);
    });
