...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.CartODeCrDito();
  });
  ...
  describe('CartODeCrDito', function() {
    it('should create an instance of CartODeCrDito', function() {
      // uncomment below and update the code to test CartODeCrDito
      //var instance = new PayconductorSdk.CartODeCrDito();
      //expect(instance).to.be.a(PayconductorSdk.CartODeCrDito);
    });
