...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.PicPay();
  });
  ...
  describe('PicPay', function() {
    it('should create an instance of PicPay', function() {
      // uncomment below and update the code to test PicPay
      //var instance = new PayconductorSdk.PicPay();
      //expect(instance).to.be.a(PayconductorSdk.PicPay);
    });
