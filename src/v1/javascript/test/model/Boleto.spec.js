...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.Boleto();
  });
  ...
  describe('Boleto', function() {
    it('should create an instance of Boleto', function() {
      // uncomment below and update the code to test Boleto
      //var instance = new PayconductorSdk.Boleto();
      //expect(instance).to.be.a(PayconductorSdk.Boleto);
    });
