...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.PostWithdraws200ResponsePayedAt();
  });
  ...
  describe('PostWithdraws200ResponsePayedAt', function() {
    it('should create an instance of PostWithdraws200ResponsePayedAt', function() {
      // uncomment below and update the code to test PostWithdraws200ResponsePayedAt
      //var instance = new PayconductorSdk.PostWithdraws200ResponsePayedAt();
      //expect(instance).to.be.a(PayconductorSdk.PostWithdraws200ResponsePayedAt);
    });
