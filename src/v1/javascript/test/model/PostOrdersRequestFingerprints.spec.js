...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.PostOrdersRequestFingerprints();
  });
  ...
  describe('PostOrdersRequestFingerprints', function() {
    it('should create an instance of PostOrdersRequestFingerprints', function() {
      // uncomment below and update the code to test PostOrdersRequestFingerprints
      //var instance = new PayconductorSdk.PostOrdersRequestFingerprints();
      //expect(instance).to.be.a(PayconductorSdk.PostOrdersRequestFingerprints);
    });

    it('should have the property threatMetrixFingerprintId (base name: "threatMetrixFingerprintId")', function() {
      // uncomment below and update the code to test the property threatMetrixFingerprintId
      //var instance = new PayconductorSdk.PostOrdersRequestFingerprints();
