...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.PostWithdrawsRequestPayoutAccount();
  });
  ...
  describe('PostWithdrawsRequestPayoutAccount', function() {
    it('should create an instance of PostWithdrawsRequestPayoutAccount', function() {
      // uncomment below and update the code to test PostWithdrawsRequestPayoutAccount
      //var instance = new PayconductorSdk.PostWithdrawsRequestPayoutAccount();
      //expect(instance).to.be.a(PayconductorSdk.PostWithdrawsRequestPayoutAccount);
    });
