...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.PostOrdersRequestItemsInner();
  });
  ...
  describe('PostOrdersRequestItemsInner', function() {
    it('should create an instance of PostOrdersRequestItemsInner', function() {
      // uncomment below and update the code to test PostOrdersRequestItemsInner
      //var instance = new PayconductorSdk.PostOrdersRequestItemsInner();
      //expect(instance).to.be.a(PayconductorSdk.PostOrdersRequestItemsInner);
    });
