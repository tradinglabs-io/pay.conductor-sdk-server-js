...
module OpenapiClient
  # PIX data
  class PostOrders200ResponsePix < ApiModelBase
    # PIX copy and paste code
    attr_accessor :copy_and_paste_code
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PostOrders200ResponsePix` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PostOrders200ResponsePix`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'copy_and_paste_code')
        self.copy_and_paste_code = attributes[:'copy_and_paste_code']
      else
        self.copy_and_paste_code = nil
      end
    ...
    def list_invalid_properties
      ...
      if @copy_and_paste_code.nil?
        invalid_properties.push('invalid value for "copy_and_paste_code", copy_and_paste_code cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @copy_and_paste_code.nil?
      return false if @qr_code_url.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] copy_and_paste_code Value to be assigned
    def copy_and_paste_code=(copy_and_paste_code)
      if copy_and_paste_code.nil?
        fail ArgumentError, 'copy_and_paste_code cannot be nil'
      end

      @copy_and_paste_code = copy_and_paste_code
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          copy_and_paste_code == o.copy_and_paste_code &&
    ...
    def hash
      [copy_and_paste_code, qr_code_url, end_to_end_id].hash
    end
