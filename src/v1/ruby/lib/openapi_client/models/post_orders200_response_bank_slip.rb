...
module OpenapiClient
  class PostOrders200ResponseBankSlip < ApiModelBase
    # Bank slip bar code
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PostOrders200ResponseBankSlip` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PostOrders200ResponseBankSlip`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'digitable_line')
        self.digitable_line = attributes[:'digitable_line']
      else
        self.digitable_line = nil
      end
    ...
    def list_invalid_properties
      ...
      if @bar_code.nil?
        invalid_properties.push('invalid value for "bar_code", bar_code cannot be nil.')
      end

      if @digitable_line.nil?
        invalid_properties.push('invalid value for "digitable_line", digitable_line cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @bar_code.nil?
      return false if @digitable_line.nil?
      true
    end
    ...
    def bar_code=(bar_code)
      if bar_code.nil?
        fail ArgumentError, 'bar_code cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] digitable_line Value to be assigned
    def digitable_line=(digitable_line)
      if digitable_line.nil?
        fail ArgumentError, 'digitable_line cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          bar_code == o.bar_code &&
          digitable_line == o.digitable_line &&
          pdf_url == o.pdf_url
    end
    ...
    def hash
      [bar_code, digitable_line, pdf_url].hash
    end
