...
module OpenapiClient
  class PostOrdersRequestFingerprints < ApiModelBase
    # ThreatMetrix fingerprint ID for fraud analysis
    attr_accessor :threat_metrix_fingerprint_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PostOrdersRequestFingerprints` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PostOrdersRequestFingerprints`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'threat_metrix_fingerprint_id')
        self.threat_metrix_fingerprint_id = attributes[:'threat_metrix_fingerprint_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          threat_metrix_fingerprint_id == o.threat_metrix_fingerprint_id
    end
    ...
    def hash
      [threat_metrix_fingerprint_id].hash
    end
