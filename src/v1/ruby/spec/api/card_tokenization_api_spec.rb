...
# Unit tests for OpenapiClient::CardTokenizationApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CardTokenizationApi' do
  before do
  ...
  describe 'test an instance of CardTokenizationApi' do
    it 'should create an instance of CardTokenizationApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::CardTokenizationApi)
    end
  end
