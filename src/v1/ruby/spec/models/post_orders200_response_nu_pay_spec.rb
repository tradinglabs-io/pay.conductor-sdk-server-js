...
# Unit tests for OpenapiClient::PostOrders200ResponseNuPay
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PostOrders200ResponseNuPay do
  #let(:instance) { OpenapiClient::PostOrders200ResponseNuPay.new }

  describe 'test an instance of PostOrders200ResponseNuPay' do
    it 'should create an instance of PostOrders200ResponseNuPay' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PostOrders200ResponseNuPay)
    end
  end
