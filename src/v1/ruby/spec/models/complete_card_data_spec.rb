...
# Unit tests for OpenapiClient::CompleteCardData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CompleteCardData do
  #let(:instance) { OpenapiClient::CompleteCardData.new }

  describe 'test an instance of CompleteCardData' do
    it 'should create an instance of CompleteCardData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CompleteCardData)
    end
  end
