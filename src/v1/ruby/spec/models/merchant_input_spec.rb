...
# Unit tests for OpenapiClient::MerchantInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MerchantInput do
  #let(:instance) { OpenapiClient::MerchantInput.new }

  describe 'test an instance of MerchantInput' do
    it 'should create an instance of MerchantInput' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::MerchantInput)
    end
  end
