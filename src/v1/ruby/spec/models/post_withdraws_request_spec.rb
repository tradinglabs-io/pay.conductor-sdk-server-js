...
# Unit tests for OpenapiClient::PostWithdrawsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PostWithdrawsRequest do
  #let(:instance) { OpenapiClient::PostWithdrawsRequest.new }

  describe 'test an instance of PostWithdrawsRequest' do
    it 'should create an instance of PostWithdrawsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PostWithdrawsRequest)
    end
  end
