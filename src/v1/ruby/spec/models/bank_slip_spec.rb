...
# Unit tests for OpenapiClient::BankSlip
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::BankSlip do
  #let(:instance) { OpenapiClient::BankSlip.new }

  describe 'test an instance of BankSlip' do
    it 'should create an instance of BankSlip' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::BankSlip)
    end
  end
