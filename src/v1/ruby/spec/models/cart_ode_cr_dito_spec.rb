...
# Unit tests for OpenapiClient::CartODeCrDito
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CartODeCrDito do
  #let(:instance) { OpenapiClient::CartODeCrDito.new }

  describe 'test an instance of CartODeCrDito' do
    it 'should create an instance of CartODeCrDito' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CartODeCrDito)
    end
  end
