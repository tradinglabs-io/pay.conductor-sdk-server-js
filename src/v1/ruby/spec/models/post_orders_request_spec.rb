...
# Unit tests for OpenapiClient::PostOrdersRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PostOrdersRequest do
  #let(:instance) { OpenapiClient::PostOrdersRequest.new }

  describe 'test an instance of PostOrdersRequest' do
    it 'should create an instance of PostOrdersRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PostOrdersRequest)
    end
  end
