...
# Unit tests for OpenapiClient::DadosCompletosDoCartO
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DadosCompletosDoCartO do
  #let(:instance) { OpenapiClient::DadosCompletosDoCartO.new }

  describe 'test an instance of DadosCompletosDoCartO' do
    it 'should create an instance of DadosCompletosDoCartO' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DadosCompletosDoCartO)
    end
  end
