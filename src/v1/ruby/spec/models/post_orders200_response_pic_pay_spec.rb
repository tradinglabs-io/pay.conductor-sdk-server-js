...
# Unit tests for OpenapiClient::PostOrders200ResponsePicPay
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PostOrders200ResponsePicPay do
  #let(:instance) { OpenapiClient::PostOrders200ResponsePicPay.new }

  describe 'test an instance of PostOrders200ResponsePicPay' do
    it 'should create an instance of PostOrders200ResponsePicPay' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PostOrders200ResponsePicPay)
    end
  end

  describe 'test attribute "copy_and_paste_code"' do
    it 'should work' do
