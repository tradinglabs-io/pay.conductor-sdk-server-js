...
# Unit tests for OpenapiClient::PostOrders200ResponseBankSlip
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PostOrders200ResponseBankSlip do
  #let(:instance) { OpenapiClient::PostOrders200ResponseBankSlip.new }

  describe 'test an instance of PostOrders200ResponseBankSlip' do
    it 'should create an instance of PostOrders200ResponseBankSlip' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PostOrders200ResponseBankSlip)
    end
  end
  ...
  describe 'test attribute "digitable_line"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
