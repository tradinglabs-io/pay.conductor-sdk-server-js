...
# Unit tests for OpenapiClient::PostOrdersRequestSession
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PostOrdersRequestSession do
  #let(:instance) { OpenapiClient::PostOrdersRequestSession.new }

  describe 'test an instance of PostOrdersRequestSession' do
    it 'should create an instance of PostOrdersRequestSession' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PostOrdersRequestSession)
    end
  end
