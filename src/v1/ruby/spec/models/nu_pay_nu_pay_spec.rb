...
# Unit tests for OpenapiClient::NuPayNuPay
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::NuPayNuPay do
  #let(:instance) { OpenapiClient::NuPayNuPay.new }

  describe 'test an instance of NuPayNuPay' do
    it 'should create an instance of NuPayNuPay' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::NuPayNuPay)
    end
  end
