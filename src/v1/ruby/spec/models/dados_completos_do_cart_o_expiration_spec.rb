...
# Unit tests for OpenapiClient::DadosCompletosDoCartOExpiration
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DadosCompletosDoCartOExpiration do
  #let(:instance) { OpenapiClient::DadosCompletosDoCartOExpiration.new }

  describe 'test an instance of DadosCompletosDoCartOExpiration' do
    it 'should create an instance of DadosCompletosDoCartOExpiration' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DadosCompletosDoCartOExpiration)
    end
  end
