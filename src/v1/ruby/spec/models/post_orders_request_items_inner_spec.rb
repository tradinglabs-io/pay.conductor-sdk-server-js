...
# Unit tests for OpenapiClient::PostOrdersRequestItemsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PostOrdersRequestItemsInner do
  #let(:instance) { OpenapiClient::PostOrdersRequestItemsInner.new }

  describe 'test an instance of PostOrdersRequestItemsInner' do
    it 'should create an instance of PostOrdersRequestItemsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PostOrdersRequestItemsInner)
    end
  end
  ...
  describe 'test attribute "is_physical"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
