...
# Unit tests for OpenapiClient::Pix
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Pix do
  #let(:instance) { OpenapiClient::Pix.new }

  describe 'test an instance of Pix' do
    it 'should create an instance of Pix' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Pix)
    end
  end
