...
# Unit tests for OpenapiClient::PostCardTokenization200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PostCardTokenization200Response do
  #let(:instance) { OpenapiClient::PostCardTokenization200Response.new }

  describe 'test an instance of PostCardTokenization200Response' do
    it 'should create an instance of PostCardTokenization200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PostCardTokenization200Response)
    end
  end
