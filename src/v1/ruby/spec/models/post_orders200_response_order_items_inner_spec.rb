...
# Unit tests for OpenapiClient::PostOrders200ResponseOrderItemsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PostOrders200ResponseOrderItemsInner do
  #let(:instance) { OpenapiClient::PostOrders200ResponseOrderItemsInner.new }

  describe 'test an instance of PostOrders200ResponseOrderItemsInner' do
    it 'should create an instance of PostOrders200ResponseOrderItemsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PostOrders200ResponseOrderItemsInner)
    end
  end
  ...
  describe 'test attribute "unity_price"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
