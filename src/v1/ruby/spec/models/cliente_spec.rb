...
# Unit tests for OpenapiClient::Cliente
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Cliente do
  #let(:instance) { OpenapiClient::Cliente.new }

  describe 'test an instance of Cliente' do
    it 'should create an instance of Cliente' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Cliente)
    end
  end
  ...
  describe 'test attribute "document_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Cpf", "Cnpj"])
