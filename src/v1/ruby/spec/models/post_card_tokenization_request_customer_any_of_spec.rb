...
# Unit tests for OpenapiClient::PostCardTokenizationRequestCustomerAnyOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PostCardTokenizationRequestCustomerAnyOf do
  #let(:instance) { OpenapiClient::PostCardTokenizationRequestCustomerAnyOf.new }

  describe 'test an instance of PostCardTokenizationRequestCustomerAnyOf' do
    it 'should create an instance of PostCardTokenizationRequestCustomerAnyOf' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PostCardTokenizationRequestCustomerAnyOf)
    end
  end
