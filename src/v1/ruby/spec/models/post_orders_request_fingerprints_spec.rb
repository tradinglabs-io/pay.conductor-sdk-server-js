...
# Unit tests for OpenapiClient::PostOrdersRequestFingerprints
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PostOrdersRequestFingerprints do
  #let(:instance) { OpenapiClient::PostOrdersRequestFingerprints.new }

  describe 'test an instance of PostOrdersRequestFingerprints' do
    it 'should create an instance of PostOrdersRequestFingerprints' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PostOrdersRequestFingerprints)
    end
  end

  describe 'test attribute "threat_metrix_fingerprint_id"' do
    it 'should work' do
