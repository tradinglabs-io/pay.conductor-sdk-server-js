...
# Unit tests for OpenapiClient::PicPay
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PicPay do
  #let(:instance) { OpenapiClient::PicPay.new }

  describe 'test an instance of PicPay' do
    it 'should create an instance of PicPay' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PicPay)
    end
  end
