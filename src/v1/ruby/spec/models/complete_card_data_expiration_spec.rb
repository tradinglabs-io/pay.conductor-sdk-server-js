...
# Unit tests for OpenapiClient::CompleteCardDataExpiration
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CompleteCardDataExpiration do
  #let(:instance) { OpenapiClient::CompleteCardDataExpiration.new }

  describe 'test an instance of CompleteCardDataExpiration' do
    it 'should create an instance of CompleteCardDataExpiration' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CompleteCardDataExpiration)
    end
  end
