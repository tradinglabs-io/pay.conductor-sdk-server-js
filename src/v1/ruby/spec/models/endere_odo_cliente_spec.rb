...
# Unit tests for OpenapiClient::EndereODoCliente
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::EndereODoCliente do
  #let(:instance) { OpenapiClient::EndereODoCliente.new }

  describe 'test an instance of EndereODoCliente' do
    it 'should create an instance of EndereODoCliente' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::EndereODoCliente)
    end
  end
