...
# Unit tests for OpenapiClient::CartOTokenizado
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CartOTokenizado do
  #let(:instance) { OpenapiClient::CartOTokenizado.new }

  describe 'test an instance of CartOTokenizado' do
    it 'should create an instance of CartOTokenizado' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CartOTokenizado)
    end
  end
