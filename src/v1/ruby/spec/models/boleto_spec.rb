...
# Unit tests for OpenapiClient::Boleto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Boleto do
  #let(:instance) { OpenapiClient::Boleto.new }

  describe 'test an instance of Boleto' do
    it 'should create an instance of Boleto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Boleto)
    end
  end
