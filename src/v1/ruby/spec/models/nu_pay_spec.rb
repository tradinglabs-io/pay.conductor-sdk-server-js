...
# Unit tests for OpenapiClient::NuPay
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::NuPay do
  #let(:instance) { OpenapiClient::NuPay.new }

  describe 'test an instance of NuPay' do
    it 'should create an instance of NuPay' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::NuPay)
    end
  end
