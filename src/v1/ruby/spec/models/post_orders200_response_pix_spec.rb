...
# Unit tests for OpenapiClient::PostOrders200ResponsePix
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PostOrders200ResponsePix do
  #let(:instance) { OpenapiClient::PostOrders200ResponsePix.new }

  describe 'test an instance of PostOrders200ResponsePix' do
    it 'should create an instance of PostOrders200ResponsePix' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PostOrders200ResponsePix)
    end
  end
