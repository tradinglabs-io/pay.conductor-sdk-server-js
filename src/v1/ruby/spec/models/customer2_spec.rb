...
# Unit tests for OpenapiClient::Customer2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Customer2 do
  #let(:instance) { OpenapiClient::Customer2.new }

  describe 'test an instance of Customer2' do
    it 'should create an instance of Customer2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Customer2)
    end
  end
