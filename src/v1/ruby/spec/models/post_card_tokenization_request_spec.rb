...
# Unit tests for OpenapiClient::PostCardTokenizationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PostCardTokenizationRequest do
  #let(:instance) { OpenapiClient::PostCardTokenizationRequest.new }

  describe 'test an instance of PostCardTokenizationRequest' do
    it 'should create an instance of PostCardTokenizationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PostCardTokenizationRequest)
    end
  end
