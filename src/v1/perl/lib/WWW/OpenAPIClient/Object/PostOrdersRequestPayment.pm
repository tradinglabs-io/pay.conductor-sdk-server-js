...
__PACKAGE__->class_documentation({description => 'Dados de pagamento para o pedido (Pix, Cartão de Crédito, Boleto, NuPay, etc...)',
...
__PACKAGE__->method_documentation({
    ...
    'installments' => {
        datatype => 'CartODeCrDitoInstallments',
    ...
    'expiration_in_days' => {
        datatype => 'BoletoExpirationInDays',
