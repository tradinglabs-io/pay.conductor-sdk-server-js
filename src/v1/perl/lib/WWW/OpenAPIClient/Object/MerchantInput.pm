...
#
package WWW::OpenAPIClient::Object::MerchantInput;
...
__PACKAGE__->class_documentation({description => 'Dados do merchant para pedido ou saque',
                                  class => 'MerchantInput',
                                  required => [], # TODO
}                                 );
