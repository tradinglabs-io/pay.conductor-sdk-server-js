...
#
package WWW::OpenAPIClient::Object::NuPayNuPay;
...
__PACKAGE__->class_documentation({description => 'Dados específicos para pagamento via NuPay',
                                  class => 'NuPayNuPay',
                                  required => [], # TODO
}                                 );
