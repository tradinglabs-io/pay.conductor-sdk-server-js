...
#
package WWW::OpenAPIClient::Object::CartODeCrDitoInstallments;
...
__PACKAGE__->class_documentation({description => 'Número de parcelas',
                                  class => 'CartODeCrDitoInstallments',
                                  required => [], # TODO
}                                 );
