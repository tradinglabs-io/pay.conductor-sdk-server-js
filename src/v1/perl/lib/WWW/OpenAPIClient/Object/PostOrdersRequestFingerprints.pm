...
#
package WWW::OpenAPIClient::Object::PostOrdersRequestFingerprints;
...
__PACKAGE__->method_documentation({
    'threat_metrix_fingerprint_id' => {
        datatype => 'string',
        base_name => 'threatMetrixFingerprintId',
