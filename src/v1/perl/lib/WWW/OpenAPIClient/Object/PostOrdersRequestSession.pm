...
#
package WWW::OpenAPIClient::Object::PostOrdersRequestSession;
...
__PACKAGE__->class_documentation({description => 'Caso o externalSessionId ou sessionId sejam fornecidos e houver uma sessão existente, ela será atualizada com os novos dados. Caso contrário, uma nova sessão será criada.',
...
__PACKAGE__->method_documentation({
    ...
    'external_session_id' => {
        datatype => 'string',
        base_name => 'externalSessionId',
        description => 'Id da sessão de checkout gerado pelo lado do cliente. O id deve ser único para cada sessão de carrinho',
        format => '',
        read_only => '',
            },
});
