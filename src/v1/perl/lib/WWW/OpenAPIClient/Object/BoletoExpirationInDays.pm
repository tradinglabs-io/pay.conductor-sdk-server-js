...
#
package WWW::OpenAPIClient::Object::BoletoExpirationInDays;
...
__PACKAGE__->class_documentation({description => 'Dias até o vencimento do boleto',
                                  class => 'BoletoExpirationInDays',
                                  required => [], # TODO
}                                 );
