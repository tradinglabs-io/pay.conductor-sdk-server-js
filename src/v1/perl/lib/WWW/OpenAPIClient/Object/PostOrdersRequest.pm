...
#
package WWW::OpenAPIClient::Object::PostOrdersRequest;
...
__PACKAGE__->method_documentation({
    ...
    'fingerprints' => {
        datatype => 'PostOrdersRequestFingerprints',
    ...
    'payment' => {
        datatype => 'PostOrdersRequestPayment',
        base_name => 'payment',
        description => '',
        format => '',
        read_only => '',
    ...
    'session' => {
        datatype => 'PostOrdersRequestSession',
        base_name => 'session',
        description => '',
        format => '',
        read_only => '',
