...
#
package WWW::OpenAPIClient::Object::CartODeCrDitoCard;
...
__PACKAGE__->method_documentation({
    ...
    'expiration' => {
        datatype => 'DadosCompletosDoCartOExpiration',
