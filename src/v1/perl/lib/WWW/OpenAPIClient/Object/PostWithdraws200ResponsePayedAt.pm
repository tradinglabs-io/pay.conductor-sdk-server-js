...
#
package WWW::OpenAPIClient::Object::PostWithdraws200ResponsePayedAt;
...
__PACKAGE__->class_documentation({description => 'Date and time when the withdrawal was paid (ISO 8601 format)',
