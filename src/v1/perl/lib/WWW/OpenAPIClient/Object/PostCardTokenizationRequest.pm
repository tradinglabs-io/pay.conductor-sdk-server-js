...
#
package WWW::OpenAPIClient::Object::PostCardTokenizationRequest;
...
__PACKAGE__->class_documentation({description => 'Data for creating a customer card',
...
__PACKAGE__->method_documentation({
    ...
    'customer' => {
        datatype => 'PostCardTokenizationRequestCustomer',
        base_name => 'customer',
        description => '',
        format => '',
        read_only => '',
