...
#
package WWW::OpenAPIClient::Object::Cliente;
...
__PACKAGE__->class_documentation({description => 'Schema para criação de um novo cliente',
                                  class => 'Cliente',
                                  required => [], # TODO
}                                 );
