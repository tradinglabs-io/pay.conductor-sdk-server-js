...
#
package WWW::OpenAPIClient::Object::EndereODoCliente;
...
__PACKAGE__->class_documentation({description => 'Schema para criação de um novo endereço',
