# WWW::OpenAPIClient::SaquesETransfernciasApi

## Load the API package
```perl
use WWW::OpenAPIClient::Object::SaquesETransfernciasApi;
```
...
my $api_instance = WWW::OpenAPIClient::SaquesETransfernciasApi->new(
...
if ($@) {
    warn "Exception when calling SaquesETransfernciasApi->get_withdraws: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling SaquesETransfernciasApi->get_withdraws_by_id: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling SaquesETransfernciasApi->post_withdraws: $@\n";
}
```
