...
pub struct PostWithdrawsRequest {
    ...
    pub payout_account: Box<models::PostWithdrawsRequestPayoutAccount>,
}

impl PostWithdrawsRequest {
    pub fn new(amount: f64, payout_account: models::PostWithdrawsRequestPayoutAccount) -> PostWithdrawsRequest {
