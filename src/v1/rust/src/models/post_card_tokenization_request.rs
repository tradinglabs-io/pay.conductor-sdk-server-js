...
pub struct PostCardTokenizationRequest {
    #[serde(rename = "card")]
    pub card: Box<models::CompleteCardData>,
    /// Indicates if the card should be saved for future use
    #[serde(rename = "saveCard")]
    pub save_card: bool,
    #[serde(rename = "customer")]
    pub customer: Box<models::PostCardTokenizationRequestCustomer>,
}

impl PostCardTokenizationRequest {
    /// Data for creating a customer card
    pub fn new(card: models::CompleteCardData, save_card: bool, customer: models::PostCardTokenizationRequestCustomer) -> PostCardTokenizationRequest {
