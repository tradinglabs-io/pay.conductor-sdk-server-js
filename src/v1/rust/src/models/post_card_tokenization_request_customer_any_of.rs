...
pub struct PostCardTokenizationRequestCustomerAnyOf {
    /// ID do cliente existente
    #[serde(rename = "id")]
    pub id: String,
}

impl PostCardTokenizationRequestCustomerAnyOf {
    pub fn new(id: String) -> PostCardTokenizationRequestCustomerAnyOf {
