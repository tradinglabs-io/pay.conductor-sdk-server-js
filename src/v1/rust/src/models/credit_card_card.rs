...
pub struct CreditCardCard {
    ...
    pub expiration: Box<models::CompleteCardDataExpiration>,
    /// Card holder name
...
impl CreditCardCard {
    pub fn new(token: String, cvv: String, expiration: models::CompleteCardDataExpiration, holder_name: String, number: String) -> CreditCardCard {
        CreditCardCard {
