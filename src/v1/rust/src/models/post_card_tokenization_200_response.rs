...
pub struct PostCardTokenization200Response {
...
impl PostCardTokenization200Response {
    pub fn new(customer_id: String, token: String) -> PostCardTokenization200Response {
