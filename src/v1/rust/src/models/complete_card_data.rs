...
impl CompleteCardData {
    pub fn new(cvv: String, expiration: models::CompleteCardDataExpiration, holder_name: String, number: String) -> CompleteCardData {
        CompleteCardData {
            cvv,
