...
pub struct DadosCompletosDoCartO {
...
impl DadosCompletosDoCartO {
    pub fn new(cvv: String, expiration: models::DadosCompletosDoCartOExpiration, holder_name: String, number: String) -> DadosCompletosDoCartO {
