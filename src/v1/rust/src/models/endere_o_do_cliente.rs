...
impl EndereODoCliente {
    /// Schema para criação de um novo endereço
    pub fn new(city: String, country: String, neighborhood: String, number: String, state: String, street: String, zip_code: String) -> EndereODoCliente {
        EndereODoCliente {
            city,
            country,
            neighborhood,
