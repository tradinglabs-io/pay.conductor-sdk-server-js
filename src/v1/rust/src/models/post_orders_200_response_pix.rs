...
pub struct PostOrders200ResponsePix {
    /// Código copia e cola do PIX
    #[serde(rename = "copyAndPasteCode")]
    pub copy_and_paste_code: String,
    /// URL da imagem do QR Code PIX
    #[serde(rename = "qrCodeUrl")]
    pub qr_code_url: String,
    /// E2E ID do PIX
    #[serde(rename = "endToEndId", deserialize_with = "Option::deserialize")]
    pub end_to_end_id: Option<String>,
}

impl PostOrders200ResponsePix {
    /// Dados do PIX
    pub fn new(copy_and_paste_code: String, qr_code_url: String, end_to_end_id: Option<String>) -> PostOrders200ResponsePix {
