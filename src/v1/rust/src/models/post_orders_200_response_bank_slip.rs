...
pub struct PostOrders200ResponseBankSlip {
    /// Bank slip bar code
...
impl PostOrders200ResponseBankSlip {
    pub fn new(bar_code: String, digitable_line: String) -> PostOrders200ResponseBankSlip {
