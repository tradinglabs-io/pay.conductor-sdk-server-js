...
pub struct PostOrders200ResponsePicPay {
...
impl PostOrders200ResponsePicPay {
    pub fn new(copy_and_paste_code: String, qr_code_url: String) -> PostOrders200ResponsePicPay {
