...
// checks if the OrderNuPayInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderNuPayInfo{}

// OrderNuPayInfo NuPay payment data
type OrderNuPayInfo struct {
	// NuPay payment URL
	PaymentUrl string `json:"paymentUrl"`
}

type _OrderNuPayInfo OrderNuPayInfo
...
func (o OrderNuPayInfo) MarshalJSON() ([]byte, error) {
...
func (o OrderNuPayInfo) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["paymentUrl"] = o.PaymentUrl
	return toSerialize, nil
}

func (o *OrderNuPayInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varOrderNuPayInfo := _OrderNuPayInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOrderNuPayInfo)

	if err != nil {
		return err
	}

	*o = OrderNuPayInfo(varOrderNuPayInfo)

	return err
}

type NullableOrderNuPayInfo struct {
	value *OrderNuPayInfo
	isSet bool
}

func (v NullableOrderNuPayInfo) Get() *OrderNuPayInfo {
	return v.value
}

func (v *NullableOrderNuPayInfo) Set(val *OrderNuPayInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderNuPayInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderNuPayInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderNuPayInfo(val *OrderNuPayInfo) *NullableOrderNuPayInfo {
	return &NullableOrderNuPayInfo{value: val, isSet: true}
}

func (v NullableOrderNuPayInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderNuPayInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
