...
// checks if the OrderCreditCardInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderCreditCardInfo{}

// OrderCreditCardInfo Credit card payment data
type OrderCreditCardInfo struct {
	// Transaction authorization code
	AuthorizationCode *string `json:"authorizationCode,omitempty"`
}

// NewOrderCreditCardInfo instantiates a new OrderCreditCardInfo object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewOrderCreditCardInfo() *OrderCreditCardInfo {
	this := OrderCreditCardInfo{}
	return &this
}

// NewOrderCreditCardInfoWithDefaults instantiates a new OrderCreditCardInfo object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewOrderCreditCardInfoWithDefaults() *OrderCreditCardInfo {
	this := OrderCreditCardInfo{}
	return &this
}

// GetAuthorizationCode returns the AuthorizationCode field value if set, zero value otherwise.
func (o *OrderCreditCardInfo) GetAuthorizationCode() string {
...
func (o *OrderCreditCardInfo) GetAuthorizationCodeOk() (*string, bool) {
	if o == nil || IsNil(o.AuthorizationCode) {
		return nil, false
	}
...
func (o *OrderCreditCardInfo) HasAuthorizationCode() bool {
	if o != nil && !IsNil(o.AuthorizationCode) {
		return true
	}
...
func (o *OrderCreditCardInfo) SetAuthorizationCode(v string) {
	o.AuthorizationCode = &v
}

func (o OrderCreditCardInfo) MarshalJSON() ([]byte, error) {
...
func (o OrderCreditCardInfo) ToMap() (map[string]interface{}, error) {
...
type NullableOrderCreditCardInfo struct {
	value *OrderCreditCardInfo
	isSet bool
}

func (v NullableOrderCreditCardInfo) Get() *OrderCreditCardInfo {
	return v.value
}

func (v *NullableOrderCreditCardInfo) Set(val *OrderCreditCardInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderCreditCardInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderCreditCardInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderCreditCardInfo(val *OrderCreditCardInfo) *NullableOrderCreditCardInfo {
	return &NullableOrderCreditCardInfo{value: val, isSet: true}
}

func (v NullableOrderCreditCardInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderCreditCardInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
