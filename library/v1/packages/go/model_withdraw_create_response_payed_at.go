...
// WithdrawCreateResponsePayedAt Date and time when the withdrawal was paid (ISO 8601 format)
type WithdrawCreateResponsePayedAt struct {
	Date *Date
	Float32 *float32
	String *string
	TimeTime *time.Time
...
func (dst *WithdrawCreateResponsePayedAt) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(WithdrawCreateResponsePayedAt)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src WithdrawCreateResponsePayedAt) MarshalJSON() ([]byte, error) {
	if src.Date != nil {
...
type NullableWithdrawCreateResponsePayedAt struct {
	value *WithdrawCreateResponsePayedAt
	isSet bool
}

func (v NullableWithdrawCreateResponsePayedAt) Get() *WithdrawCreateResponsePayedAt {
	return v.value
}

func (v *NullableWithdrawCreateResponsePayedAt) Set(val *WithdrawCreateResponsePayedAt) {
	v.value = val
	v.isSet = true
}

func (v NullableWithdrawCreateResponsePayedAt) IsSet() bool {
	return v.isSet
}

func (v *NullableWithdrawCreateResponsePayedAt) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWithdrawCreateResponsePayedAt(val *WithdrawCreateResponsePayedAt) *NullableWithdrawCreateResponsePayedAt {
	return &NullableWithdrawCreateResponsePayedAt{value: val, isSet: true}
}

func (v NullableWithdrawCreateResponsePayedAt) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWithdrawCreateResponsePayedAt) UnmarshalJSON(src []byte) error {
	v.isSet = true
