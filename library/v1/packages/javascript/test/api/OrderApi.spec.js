  ...
  describe('OrderApi', function() {
    describe('orderConfirm', function() {
      it('should call orderConfirm successfully', function(done) {
        //uncomment below and update the code to test orderConfirm
        //instance.orderConfirm(function(error) {
    ...
    describe('orderRead', function() {
      it('should call orderRead successfully', function(done) {
        //uncomment below and update the code to test orderRead
        //instance.orderRead(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('orderRefund', function() {
      it('should call orderRefund successfully', function(done) {
        //uncomment below and update the code to test orderRefund
        //instance.orderRefund(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
