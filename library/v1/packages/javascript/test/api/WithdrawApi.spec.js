...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.WithdrawApi();
  });
  ...
  describe('WithdrawApi', function() {
    describe('withdrawCreate', function() {
      it('should call withdrawCreate successfully', function(done) {
        //uncomment below and update the code to test withdrawCreate
        //instance.withdrawCreate(function(error) {
    ...
    describe('withdrawList', function() {
      it('should call withdrawList successfully', function(done) {
        //uncomment below and update the code to test withdrawList
        //instance.withdrawList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('withdrawRead', function() {
      it('should call withdrawRead successfully', function(done) {
        //uncomment below and update the code to test withdrawRead
        //instance.withdrawRead(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
