...
(function(root, factory) {
  ...
  describe('CustomerApi', function() {
    ...
    describe('customerListCustom', function() {
      it('should call customerListCustom successfully', function(done) {
        //uncomment below and update the code to test customerListCustom
        //instance.customerListCustom(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('customerRead', function() {
      it('should call customerRead successfully', function(done) {
        //uncomment below and update the code to test customerRead
        //instance.customerRead(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
