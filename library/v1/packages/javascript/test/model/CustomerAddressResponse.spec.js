...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.CustomerAddressResponse();
  });
  ...
  describe('CustomerAddressResponse', function() {
    it('should create an instance of CustomerAddressResponse', function() {
      // uncomment below and update the code to test CustomerAddressResponse
      //var instance = new PayconductorSdk.CustomerAddressResponse();
      //expect(instance).to.be.a(PayconductorSdk.CustomerAddressResponse);
    });
