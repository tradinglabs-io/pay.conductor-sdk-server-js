...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.OrderPicPayInfo();
  });
  ...
  describe('OrderPicPayInfo', function() {
    it('should create an instance of OrderPicPayInfo', function() {
      // uncomment below and update the code to test OrderPicPayInfo
      //var instance = new PayconductorSdk.OrderPicPayInfo();
      //expect(instance).to.be.a(PayconductorSdk.OrderPicPayInfo);
    });
