...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.CustomerCreateRequest();
  });
  ...
  describe('CustomerCreateRequest', function() {
    it('should create an instance of CustomerCreateRequest', function() {
      ...
      //var instance = new PayconductorSdk.CustomerCreateRequest();
      //expect(instance).to.be.a(PayconductorSdk.CustomerCreateRequest);
    });
