...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.CardTokenizationCustomerByIdData();
  });
  ...
  describe('CardTokenizationCustomerByIdData', function() {
    it('should create an instance of CardTokenizationCustomerByIdData', function() {
      // uncomment below and update the code to test CardTokenizationCustomerByIdData
      //var instance = new PayconductorSdk.CardTokenizationCustomerByIdData();
      //expect(instance).to.be.a(PayconductorSdk.CardTokenizationCustomerByIdData);
    });
