...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.OrderBankSlipPaymentRequest();
  });
  ...
  describe('OrderBankSlipPaymentRequest', function() {
    it('should create an instance of OrderBankSlipPaymentRequest', function() {
      // uncomment below and update the code to test OrderBankSlipPaymentRequest
      //var instance = new PayconductorSdk.OrderBankSlipPaymentRequest();
      //expect(instance).to.be.a(PayconductorSdk.OrderBankSlipPaymentRequest);
    });
