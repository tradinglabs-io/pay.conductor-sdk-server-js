...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.CustomerUpdateRequest();
  });
  ...
  describe('CustomerUpdateRequest', function() {
    it('should create an instance of CustomerUpdateRequest', function() {
      // uncomment below and update the code to test CustomerUpdateRequest
      //var instance = new PayconductorSdk.CustomerUpdateRequest();
      //expect(instance).to.be.a(PayconductorSdk.CustomerUpdateRequest);
    });
