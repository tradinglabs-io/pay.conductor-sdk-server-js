...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.OrderCreateRequestSession();
  });
  ...
  describe('OrderCreateRequestSession', function() {
    it('should create an instance of OrderCreateRequestSession', function() {
      // uncomment below and update the code to test OrderCreateRequestSession
      //var instance = new PayconductorSdk.OrderCreateRequestSession();
      //expect(instance).to.be.a(PayconductorSdk.OrderCreateRequestSession);
    });
