...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.OrderNuPayPaymentRequestNuPay();
  });
  ...
  describe('OrderNuPayPaymentRequestNuPay', function() {
    it('should create an instance of OrderNuPayPaymentRequestNuPay', function() {
      // uncomment below and update the code to test OrderNuPayPaymentRequestNuPay
      //var instance = new PayconductorSdk.OrderNuPayPaymentRequestNuPay();
      //expect(instance).to.be.a(PayconductorSdk.OrderNuPayPaymentRequestNuPay);
    });
