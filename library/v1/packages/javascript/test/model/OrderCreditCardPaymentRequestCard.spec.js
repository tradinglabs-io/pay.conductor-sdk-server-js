...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.OrderCreditCardPaymentRequestCard();
  });
  ...
  describe('OrderCreditCardPaymentRequestCard', function() {
    it('should create an instance of OrderCreditCardPaymentRequestCard', function() {
      // uncomment below and update the code to test OrderCreditCardPaymentRequestCard
      //var instance = new PayconductorSdk.OrderCreditCardPaymentRequestCard();
      //expect(instance).to.be.a(PayconductorSdk.OrderCreditCardPaymentRequestCard);
    });

    it('should have the property firstSixCardNumber (base name: "firstSixCardNumber")', function() {
      // uncomment below and update the code to test the property firstSixCardNumber
      //var instance = new PayconductorSdk.OrderCreditCardPaymentRequestCard();
