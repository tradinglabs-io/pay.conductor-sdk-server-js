...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.OrderNuPayInfo();
  });
  ...
  describe('OrderNuPayInfo', function() {
    it('should create an instance of OrderNuPayInfo', function() {
      // uncomment below and update the code to test OrderNuPayInfo
      //var instance = new PayconductorSdk.OrderNuPayInfo();
      //expect(instance).to.be.a(PayconductorSdk.OrderNuPayInfo);
    });
