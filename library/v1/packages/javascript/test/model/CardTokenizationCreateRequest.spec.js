...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.CardTokenizationCreateRequest();
  });
  ...
  describe('CardTokenizationCreateRequest', function() {
    it('should create an instance of CardTokenizationCreateRequest', function() {
      // uncomment below and update the code to test CardTokenizationCreateRequest
      //var instance = new PayconductorSdk.CardTokenizationCreateRequest();
      //expect(instance).to.be.a(PayconductorSdk.CardTokenizationCreateRequest);
    });
    ...
    it('should have the property saveCard (base name: "saveCard")', function() {
      // uncomment below and update the code to test the property saveCard
      //var instance = new PayconductorSdk.CardTokenizationCreateRequest();
      //expect(instance).to.be();
    });
