...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.OrderTokenizedCardData();
  });
  ...
  describe('OrderTokenizedCardData', function() {
    it('should create an instance of OrderTokenizedCardData', function() {
      // uncomment below and update the code to test OrderTokenizedCardData
      //var instance = new PayconductorSdk.OrderTokenizedCardData();
      //expect(instance).to.be.a(PayconductorSdk.OrderTokenizedCardData);
    });
