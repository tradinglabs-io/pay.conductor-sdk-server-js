...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.OrderNuPayPaymentRequest();
  });
  ...
  describe('OrderNuPayPaymentRequest', function() {
    it('should create an instance of OrderNuPayPaymentRequest', function() {
      // uncomment below and update the code to test OrderNuPayPaymentRequest
      //var instance = new PayconductorSdk.OrderNuPayPaymentRequest();
      //expect(instance).to.be.a(PayconductorSdk.OrderNuPayPaymentRequest);
    });
