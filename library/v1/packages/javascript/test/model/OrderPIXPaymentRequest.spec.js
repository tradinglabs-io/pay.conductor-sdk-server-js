...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.OrderPIXPaymentRequest();
  });
  ...
  describe('OrderPIXPaymentRequest', function() {
    it('should create an instance of OrderPIXPaymentRequest', function() {
      // uncomment below and update the code to test OrderPIXPaymentRequest
      //var instance = new PayconductorSdk.OrderPIXPaymentRequest();
      //expect(instance).to.be.a(PayconductorSdk.OrderPIXPaymentRequest);
    });
