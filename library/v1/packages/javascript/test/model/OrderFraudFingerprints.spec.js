...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.OrderFraudFingerprints();
  });
  ...
  describe('OrderFraudFingerprints', function() {
    it('should create an instance of OrderFraudFingerprints', function() {
      // uncomment below and update the code to test OrderFraudFingerprints
      //var instance = new PayconductorSdk.OrderFraudFingerprints();
      //expect(instance).to.be.a(PayconductorSdk.OrderFraudFingerprints);
    });
