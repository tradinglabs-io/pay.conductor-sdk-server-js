...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.OrderPicPayPaymentRequest();
  });
  ...
  describe('OrderPicPayPaymentRequest', function() {
    it('should create an instance of OrderPicPayPaymentRequest', function() {
      // uncomment below and update the code to test OrderPicPayPaymentRequest
      //var instance = new PayconductorSdk.OrderPicPayPaymentRequest();
      //expect(instance).to.be.a(PayconductorSdk.OrderPicPayPaymentRequest);
    });
