...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.OrderCreateRequest();
  });
  ...
  describe('OrderCreateRequest', function() {
    it('should create an instance of OrderCreateRequest', function() {
      ...
      //var instance = new PayconductorSdk.OrderCreateRequest();
      //expect(instance).to.be.a(PayconductorSdk.OrderCreateRequest);
    });
