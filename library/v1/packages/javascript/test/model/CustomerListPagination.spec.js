...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.CustomerListPagination();
  });
  ...
  describe('CustomerListPagination', function() {
    it('should create an instance of CustomerListPagination', function() {
      // uncomment below and update the code to test CustomerListPagination
      //var instance = new PayconductorSdk.CustomerListPagination();
      //expect(instance).to.be.a(PayconductorSdk.CustomerListPagination);
    });
