...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.CardExpirationData();
  });
  ...
  describe('CardExpirationData', function() {
    it('should create an instance of CardExpirationData', function() {
      // uncomment below and update the code to test CardExpirationData
      //var instance = new PayconductorSdk.CardExpirationData();
      //expect(instance).to.be.a(PayconductorSdk.CardExpirationData);
    });
