...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.CustomerListResponse();
  });
  ...
  describe('CustomerListResponse', function() {
    it('should create an instance of CustomerListResponse', function() {
      ...
      //var instance = new PayconductorSdk.CustomerListResponse();
      //expect(instance).to.be.a(PayconductorSdk.CustomerListResponse);
    });
