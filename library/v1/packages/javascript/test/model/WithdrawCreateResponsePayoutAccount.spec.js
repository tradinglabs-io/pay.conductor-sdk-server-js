...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.WithdrawCreateResponsePayoutAccount();
  });
  ...
  describe('WithdrawCreateResponsePayoutAccount', function() {
    it('should create an instance of WithdrawCreateResponsePayoutAccount', function() {
      // uncomment below and update the code to test WithdrawCreateResponsePayoutAccount
      //var instance = new PayconductorSdk.WithdrawCreateResponsePayoutAccount();
      //expect(instance).to.be.a(PayconductorSdk.WithdrawCreateResponsePayoutAccount);
    });
