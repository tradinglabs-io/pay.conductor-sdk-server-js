...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.CardTokenizationCreateResponse();
  });
  ...
  describe('CardTokenizationCreateResponse', function() {
    it('should create an instance of CardTokenizationCreateResponse', function() {
      // uncomment below and update the code to test CardTokenizationCreateResponse
      //var instance = new PayconductorSdk.CardTokenizationCreateResponse();
      //expect(instance).to.be.a(PayconductorSdk.CardTokenizationCreateResponse);
    });
