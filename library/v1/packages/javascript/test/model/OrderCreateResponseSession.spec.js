...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.OrderCreateResponseSession();
  });
  ...
  describe('OrderCreateResponseSession', function() {
    it('should create an instance of OrderCreateResponseSession', function() {
      // uncomment below and update the code to test OrderCreateResponseSession
      //var instance = new PayconductorSdk.OrderCreateResponseSession();
      //expect(instance).to.be.a(PayconductorSdk.OrderCreateResponseSession);
    });
