...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.WithdrawCreateRequest();
  });
  ...
  describe('WithdrawCreateRequest', function() {
    it('should create an instance of WithdrawCreateRequest', function() {
      // uncomment below and update the code to test WithdrawCreateRequest
      //var instance = new PayconductorSdk.WithdrawCreateRequest();
      //expect(instance).to.be.a(PayconductorSdk.WithdrawCreateRequest);
    });
