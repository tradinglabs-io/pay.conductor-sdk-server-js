...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.CustomerReadResponse();
  });
  ...
  describe('CustomerReadResponse', function() {
    it('should create an instance of CustomerReadResponse', function() {
      // uncomment below and update the code to test CustomerReadResponse
      //var instance = new PayconductorSdk.CustomerReadResponse();
      //expect(instance).to.be.a(PayconductorSdk.CustomerReadResponse);
    });
