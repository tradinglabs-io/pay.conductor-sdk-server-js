...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.CardCreateRequest();
  });
  ...
  describe('CardCreateRequest', function() {
    it('should create an instance of CardCreateRequest', function() {
      ...
      //var instance = new PayconductorSdk.CardCreateRequest();
      //expect(instance).to.be.a(PayconductorSdk.CardCreateRequest);
    });
