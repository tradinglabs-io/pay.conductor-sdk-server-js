...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.OrderCreateResponseOrderItemsInner();
  });
  ...
  describe('OrderCreateResponseOrderItemsInner', function() {
    it('should create an instance of OrderCreateResponseOrderItemsInner', function() {
      // uncomment below and update the code to test OrderCreateResponseOrderItemsInner
      //var instance = new PayconductorSdk.OrderCreateResponseOrderItemsInner();
      //expect(instance).to.be.a(PayconductorSdk.OrderCreateResponseOrderItemsInner);
    });
