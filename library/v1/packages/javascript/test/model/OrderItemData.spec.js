...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.OrderItemData();
  });
  ...
  describe('OrderItemData', function() {
    it('should create an instance of OrderItemData', function() {
      // uncomment below and update the code to test OrderItemData
      //var instance = new PayconductorSdk.OrderItemData();
      //expect(instance).to.be.a(PayconductorSdk.OrderItemData);
    });
