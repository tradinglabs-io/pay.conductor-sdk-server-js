...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.CardTokenizationCreateRequestCustomer();
  });
  ...
  describe('CardTokenizationCreateRequestCustomer', function() {
    it('should create an instance of CardTokenizationCreateRequestCustomer', function() {
      // uncomment below and update the code to test CardTokenizationCreateRequestCustomer
      //var instance = new PayconductorSdk.CardTokenizationCreateRequestCustomer();
      //expect(instance).to.be.a(PayconductorSdk.CardTokenizationCreateRequestCustomer);
    });
