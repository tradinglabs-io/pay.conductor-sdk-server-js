...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.OrderDraftPaymentRequest();
  });
  ...
  describe('OrderDraftPaymentRequest', function() {
    it('should create an instance of OrderDraftPaymentRequest', function() {
      // uncomment below and update the code to test OrderDraftPaymentRequest
      //var instance = new PayconductorSdk.OrderDraftPaymentRequest();
      //expect(instance).to.be.a(PayconductorSdk.OrderDraftPaymentRequest);
    });
