...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.OrderBankSlipInfo();
  });
  ...
  describe('OrderBankSlipInfo', function() {
    it('should create an instance of OrderBankSlipInfo', function() {
      // uncomment below and update the code to test OrderBankSlipInfo
      //var instance = new PayconductorSdk.OrderBankSlipInfo();
      //expect(instance).to.be.a(PayconductorSdk.OrderBankSlipInfo);
    });
