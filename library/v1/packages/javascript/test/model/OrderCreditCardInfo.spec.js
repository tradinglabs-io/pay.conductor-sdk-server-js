...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.OrderCreditCardInfo();
  });
  ...
  describe('OrderCreditCardInfo', function() {
    it('should create an instance of OrderCreditCardInfo', function() {
      // uncomment below and update the code to test OrderCreditCardInfo
      //var instance = new PayconductorSdk.OrderCreditCardInfo();
      //expect(instance).to.be.a(PayconductorSdk.OrderCreditCardInfo);
    });
