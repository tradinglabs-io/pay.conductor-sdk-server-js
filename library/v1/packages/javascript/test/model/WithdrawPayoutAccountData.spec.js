...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.WithdrawPayoutAccountData();
  });
  ...
  describe('WithdrawPayoutAccountData', function() {
    it('should create an instance of WithdrawPayoutAccountData', function() {
      // uncomment below and update the code to test WithdrawPayoutAccountData
      //var instance = new PayconductorSdk.WithdrawPayoutAccountData();
      //expect(instance).to.be.a(PayconductorSdk.WithdrawPayoutAccountData);
    });
