...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.WithdrawCreateResponse();
  });
  ...
  describe('WithdrawCreateResponse', function() {
    it('should create an instance of WithdrawCreateResponse', function() {
      // uncomment below and update the code to test WithdrawCreateResponse
      //var instance = new PayconductorSdk.WithdrawCreateResponse();
      //expect(instance).to.be.a(PayconductorSdk.WithdrawCreateResponse);
    });
