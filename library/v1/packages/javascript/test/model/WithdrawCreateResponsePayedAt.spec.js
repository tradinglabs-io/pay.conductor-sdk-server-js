...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.WithdrawCreateResponsePayedAt();
  });
  ...
  describe('WithdrawCreateResponsePayedAt', function() {
    it('should create an instance of WithdrawCreateResponsePayedAt', function() {
      // uncomment below and update the code to test WithdrawCreateResponsePayedAt
      //var instance = new PayconductorSdk.WithdrawCreateResponsePayedAt();
      //expect(instance).to.be.a(PayconductorSdk.WithdrawCreateResponsePayedAt);
    });
