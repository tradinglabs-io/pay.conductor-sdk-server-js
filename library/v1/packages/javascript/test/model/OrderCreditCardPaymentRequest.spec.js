...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.OrderCreditCardPaymentRequest();
  });
  ...
  describe('OrderCreditCardPaymentRequest', function() {
    it('should create an instance of OrderCreditCardPaymentRequest', function() {
      // uncomment below and update the code to test OrderCreditCardPaymentRequest
      //var instance = new PayconductorSdk.OrderCreditCardPaymentRequest();
      //expect(instance).to.be.a(PayconductorSdk.OrderCreditCardPaymentRequest);
    });
