...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.OrderConfirmResponse();
  });
  ...
  describe('OrderConfirmResponse', function() {
    it('should create an instance of OrderConfirmResponse', function() {
      // uncomment below and update the code to test OrderConfirmResponse
      //var instance = new PayconductorSdk.OrderConfirmResponse();
      //expect(instance).to.be.a(PayconductorSdk.OrderConfirmResponse);
    });
