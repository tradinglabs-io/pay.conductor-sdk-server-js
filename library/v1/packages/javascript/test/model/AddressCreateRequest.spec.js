...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.AddressCreateRequest();
  });
  ...
  describe('AddressCreateRequest', function() {
    it('should create an instance of AddressCreateRequest', function() {
      // uncomment below and update the code to test AddressCreateRequest
      //var instance = new PayconductorSdk.AddressCreateRequest();
      //expect(instance).to.be.a(PayconductorSdk.AddressCreateRequest);
    });
