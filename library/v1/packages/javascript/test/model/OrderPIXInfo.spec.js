...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.OrderPIXInfo();
  });
  ...
  describe('OrderPIXInfo', function() {
    it('should create an instance of OrderPIXInfo', function() {
      // uncomment below and update the code to test OrderPIXInfo
      //var instance = new PayconductorSdk.OrderPIXInfo();
      //expect(instance).to.be.a(PayconductorSdk.OrderPIXInfo);
    });
