...
/**
 * The OrderCreateResponseSession model module.
 * @module model/OrderCreateResponseSession
 * @version 1.0.0
 */
class OrderCreateResponseSession {
    /**
     * Constructs a new <code>OrderCreateResponseSession</code>.
     * @alias module:model/OrderCreateResponseSession
     * @param sessionId {String} ID of the checkout session associated with the order
     */
    constructor(sessionId) { 
        
        OrderCreateResponseSession.initialize(this, sessionId);
    }
    ...
    /**
     * Constructs a <code>OrderCreateResponseSession</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderCreateResponseSession} obj Optional instance to populate.
     * @return {module:model/OrderCreateResponseSession} The populated <code>OrderCreateResponseSession</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderCreateResponseSession();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderCreateResponseSession</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderCreateResponseSession</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OrderCreateResponseSession.RequiredProperties) {
...
OrderCreateResponseSession.RequiredProperties = ["sessionId"];

/**
 * ID of the checkout session associated with the order
 * @member {String} sessionId
 */
OrderCreateResponseSession.prototype['sessionId'] = undefined;
...
export default OrderCreateResponseSession;
