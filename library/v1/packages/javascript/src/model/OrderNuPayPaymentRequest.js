 ...
 * @module model/OrderNuPayPaymentRequest
 * @version 1.0.0
 */
class OrderNuPayPaymentRequest {
    /**
    ...
    constructor(paymentMethod, nuPay) { 
        ...
        OrderNuPayPaymentRequest.initialize(this, paymentMethod, nuPay);
    }
    ...
    /**
     * Constructs a <code>OrderNuPayPaymentRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderNuPayPaymentRequest} obj Optional instance to populate.
     * @return {module:model/OrderNuPayPaymentRequest} The populated <code>OrderNuPayPaymentRequest</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>OrderNuPayPaymentRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderNuPayPaymentRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OrderNuPayPaymentRequest.RequiredProperties) {
 ...
 */
OrderNuPayPaymentRequest.prototype['nuPay'] = undefined;
...
export default OrderNuPayPaymentRequest;
