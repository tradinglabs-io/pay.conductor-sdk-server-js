...
/**
 * The OrderPicPayPaymentRequest model module.
 * @module model/OrderPicPayPaymentRequest
 * @version 1.0.0
 */
class OrderPicPayPaymentRequest {
    /**
     * Constructs a new <code>OrderPicPayPaymentRequest</code>.
     * @alias module:model/OrderPicPayPaymentRequest
     * @param paymentMethod {module:model/PaymentMethod} 
     */
    constructor(paymentMethod) { 
        
        OrderPicPayPaymentRequest.initialize(this, paymentMethod);
    }
    ...
    /**
     * Constructs a <code>OrderPicPayPaymentRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderPicPayPaymentRequest} obj Optional instance to populate.
     * @return {module:model/OrderPicPayPaymentRequest} The populated <code>OrderPicPayPaymentRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderPicPayPaymentRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderPicPayPaymentRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderPicPayPaymentRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OrderPicPayPaymentRequest.RequiredProperties) {
...
OrderPicPayPaymentRequest.RequiredProperties = ["paymentMethod"];

/**
 * @member {module:model/PaymentMethod} paymentMethod
 */
OrderPicPayPaymentRequest.prototype['paymentMethod'] = undefined;
...
export default OrderPicPayPaymentRequest;
