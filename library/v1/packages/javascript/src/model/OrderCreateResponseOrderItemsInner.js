...
/**
 * The OrderCreateResponseOrderItemsInner model module.
 * @module model/OrderCreateResponseOrderItemsInner
 * @version 1.0.0
 */
class OrderCreateResponseOrderItemsInner {
    /**
     * Constructs a new <code>OrderCreateResponseOrderItemsInner</code>.
     * @alias module:model/OrderCreateResponseOrderItemsInner
    ...
    constructor(externalId, id, name, qty, totalAmount, totalNetAmount, unityPrice) { 
        ...
        OrderCreateResponseOrderItemsInner.initialize(this, externalId, id, name, qty, totalAmount, totalNetAmount, unityPrice);
    }
    ...
    /**
     * Constructs a <code>OrderCreateResponseOrderItemsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderCreateResponseOrderItemsInner} obj Optional instance to populate.
     * @return {module:model/OrderCreateResponseOrderItemsInner} The populated <code>OrderCreateResponseOrderItemsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderCreateResponseOrderItemsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderCreateResponseOrderItemsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderCreateResponseOrderItemsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OrderCreateResponseOrderItemsInner.RequiredProperties) {
...
OrderCreateResponseOrderItemsInner.RequiredProperties = ["externalId", "id", "name", "qty", "totalAmount", "totalNetAmount", "unityPrice"];

/**
 * External item ID
 * @member {String} externalId
 */
OrderCreateResponseOrderItemsInner.prototype['externalId'] = undefined;

/**
 * Item ID in the order
 * @member {String} id
 */
OrderCreateResponseOrderItemsInner.prototype['id'] = undefined;

/**
 * Product/service name
 * @member {String} name
 */
OrderCreateResponseOrderItemsInner.prototype['name'] = undefined;

/**
 * Quantity
 * @member {Number} qty
 */
OrderCreateResponseOrderItemsInner.prototype['qty'] = undefined;

/**
 * Total item amount (quantity × unit price)
 * @member {Number} totalAmount
 */
OrderCreateResponseOrderItemsInner.prototype['totalAmount'] = undefined;

/**
 * Total net amount of the item
 * @member {Number} totalNetAmount
 */
OrderCreateResponseOrderItemsInner.prototype['totalNetAmount'] = undefined;

/**
 * Unit price
 * @member {Number} unityPrice
 */
OrderCreateResponseOrderItemsInner.prototype['unityPrice'] = undefined;
...
export default OrderCreateResponseOrderItemsInner;
