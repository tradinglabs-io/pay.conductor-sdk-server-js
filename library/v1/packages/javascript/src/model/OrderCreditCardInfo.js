...
/**
 * The OrderCreditCardInfo model module.
 * @module model/OrderCreditCardInfo
 * @version 1.0.0
 */
class OrderCreditCardInfo {
    /**
     * Constructs a new <code>OrderCreditCardInfo</code>.
     * Credit card payment data
     * @alias module:model/OrderCreditCardInfo
     */
    constructor() { 
        
        OrderCreditCardInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrderCreditCardInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderCreditCardInfo} obj Optional instance to populate.
     * @return {module:model/OrderCreditCardInfo} The populated <code>OrderCreditCardInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderCreditCardInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderCreditCardInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderCreditCardInfo</code>.
     */
 ...
 */
OrderCreditCardInfo.prototype['authorizationCode'] = undefined;
...
export default OrderCreditCardInfo;
