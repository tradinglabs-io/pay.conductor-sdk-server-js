...
class CustomerCreateRequest {
    ...
    constructor(documentNumber, documentType, email, name) { 
        ...
        CustomerCreateRequest.initialize(this, documentNumber, documentType, email, name);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomerCreateRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CustomerCreateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomerCreateRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CustomerCreateRequest.RequiredProperties) {
...
CustomerCreateRequest.RequiredProperties = ["documentNumber", "documentType", "email", "name"];

/**
 * @member {module:model/AddressCreateRequest} address
 */
CustomerCreateRequest.prototype['address'] = undefined;

/**
 * Customer CPF or CNPJ without formatting
 * @member {String} documentNumber
 */
CustomerCreateRequest.prototype['documentNumber'] = undefined;

/**
 * @member {module:model/DocumentType} documentType
 */
CustomerCreateRequest.prototype['documentType'] = undefined;

/**
 * Customer email
 * @member {String} email
 */
CustomerCreateRequest.prototype['email'] = undefined;

/**
 * Customer full name
 * @member {String} name
 */
CustomerCreateRequest.prototype['name'] = undefined;

/**
 * Customer phone number in +55 DD 9XXXXXXXX format
 * @member {String} phoneNumber
 */
CustomerCreateRequest.prototype['phoneNumber'] = undefined;
