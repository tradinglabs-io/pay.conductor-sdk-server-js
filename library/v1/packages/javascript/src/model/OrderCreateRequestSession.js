...
/**
 * The OrderCreateRequestSession model module.
 * @module model/OrderCreateRequestSession
 * @version 1.0.0
 */
class OrderCreateRequestSession {
    /**
     * Constructs a new <code>OrderCreateRequestSession</code>.
     ...
     * @alias module:model/OrderCreateRequestSession
     */
    constructor() { 
        
        OrderCreateRequestSession.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrderCreateRequestSession</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderCreateRequestSession} obj Optional instance to populate.
     * @return {module:model/OrderCreateRequestSession} The populated <code>OrderCreateRequestSession</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderCreateRequestSession();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderCreateRequestSession</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderCreateRequestSession</code>.
     */
 ...
 * @default 30
 */
OrderCreateRequestSession.prototype['expiresInMinutes'] = 30;

/**
 * Checkout URL for redirection
 * @member {String} checkoutUrl
 */
OrderCreateRequestSession.prototype['checkoutUrl'] = undefined;

/**
 * ID generated by our service to identify the checkout session
 * @member {String} sessionId
 */
OrderCreateRequestSession.prototype['sessionId'] = undefined;
 ...
 */
OrderCreateRequestSession.prototype['externalSessionId'] = undefined;
...
export default OrderCreateRequestSession;
