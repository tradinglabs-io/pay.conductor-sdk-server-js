...
/**
 * The AddressCreateRequest model module.
 * @module model/AddressCreateRequest
 * @version 1.0.0
 */
class AddressCreateRequest {
    /**
     * Constructs a new <code>AddressCreateRequest</code>.
     * Schema for creating a new address
     * @alias module:model/AddressCreateRequest
    ...
    constructor(city, country, neighborhood, number, state, street, zipCode) { 
        ...
        AddressCreateRequest.initialize(this, city, country, neighborhood, number, state, street, zipCode);
    }
    ...
    /**
     * Constructs a <code>AddressCreateRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddressCreateRequest} obj Optional instance to populate.
     * @return {module:model/AddressCreateRequest} The populated <code>AddressCreateRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddressCreateRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AddressCreateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddressCreateRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddressCreateRequest.RequiredProperties) {
...
AddressCreateRequest.RequiredProperties = ["city", "country", "neighborhood", "number", "state", "street", "zipCode"];

/**
 * City name
 * @member {String} city
 */
AddressCreateRequest.prototype['city'] = undefined;
 ...
 * @default 'BR'
 */
AddressCreateRequest.prototype['country'] = 'BR';

/**
 * Neighborhood name
 * @member {String} neighborhood
 */
AddressCreateRequest.prototype['neighborhood'] = undefined;

/**
 * Address number
 * @member {String} number
 */
AddressCreateRequest.prototype['number'] = undefined;

/**
 * State code in ISO 3166-2 format
 * @member {String} state
 */
AddressCreateRequest.prototype['state'] = undefined;

/**
 * Street name
 * @member {String} street
 */
AddressCreateRequest.prototype['street'] = undefined;

/**
 * ZIP code without formatting
 * @member {String} zipCode
 */
AddressCreateRequest.prototype['zipCode'] = undefined;
...
export default AddressCreateRequest;
