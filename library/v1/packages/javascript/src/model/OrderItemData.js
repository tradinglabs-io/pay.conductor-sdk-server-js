...
/**
 * The OrderItemData model module.
 * @module model/OrderItemData
 * @version 1.0.0
 */
class OrderItemData {
    /**
     * Constructs a new <code>OrderItemData</code>.
     * Product or service item in the order
     * @alias module:model/OrderItemData
    ...
    constructor(id, isPhysical, name, qty, unitPrice) { 
        ...
        OrderItemData.initialize(this, id, isPhysical, name, qty, unitPrice);
    }
    ...
    /**
     * Constructs a <code>OrderItemData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderItemData} obj Optional instance to populate.
     * @return {module:model/OrderItemData} The populated <code>OrderItemData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderItemData();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderItemData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderItemData</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OrderItemData.RequiredProperties) {
...
OrderItemData.RequiredProperties = ["id", "isPhysical", "name", "qty", "unitPrice"];

/**
 * Product or service ID in your system
 * @member {String} id
 */
OrderItemData.prototype['id'] = undefined;
 ...
 * @default false
 */
OrderItemData.prototype['isPhysical'] = false;

/**
 * Product or service name
 * @member {String} name
 */
OrderItemData.prototype['name'] = undefined;

/**
 * Quantity of the product or service
 * @member {Number} qty
 */
OrderItemData.prototype['qty'] = undefined;

/**
 * Unit price
 * @member {Number} unitPrice
 */
OrderItemData.prototype['unitPrice'] = undefined;
