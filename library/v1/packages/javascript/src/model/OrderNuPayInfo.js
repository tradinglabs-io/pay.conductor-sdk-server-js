...
/**
 * The OrderNuPayInfo model module.
 * @module model/OrderNuPayInfo
 * @version 1.0.0
 */
class OrderNuPayInfo {
    /**
     * Constructs a new <code>OrderNuPayInfo</code>.
     * NuPay payment data
     * @alias module:model/OrderNuPayInfo
     * @param paymentUrl {String} NuPay payment URL
     */
    constructor(paymentUrl) { 
        
        OrderNuPayInfo.initialize(this, paymentUrl);
    }
    ...
    /**
     * Constructs a <code>OrderNuPayInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderNuPayInfo} obj Optional instance to populate.
     * @return {module:model/OrderNuPayInfo} The populated <code>OrderNuPayInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderNuPayInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderNuPayInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderNuPayInfo</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OrderNuPayInfo.RequiredProperties) {
...
OrderNuPayInfo.RequiredProperties = ["paymentUrl"];

/**
 * NuPay payment URL
 * @member {String} paymentUrl
 */
OrderNuPayInfo.prototype['paymentUrl'] = undefined;
