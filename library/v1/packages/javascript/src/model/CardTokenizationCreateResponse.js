...
/**
 * The CardTokenizationCreateResponse model module.
 * @module model/CardTokenizationCreateResponse
 * @version 1.0.0
 */
class CardTokenizationCreateResponse {
    /**
     * Constructs a new <code>CardTokenizationCreateResponse</code>.
     * Response containing customer ID and card token
     * @alias module:model/CardTokenizationCreateResponse
    ...
    constructor(customerId, token) { 
        ...
        CardTokenizationCreateResponse.initialize(this, customerId, token);
    }
    ...
    /**
     * Constructs a <code>CardTokenizationCreateResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CardTokenizationCreateResponse} obj Optional instance to populate.
     * @return {module:model/CardTokenizationCreateResponse} The populated <code>CardTokenizationCreateResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CardTokenizationCreateResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CardTokenizationCreateResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CardTokenizationCreateResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CardTokenizationCreateResponse.RequiredProperties) {
...
CardTokenizationCreateResponse.RequiredProperties = ["customerId", "token"];

/**
 * ID of the customer associated with the created card
 * @member {String} customerId
 */
CardTokenizationCreateResponse.prototype['customerId'] = undefined;

/**
 * Token of the created card for future transactions
 * @member {String} token
 */
CardTokenizationCreateResponse.prototype['token'] = undefined;
...
export default CardTokenizationCreateResponse;
