...
/**
 * The CardTokenizationCustomerByIdData model module.
 * @module model/CardTokenizationCustomerByIdData
 * @version 1.0.0
 */
class CardTokenizationCustomerByIdData {
    /**
     * Constructs a new <code>CardTokenizationCustomerByIdData</code>.
     * Reference to an existing customer by ID
     * @alias module:model/CardTokenizationCustomerByIdData
     * @param id {String} ID of an existing customer
     */
    constructor(id) { 
        
        CardTokenizationCustomerByIdData.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>CardTokenizationCustomerByIdData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CardTokenizationCustomerByIdData} obj Optional instance to populate.
     * @return {module:model/CardTokenizationCustomerByIdData} The populated <code>CardTokenizationCustomerByIdData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CardTokenizationCustomerByIdData();
    ...
    /**
     * Validates the JSON data with respect to <code>CardTokenizationCustomerByIdData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CardTokenizationCustomerByIdData</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CardTokenizationCustomerByIdData.RequiredProperties) {
...
CardTokenizationCustomerByIdData.RequiredProperties = ["id"];

/**
 * ID of an existing customer
 * @member {String} id
 */
CardTokenizationCustomerByIdData.prototype['id'] = undefined;
...
export default CardTokenizationCustomerByIdData;
