...
/**
 * The CustomerUpdateRequest model module.
 * @module model/CustomerUpdateRequest
 * @version 1.0.0
 */
class CustomerUpdateRequest {
    /**
     * Constructs a new <code>CustomerUpdateRequest</code>.
     * Schema for updating customer information
     * @alias module:model/CustomerUpdateRequest
     */
    constructor() { 
        
        CustomerUpdateRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CustomerUpdateRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomerUpdateRequest} obj Optional instance to populate.
     * @return {module:model/CustomerUpdateRequest} The populated <code>CustomerUpdateRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomerUpdateRequest();

            if (data.hasOwnProperty('address')) {
                obj['address'] = AddressCreateRequest.constructFromObject(data['address']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CustomerUpdateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomerUpdateRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `address`
        if (data['address']) { // data not null
          AddressCreateRequest.validateJSON(data['address']);
        }
 ...
 */
CustomerUpdateRequest.prototype['address'] = undefined;

/**
 * Customer CPF or CNPJ without formatting
 * @member {String} documentNumber
 */
CustomerUpdateRequest.prototype['documentNumber'] = undefined;

/**
 * @member {module:model/DocumentType} documentType
 */
CustomerUpdateRequest.prototype['documentType'] = undefined;

/**
 * Customer email
 * @member {String} email
 */
CustomerUpdateRequest.prototype['email'] = undefined;

/**
 * Customer full name
 * @member {String} name
 */
CustomerUpdateRequest.prototype['name'] = undefined;

/**
 * Customer phone number in +55 DD 9XXXXXXXX format
 * @member {String} phoneNumber
 */
CustomerUpdateRequest.prototype['phoneNumber'] = undefined;
