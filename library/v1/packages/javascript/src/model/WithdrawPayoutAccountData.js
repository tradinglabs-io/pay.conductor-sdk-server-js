...
/**
 * The WithdrawPayoutAccountData model module.
 * @module model/WithdrawPayoutAccountData
 * @version 1.0.0
 */
class WithdrawPayoutAccountData {
    /**
     * Constructs a new <code>WithdrawPayoutAccountData</code>.
     * Bank account information for withdrawal
     * @alias module:model/WithdrawPayoutAccountData
    ...
    constructor(ownerDocument, ownerName, pixKey, pixType) { 
        ...
        WithdrawPayoutAccountData.initialize(this, ownerDocument, ownerName, pixKey, pixType);
    }
    ...
    /**
     * Constructs a <code>WithdrawPayoutAccountData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WithdrawPayoutAccountData} obj Optional instance to populate.
     * @return {module:model/WithdrawPayoutAccountData} The populated <code>WithdrawPayoutAccountData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WithdrawPayoutAccountData();
    ...
    /**
     * Validates the JSON data with respect to <code>WithdrawPayoutAccountData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WithdrawPayoutAccountData</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WithdrawPayoutAccountData.RequiredProperties) {
...
WithdrawPayoutAccountData.RequiredProperties = ["ownerDocument", "ownerName", "pixKey", "pixType"];

/**
 * Account holder document (CPF or CNPJ)
 * @member {String} ownerDocument
 */
WithdrawPayoutAccountData.prototype['ownerDocument'] = undefined;

/**
 * Account holder name
 * @member {String} ownerName
 */
WithdrawPayoutAccountData.prototype['ownerName'] = undefined;

/**
 * PIX key for withdrawal
 * @member {String} pixKey
 */
WithdrawPayoutAccountData.prototype['pixKey'] = undefined;

/**
 * @member {module:model/PixType} pixType
 */
WithdrawPayoutAccountData.prototype['pixType'] = undefined;
...
export default WithdrawPayoutAccountData;
