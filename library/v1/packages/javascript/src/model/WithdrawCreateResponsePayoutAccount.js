...
/**
 * The WithdrawCreateResponsePayoutAccount model module.
 * @module model/WithdrawCreateResponsePayoutAccount
 * @version 1.0.0
 */
class WithdrawCreateResponsePayoutAccount {
    /**
     * Constructs a new <code>WithdrawCreateResponsePayoutAccount</code>.
     * @alias module:model/WithdrawCreateResponsePayoutAccount
    ...
    constructor(id, ownerDocument, ownerName, pixKey, pixType) { 
        ...
        WithdrawCreateResponsePayoutAccount.initialize(this, id, ownerDocument, ownerName, pixKey, pixType);
    }
    ...
    /**
     * Constructs a <code>WithdrawCreateResponsePayoutAccount</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WithdrawCreateResponsePayoutAccount} obj Optional instance to populate.
     * @return {module:model/WithdrawCreateResponsePayoutAccount} The populated <code>WithdrawCreateResponsePayoutAccount</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WithdrawCreateResponsePayoutAccount();
    ...
    /**
     * Validates the JSON data with respect to <code>WithdrawCreateResponsePayoutAccount</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WithdrawCreateResponsePayoutAccount</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WithdrawCreateResponsePayoutAccount.RequiredProperties) {
...
WithdrawCreateResponsePayoutAccount.RequiredProperties = ["id", "ownerDocument", "ownerName", "pixKey", "pixType"];

/**
 * Unique payment account identifier
 * @member {String} id
 */
WithdrawCreateResponsePayoutAccount.prototype['id'] = undefined;

/**
 * Account holder document (CPF or CNPJ)
 * @member {String} ownerDocument
 */
WithdrawCreateResponsePayoutAccount.prototype['ownerDocument'] = undefined;

/**
 * Account holder name
 * @member {String} ownerName
 */
WithdrawCreateResponsePayoutAccount.prototype['ownerName'] = undefined;

/**
 * PIX key used for the withdrawal
 * @member {String} pixKey
 */
WithdrawCreateResponsePayoutAccount.prototype['pixKey'] = undefined;

/**
 * @member {module:model/PixType} pixType
 */
WithdrawCreateResponsePayoutAccount.prototype['pixType'] = undefined;
...
export default WithdrawCreateResponsePayoutAccount;
