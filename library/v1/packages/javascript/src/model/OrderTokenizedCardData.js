...
/**
 * The OrderTokenizedCardData model module.
 * @module model/OrderTokenizedCardData
 * @version 1.0.0
 */
class OrderTokenizedCardData {
    /**
     * Constructs a new <code>OrderTokenizedCardData</code>.
     * @alias module:model/OrderTokenizedCardData
     * @param token {String} Previously generated credit card token
     */
    constructor(token) { 
        
        OrderTokenizedCardData.initialize(this, token);
    }
    ...
    /**
     * Constructs a <code>OrderTokenizedCardData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderTokenizedCardData} obj Optional instance to populate.
     * @return {module:model/OrderTokenizedCardData} The populated <code>OrderTokenizedCardData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderTokenizedCardData();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderTokenizedCardData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderTokenizedCardData</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OrderTokenizedCardData.RequiredProperties) {
...
OrderTokenizedCardData.RequiredProperties = ["token"];

/**
 * First 6 digits of the credit card
 * @member {String} firstSixCardNumber
 */
OrderTokenizedCardData.prototype['firstSixCardNumber'] = undefined;

/**
 * Previously generated credit card token
 * @member {String} token
 */
OrderTokenizedCardData.prototype['token'] = undefined;
...
export default OrderTokenizedCardData;
