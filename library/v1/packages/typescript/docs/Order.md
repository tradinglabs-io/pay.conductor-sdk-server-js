...
**customer** | [**Customer1**](Customer1.md) |  | [default to undefined]
**discountAmount** | **number** | Discount amount | [default to 0]
**externalId** | **string** | Order ID in your system | [default to undefined]
**fingerprints** | [**FraudFingerprints**](FraudFingerprints.md) |  | [optional] [default to undefined]
**items** | [**Array&lt;OrderItem&gt;**](OrderItem.md) | List of products or services in the order | [optional] [default to undefined]
**merchant** | [**MerchantInput**](MerchantInput.md) |  | [optional] [default to undefined]
**payment** | [**PaymentData**](PaymentData.md) |  | [default to undefined]
...
**session** | [**OrderSession**](OrderSession.md) |  | [optional] [default to undefined]
...
```typescript
import { Order } from 'payconductor-sdk';
