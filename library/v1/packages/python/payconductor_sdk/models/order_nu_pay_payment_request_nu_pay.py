...
class OrderNuPayPaymentRequestNuPay(BaseModel):
    """
    Specific data for NuPay payment
    """ # noqa: E501
    cancel_url: StrictStr = Field(description="Payment cancellation URL", alias="cancelUrl")
    merchant_name: StrictStr = Field(description="Merchant name", alias="merchantName")
    return_url: StrictStr = Field(description="Return URL after payment completion", alias="returnUrl")
    store_name: Optional[StrictStr] = Field(default=None, description="Store name", alias="storeName")
