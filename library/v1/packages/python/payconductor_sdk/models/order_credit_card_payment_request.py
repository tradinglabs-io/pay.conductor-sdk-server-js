...
class OrderCreditCardPaymentRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "card": OrderCreditCardPaymentRequestCard.from_dict(obj["card"]) if obj.get("card") is not None else None,
            "installments": obj.get("installments") if obj.get("installments") is not None else 1,
