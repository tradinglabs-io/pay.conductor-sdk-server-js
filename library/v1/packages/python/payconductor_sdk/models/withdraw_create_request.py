...
class WithdrawCreateRequest(BaseModel):
    ...
    payout_account: WithdrawPayoutAccountData = Field(alias="payoutAccount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payoutAccount": WithdrawPayoutAccountData.from_dict(obj["payoutAccount"]) if obj.get("payoutAccount") is not None else None
        })
        return _obj
