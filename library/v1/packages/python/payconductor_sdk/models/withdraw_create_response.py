...
class WithdrawCreateResponse(BaseModel):
    ...
    payed_at: Optional[WithdrawCreateResponsePayedAt] = Field(alias="payedAt")
    payout_account: WithdrawCreateResponsePayoutAccount = Field(alias="payoutAccount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payedAt": WithdrawCreateResponsePayedAt.from_dict(obj["payedAt"]) if obj.get("payedAt") is not None else None,
            "payoutAccount": WithdrawCreateResponsePayoutAccount.from_dict(obj["payoutAccount"]) if obj.get("payoutAccount") is not None else None
        })
        return _obj
