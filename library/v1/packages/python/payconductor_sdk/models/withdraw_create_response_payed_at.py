...
WITHDRAWCREATERESPONSEPAYEDAT_ANY_OF_SCHEMAS = ["ModelDate", "date", "datetime", "float"]

class WithdrawCreateResponsePayedAt(BaseModel):
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = WithdrawCreateResponsePayedAt.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in WithdrawCreateResponsePayedAt with anyOf schemas: ModelDate, date, datetime, float. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into WithdrawCreateResponsePayedAt with anyOf schemas: ModelDate, date, datetime, float. Details: " + ", ".join(error_messages))
        else:
            return instance
