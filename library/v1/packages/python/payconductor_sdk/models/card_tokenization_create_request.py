...
class CardTokenizationCreateRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "card": CardCreateRequest.from_dict(obj["card"]) if obj.get("card") is not None else None,
            "saveCard": obj.get("saveCard"),
            "customer": CardTokenizationCreateRequestCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None
        })
        return _obj
