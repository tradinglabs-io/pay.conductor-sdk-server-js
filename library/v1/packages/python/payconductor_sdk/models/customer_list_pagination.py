...
class CustomerListPagination(BaseModel):
    """
    Pagination information for customer list
    """ # noqa: E501
    current_page: Union[StrictFloat, StrictInt] = Field(description="Current page number", alias="currentPage")
    page_size: Union[StrictFloat, StrictInt] = Field(description="Number of items per page", alias="pageSize")
    total_items: Union[StrictFloat, StrictInt] = Field(description="Total number of customers", alias="totalItems")
    total_pages: Union[StrictFloat, StrictInt] = Field(description="Total number of pages", alias="totalPages")
    __properties: ClassVar[List[str]] = ["currentPage", "pageSize", "totalItems", "totalPages"]
