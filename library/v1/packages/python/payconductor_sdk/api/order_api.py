...
class OrderApi:
    ...
    def order_confirm(
        self,
        id: StrictStr,
        order_payment_request: Annotated[OrderPaymentRequest, Field(description="Payment data for the order (Pix, Credit Card, Bank Slip, NuPay, etc...)")],
        ...
        :param id: (required)
        :type id: str
        :param order_payment_request: Payment data for the order (Pix, Credit Card, Bank Slip, NuPay, etc...) (required)
        :type order_payment_request: OrderPaymentRequest
        ...
        _param = self._order_confirm_serialize(
            id=id,
    ...
    @validate_call
    def order_confirm_with_http_info(
        self,
        id: StrictStr,
        order_payment_request: Annotated[OrderPaymentRequest, Field(description="Payment data for the order (Pix, Credit Card, Bank Slip, NuPay, etc...)")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OrderConfirmResponse]:
        """Confirm Order
    ...
    @validate_call
    def order_confirm_without_preload_content(
        self,
        id: StrictStr,
        order_payment_request: Annotated[OrderPaymentRequest, Field(description="Payment data for the order (Pix, Credit Card, Bank Slip, NuPay, etc...)")],
        _request_timeout: Union[
    ...
    def _order_confirm_serialize(
        ...
        if order_payment_request is not None:
            _body_params = order_payment_request
    ...
    def order_create(
        self,
        order_create_request: Annotated[OrderCreateRequest, Field(description="Order data for payment processing")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param order_create_request: Order data for payment processing (required)
    ...
    def order_read(
        ...
        _param = self._order_read_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def order_read_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
