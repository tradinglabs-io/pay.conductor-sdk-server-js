...
class WithdrawApi:
    ...
    def withdraw_create(
        self,
        withdraw_create_request: Annotated[WithdrawCreateRequest, Field(description="Withdrawal or transfer request data")],
        ...
        :param withdraw_create_request: Withdrawal or transfer request data (required)
        :type withdraw_create_request: WithdrawCreateRequest
        ...
        _param = self._withdraw_create_serialize(
            withdraw_create_request=withdraw_create_request,
    ...
    @validate_call
    def withdraw_create_with_http_info(
        self,
        withdraw_create_request: Annotated[WithdrawCreateRequest, Field(description="Withdrawal or transfer request data")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WithdrawCreateResponse]:
        """Create Withdrawal
    ...
    @validate_call
    def withdraw_create_without_preload_content(
        self,
        withdraw_create_request: Annotated[WithdrawCreateRequest, Field(description="Withdrawal or transfer request data")],
        _request_timeout: Union[
            None,
    ...
    def _withdraw_create_serialize(
        self,
        ...
        if withdraw_create_request is not None:
            _body_params = withdraw_create_request
    ...
    def withdraw_list(
        ...
        _param = self._withdraw_list_serialize(
            page=page,
            page_size=page_size,
            end_date=end_date,
    ...
    @validate_call
    def withdraw_list_with_http_info(
        self,
        page: Union[Annotated[float, Field(multiple_of=1, strict=True, ge=1)], Annotated[int, Field(strict=True, ge=1)]],
        page_size: Union[Annotated[float, Field(multiple_of=1, le=100, strict=True, ge=1)], Annotated[int, Field(le=100, strict=True, ge=1)]],
        end_date: Optional[datetime] = None,
    ...
    @validate_call
    def withdraw_list_without_preload_content(
        self,
        page: Union[Annotated[float, Field(multiple_of=1, strict=True, ge=1)], Annotated[int, Field(strict=True, ge=1)]],
        page_size: Union[Annotated[float, Field(multiple_of=1, le=100, strict=True, ge=1)], Annotated[int, Field(le=100, strict=True, ge=1)]],
        end_date: Optional[datetime] = None,
    ...
    def withdraw_read(
        ...
        _param = self._withdraw_read_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def withdraw_read_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def withdraw_read_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
