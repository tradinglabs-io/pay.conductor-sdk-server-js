        ...
        if include_optional:
            return OrderCreateResponse(
                ...
                pic_pay = payconductor_sdk.models.order_pic_pay_info.Order PicPay Info(
                    copy_and_paste_code = '', 
                    qr_code_url = '', ),
                credit_card = payconductor_sdk.models.order_credit_card_info.Order Credit Card Info(
                    authorization_code = '', ),
                status = 'Generating',
                payment_method = 'Pix',
                payed_at = '',
                ...
                error_message = '',
                order_items = [
                    payconductor_sdk.models.order_create_response_order_items_inner.Order_Create_Response_orderItems_inner(
                        external_id = '', 
                        id = '', 
                        name = '', 
                        qty = 1.337, 
                ...
                session = payconductor_sdk.models.order_create_response_session.Order_Create_Response_session(
                    session_id = '', )
            )
        else:
            return OrderCreateResponse(
