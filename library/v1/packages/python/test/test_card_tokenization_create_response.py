...
class TestCardTokenizationCreateResponse(unittest.TestCase):
    """CardTokenizationCreateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CardTokenizationCreateResponse:
        """Test CardTokenizationCreateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CardTokenizationCreateResponse`
        """
        model = CardTokenizationCreateResponse()
        if include_optional:
    ...
    def testCardTokenizationCreateResponse(self):
        """Test CardTokenizationCreateResponse"""
