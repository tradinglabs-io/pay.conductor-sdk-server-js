...
class TestOrderConfirmResponse(unittest.TestCase):
    """OrderConfirmResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderConfirmResponse:
        """Test OrderConfirmResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderConfirmResponse`
        """
        model = OrderConfirmResponse()
        if include_optional:
            return OrderConfirmResponse(
                ...
                amount = 1.337,
                cost_fee = 1.337,
                pix = payconductor_sdk.models.order_pix_info.Order PIX Info(
                    copy_and_paste_code = '', 
                    qr_code_url = '', 
                    end_to_end_id = '', ),
                bank_slip = payconductor_sdk.models.order_bank_slip_info.Order Bank Slip Info(
                    bar_code = '', 
                    digitable_line = '', 
                    pdf_url = '', ),
                nu_pay = payconductor_sdk.models.order_nu_pay_info.Order NuPay Info(
                    payment_url = '', ),
                pic_pay = payconductor_sdk.models.order_pic_pay_info.Order PicPay Info(
                    copy_and_paste_code = '', 
                    qr_code_url = '', ),
                status = 'Generating',
                payment_method = 'Pix',
    ...
    def testOrderConfirmResponse(self):
        """Test OrderConfirmResponse"""
