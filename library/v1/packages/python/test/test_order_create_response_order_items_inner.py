...
class TestOrderCreateResponseOrderItemsInner(unittest.TestCase):
    """OrderCreateResponseOrderItemsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderCreateResponseOrderItemsInner:
        """Test OrderCreateResponseOrderItemsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderCreateResponseOrderItemsInner`
        """
        model = OrderCreateResponseOrderItemsInner()
        if include_optional:
            return OrderCreateResponseOrderItemsInner(
                external_id = '',
                id = '',
                name = '',
                qty = 1.337,
    ...
    def testOrderCreateResponseOrderItemsInner(self):
        """Test OrderCreateResponseOrderItemsInner"""
