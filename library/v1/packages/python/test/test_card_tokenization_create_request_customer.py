...
class TestCardTokenizationCreateRequestCustomer(unittest.TestCase):
    """CardTokenizationCreateRequestCustomer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CardTokenizationCreateRequestCustomer:
        """Test CardTokenizationCreateRequestCustomer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CardTokenizationCreateRequestCustomer`
        """
        model = CardTokenizationCreateRequestCustomer()
        if include_optional:
    ...
    def testCardTokenizationCreateRequestCustomer(self):
        """Test CardTokenizationCreateRequestCustomer"""
