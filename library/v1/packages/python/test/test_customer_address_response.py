...
class TestCustomerAddressResponse(unittest.TestCase):
    """CustomerAddressResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomerAddressResponse:
        """Test CustomerAddressResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomerAddressResponse`
        """
        model = CustomerAddressResponse()
        if include_optional:
    ...
    def testCustomerAddressResponse(self):
        """Test CustomerAddressResponse"""
