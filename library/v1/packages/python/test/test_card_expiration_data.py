...
class TestCardExpirationData(unittest.TestCase):
    """CardExpirationData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CardExpirationData:
        """Test CardExpirationData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CardExpirationData`
        """
        model = CardExpirationData()
        if include_optional:
            return CardExpirationData(
                month = 1,
                year = 2025
            )
        else:
    ...
    def testCardExpirationData(self):
        """Test CardExpirationData"""
