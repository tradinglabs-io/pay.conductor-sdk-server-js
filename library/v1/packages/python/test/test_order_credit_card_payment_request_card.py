...
class TestOrderCreditCardPaymentRequestCard(unittest.TestCase):
    """OrderCreditCardPaymentRequestCard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderCreditCardPaymentRequestCard:
        """Test OrderCreditCardPaymentRequestCard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderCreditCardPaymentRequestCard`
        """
        model = OrderCreditCardPaymentRequestCard()
        if include_optional:
    ...
    def testOrderCreditCardPaymentRequestCard(self):
        """Test OrderCreditCardPaymentRequestCard"""
