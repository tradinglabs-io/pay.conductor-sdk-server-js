...
class TestAddressCreateRequest(unittest.TestCase):
    """AddressCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddressCreateRequest:
    ...
    def testAddressCreateRequest(self):
        """Test AddressCreateRequest"""
