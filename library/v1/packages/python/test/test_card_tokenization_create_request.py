...
class TestCardTokenizationCreateRequest(unittest.TestCase):
    """CardTokenizationCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CardTokenizationCreateRequest:
        """Test CardTokenizationCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CardTokenizationCreateRequest`
        """
        model = CardTokenizationCreateRequest()
        if include_optional:
            return CardTokenizationCreateRequest(
                card = payconductor_sdk.models.card_create_request.Card Create Request(
                    cvv = '012', 
                    expiration = payconductor_sdk.models.card_expiration_data.Card Expiration Data(
                        month = 1, 
                        year = 2025, ), 
                    holder_name = '', 
                    number = '', ),
    ...
    def testCardTokenizationCreateRequest(self):
        """Test CardTokenizationCreateRequest"""
