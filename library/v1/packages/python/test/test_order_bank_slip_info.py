...
class TestOrderBankSlipInfo(unittest.TestCase):
    """OrderBankSlipInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderBankSlipInfo:
        """Test OrderBankSlipInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderBankSlipInfo`
        """
        model = OrderBankSlipInfo()
        if include_optional:
            return OrderBankSlipInfo(
                bar_code = '',
                digitable_line = '',
                pdf_url = ''
            )
    ...
    def testOrderBankSlipInfo(self):
        """Test OrderBankSlipInfo"""
