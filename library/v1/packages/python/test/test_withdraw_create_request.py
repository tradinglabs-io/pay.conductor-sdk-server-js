...
class TestWithdrawCreateRequest(unittest.TestCase):
    """WithdrawCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WithdrawCreateRequest:
        """Test WithdrawCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WithdrawCreateRequest`
        """
        model = WithdrawCreateRequest()
        if include_optional:
            return WithdrawCreateRequest(
                amount = 1,
                external_id = '',
                merchant = payconductor_sdk.models.merchant_input.MerchantInput(
                    ...
                    email = '', 
                    name = '01', ),
                payout_account = payconductor_sdk.models.withdraw_payout_account_data.Withdraw Payout Account Data(
                    owner_document = '', 
                    owner_name = '', 
                    pix_key = '', 
                    pix_type = 'Cpf', )
    ...
    def testWithdrawCreateRequest(self):
        """Test WithdrawCreateRequest"""
