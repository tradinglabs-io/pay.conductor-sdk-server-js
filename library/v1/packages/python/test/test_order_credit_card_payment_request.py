...
class TestOrderCreditCardPaymentRequest(unittest.TestCase):
    """OrderCreditCardPaymentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderCreditCardPaymentRequest:
    ...
    def testOrderCreditCardPaymentRequest(self):
        """Test OrderCreditCardPaymentRequest"""
