...
class TestOrderNuPayInfo(unittest.TestCase):
    """OrderNuPayInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderNuPayInfo:
        """Test OrderNuPayInfo
        ...
        """
        model = OrderNuPayInfo()
        if include_optional:
            return OrderNuPayInfo(
                payment_url = ''
            )
        else:
            return OrderNuPayInfo(
