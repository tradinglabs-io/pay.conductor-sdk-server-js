...
class TestWithdrawCreateResponsePayoutAccount(unittest.TestCase):
    """WithdrawCreateResponsePayoutAccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WithdrawCreateResponsePayoutAccount:
        """Test WithdrawCreateResponsePayoutAccount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WithdrawCreateResponsePayoutAccount`
        """
        model = WithdrawCreateResponsePayoutAccount()
        if include_optional:
            return WithdrawCreateResponsePayoutAccount(
                id = '',
    ...
    def testWithdrawCreateResponsePayoutAccount(self):
        """Test WithdrawCreateResponsePayoutAccount"""
