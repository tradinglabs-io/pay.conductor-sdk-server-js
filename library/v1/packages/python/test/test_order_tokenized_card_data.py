...
class TestOrderTokenizedCardData(unittest.TestCase):
    """OrderTokenizedCardData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderTokenizedCardData:
        """Test OrderTokenizedCardData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderTokenizedCardData`
        """
        model = OrderTokenizedCardData()
        if include_optional:
            return OrderTokenizedCardData(
    ...
    def testOrderTokenizedCardData(self):
        """Test OrderTokenizedCardData"""
