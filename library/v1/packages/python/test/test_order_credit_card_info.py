...
class TestOrderCreditCardInfo(unittest.TestCase):
    """OrderCreditCardInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderCreditCardInfo:
        """Test OrderCreditCardInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderCreditCardInfo`
        """
        model = OrderCreditCardInfo()
        if include_optional:
            return OrderCreditCardInfo(
                authorization_code = ''
            )
        else:
            return OrderCreditCardInfo(
    ...
    def testOrderCreditCardInfo(self):
        """Test OrderCreditCardInfo"""
