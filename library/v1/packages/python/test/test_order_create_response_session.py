...
class TestOrderCreateResponseSession(unittest.TestCase):
    """OrderCreateResponseSession unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderCreateResponseSession:
        """Test OrderCreateResponseSession
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderCreateResponseSession`
        """
        model = OrderCreateResponseSession()
        if include_optional:
            return OrderCreateResponseSession(
                session_id = ''
            )
        else:
            return OrderCreateResponseSession(
    ...
    def testOrderCreateResponseSession(self):
        """Test OrderCreateResponseSession"""
