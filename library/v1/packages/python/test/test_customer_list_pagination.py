...
class TestCustomerListPagination(unittest.TestCase):
    """CustomerListPagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomerListPagination:
        """Test CustomerListPagination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomerListPagination`
        """
        model = CustomerListPagination()
        if include_optional:
    ...
    def testCustomerListPagination(self):
        """Test CustomerListPagination"""
