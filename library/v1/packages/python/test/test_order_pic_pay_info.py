...
class TestOrderPicPayInfo(unittest.TestCase):
    """OrderPicPayInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderPicPayInfo:
        """Test OrderPicPayInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderPicPayInfo`
        """
        model = OrderPicPayInfo()
        if include_optional:
            return OrderPicPayInfo(
                copy_and_paste_code = '',
                qr_code_url = ''
            )
        else:
