...
class TestWithdrawPayoutAccountData(unittest.TestCase):
    """WithdrawPayoutAccountData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WithdrawPayoutAccountData:
        """Test WithdrawPayoutAccountData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WithdrawPayoutAccountData`
        """
        model = WithdrawPayoutAccountData()
        if include_optional:
            return WithdrawPayoutAccountData(
                owner_document = '',
                owner_name = '',
                pix_key = '',
                pix_type = 'Cpf'
    ...
    def testWithdrawPayoutAccountData(self):
        """Test WithdrawPayoutAccountData"""
