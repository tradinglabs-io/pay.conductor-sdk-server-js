...
class TestOrderFraudFingerprints(unittest.TestCase):
    """OrderFraudFingerprints unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderFraudFingerprints:
        """Test OrderFraudFingerprints
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderFraudFingerprints`
        """
        model = OrderFraudFingerprints()
        if include_optional:
            return OrderFraudFingerprints(
    ...
    def testOrderFraudFingerprints(self):
        """Test OrderFraudFingerprints"""
