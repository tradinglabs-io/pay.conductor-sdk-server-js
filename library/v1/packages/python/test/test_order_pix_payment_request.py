...
class TestOrderPIXPaymentRequest(unittest.TestCase):
    """OrderPIXPaymentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderPIXPaymentRequest:
        """Test OrderPIXPaymentRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderPIXPaymentRequest`
        """
        model = OrderPIXPaymentRequest()
        if include_optional:
            return OrderPIXPaymentRequest(
                payment_method = '',
    ...
    def testOrderPIXPaymentRequest(self):
        """Test OrderPIXPaymentRequest"""
