...
class TestCardTokenizationCustomerByIdData(unittest.TestCase):
    """CardTokenizationCustomerByIdData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CardTokenizationCustomerByIdData:
        """Test CardTokenizationCustomerByIdData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CardTokenizationCustomerByIdData`
        """
        model = CardTokenizationCustomerByIdData()
        if include_optional:
            return CardTokenizationCustomerByIdData(
                id = ''
            )
        else:
            return CardTokenizationCustomerByIdData(
    ...
    def testCardTokenizationCustomerByIdData(self):
        """Test CardTokenizationCustomerByIdData"""
