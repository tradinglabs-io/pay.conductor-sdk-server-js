    ...
    def make_instance(self, include_optional) -> CustomerListResponse:
        ...
        if include_optional:
            return CustomerListResponse(
                data = [
                    payconductor_sdk.models.customer_read_response.Customer Read Response(
                        id = '', 
                        name = '', 
                        email = '', 
                        document_type = 'Cpf', 
                ...
                pagination = payconductor_sdk.models.customer_list_pagination.Customer List Pagination(
                    current_page = 1.337, 
                    page_size = 1.337, 
                    total_items = 1.337, 
                    total_pages = 1.337, )
