...
class TestOrderCreateRequestSession(unittest.TestCase):
    """OrderCreateRequestSession unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderCreateRequestSession:
        """Test OrderCreateRequestSession
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderCreateRequestSession`
        """
        model = OrderCreateRequestSession()
        if include_optional:
            return OrderCreateRequestSession(
    ...
    def testOrderCreateRequestSession(self):
        """Test OrderCreateRequestSession"""
