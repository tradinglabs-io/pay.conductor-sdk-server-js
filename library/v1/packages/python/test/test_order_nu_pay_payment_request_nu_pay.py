...
class TestOrderNuPayPaymentRequestNuPay(unittest.TestCase):
    """OrderNuPayPaymentRequestNuPay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderNuPayPaymentRequestNuPay:
        """Test OrderNuPayPaymentRequestNuPay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderNuPayPaymentRequestNuPay`
        """
        model = OrderNuPayPaymentRequestNuPay()
        if include_optional:
            return OrderNuPayPaymentRequestNuPay(
                cancel_url = '',
                merchant_name = '',
                return_url = '',
                store_name = ''
    ...
    def testOrderNuPayPaymentRequestNuPay(self):
        """Test OrderNuPayPaymentRequestNuPay"""
