...
class TestWithdrawApi(unittest.TestCase):
    ...
    def test_withdraw_create(self) -> None:
        """Test case for withdraw_create

        Create Withdrawal
        """
        pass

    def test_withdraw_list(self) -> None:
        """Test case for withdraw_list

        List Withdrawals
        """
        pass

    def test_withdraw_read(self) -> None:
        """Test case for withdraw_read
