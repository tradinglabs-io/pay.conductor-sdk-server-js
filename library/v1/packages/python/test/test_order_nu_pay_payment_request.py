...
class TestOrderNuPayPaymentRequest(unittest.TestCase):
    """OrderNuPayPaymentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderNuPayPaymentRequest:
    ...
    def testOrderNuPayPaymentRequest(self):
        """Test OrderNuPayPaymentRequest"""
