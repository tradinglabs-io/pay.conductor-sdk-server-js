...
class TestWithdrawCreateResponsePayedAt(unittest.TestCase):
    """WithdrawCreateResponsePayedAt unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WithdrawCreateResponsePayedAt:
        """Test WithdrawCreateResponsePayedAt
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WithdrawCreateResponsePayedAt`
        """
        model = WithdrawCreateResponsePayedAt()
        if include_optional:
            return WithdrawCreateResponsePayedAt(
            )
        else:
            return WithdrawCreateResponsePayedAt(
        )
    ...
    def testWithdrawCreateResponsePayedAt(self):
        """Test WithdrawCreateResponsePayedAt"""
