...
with payconductor_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = payconductor_sdk.WithdrawApi(api_client)
    withdraw_create_request = payconductor_sdk.WithdrawCreateRequest() # WithdrawCreateRequest | Withdrawal or transfer request data

    try:
        # Create Withdrawal
        api_response = api_instance.withdraw_create(withdraw_create_request)
        print("The response of WithdrawApi->withdraw_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WithdrawApi->withdraw_create: %s\n" % e)
```
...
# **withdraw_list**
> withdraw_list(page, page_size, end_date=end_date, start_date=start_date, id=id)
...
with payconductor_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List Withdrawals
        api_instance.withdraw_list(page, page_size, end_date=end_date, start_date=start_date, id=id)
    except Exception as e:
        print("Exception when calling WithdrawApi->withdraw_list: %s\n" % e)
```
...
with payconductor_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling WithdrawApi->withdraw_read: %s\n" % e)
```
