...
// tests for OrderCreateResponse
void main() {
  final instance = OrderCreateResponseBuilder();
  ...
  group(OrderCreateResponse, () {
    ...
    // BuiltList<OrderCreateResponseOrderItemsInner> orderItems
    test('to test the property `orderItems`', () async {
      // TODO
    });

    // OrderCreateResponseSession session
