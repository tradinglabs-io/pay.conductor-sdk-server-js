...
class WithdrawApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [WithdrawCreateResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WithdrawCreateResponse>> withdrawCreate({ 
    required WithdrawCreateRequest withdrawCreateRequest,
    ...
    try {
      const _type = FullType(WithdrawCreateRequest);
      _bodyData = _serializers.serialize(withdrawCreateRequest, specifiedType: _type);
    ...
    WithdrawCreateResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(WithdrawCreateResponse),
    ...
    return Response<WithdrawCreateResponse>(
      data: _responseData,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> withdrawList({ 
    num page = 1,
    num pageSize = 20,
    DateTime? endDate,
    DateTime? startDate,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> withdrawRead({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
