...
class CustomerApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CustomerReadResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CustomerReadResponse>> customerCreate({ 
    ...
    try {
      const _type = FullType(CustomerCreateRequest);
      _bodyData = _serializers.serialize(customerCreateRequest, specifiedType: _type);
    ...
    CustomerReadResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CustomerReadResponse),
      ) as CustomerReadResponse;
    ...
    return Response<CustomerReadResponse>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CustomerListResponse>> customerListCustom({ 
    num page = 1,
    num pageSize = 20,
    String? email,
    String? name,
  ...
  /// Returns a [Future] containing a [Response] with a [CustomerReadResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CustomerReadResponse>> customerRead({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [CustomerReadResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CustomerReadResponse>> customerUpdate({ 
    required String id,
    required CustomerUpdateRequest customerUpdateRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(customerUpdateRequest, specifiedType: _type);
