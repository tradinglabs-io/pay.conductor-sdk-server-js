...
pub struct CardCreateRequest {
    ...
    pub expiration: Box<models::CardExpirationData>,
    /// Card holder name
...
impl CardCreateRequest {
    ...
    pub fn new(cvv: String, expiration: models::CardExpirationData, holder_name: String, number: String) -> CardCreateRequest {
        CardCreateRequest {
            cvv,
