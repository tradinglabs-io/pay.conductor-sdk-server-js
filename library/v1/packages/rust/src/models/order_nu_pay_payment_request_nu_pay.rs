...
pub struct OrderNuPayPaymentRequestNuPay {
...
impl OrderNuPayPaymentRequestNuPay {
    /// Specific data for NuPay payment
    pub fn new(cancel_url: String, merchant_name: String, return_url: String) -> OrderNuPayPaymentRequestNuPay {
