...
pub struct WithdrawCreateRequest {
    ...
    pub payout_account: Box<models::WithdrawPayoutAccountData>,
}

impl WithdrawCreateRequest {
    /// Withdrawal or transfer request data
    pub fn new(amount: f64, payout_account: models::WithdrawPayoutAccountData) -> WithdrawCreateRequest {
