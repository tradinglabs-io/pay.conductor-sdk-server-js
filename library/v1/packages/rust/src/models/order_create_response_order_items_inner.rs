...
pub struct OrderCreateResponseOrderItemsInner {
    /// External item ID
...
impl OrderCreateResponseOrderItemsInner {
    pub fn new(external_id: Option<String>, id: String, name: String, qty: f64, total_amount: f64, total_net_amount: f64, unity_price: f64) -> OrderCreateResponseOrderItemsInner {
