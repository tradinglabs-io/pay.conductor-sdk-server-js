...
pub struct WithdrawCreateResponsePayoutAccount {
...
impl WithdrawCreateResponsePayoutAccount {
    pub fn new(id: String, owner_document: String, owner_name: String, pix_key: String, pix_type: models::PixType) -> WithdrawCreateResponsePayoutAccount {
