...
pub struct WithdrawPayoutAccountData {
...
impl WithdrawPayoutAccountData {
    /// Bank account information for withdrawal
    pub fn new(owner_document: String, owner_name: String, pix_key: String, pix_type: models::PixType) -> WithdrawPayoutAccountData {
