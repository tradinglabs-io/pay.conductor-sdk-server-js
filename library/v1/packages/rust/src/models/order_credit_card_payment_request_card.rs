...
#[serde(untagged)]
pub enum OrderCreditCardPaymentRequestCard {
    OrderTokenizedCardData(Box<models::OrderTokenizedCardData>),
    CardCreateRequest(Box<models::CardCreateRequest>),
}

impl Default for OrderCreditCardPaymentRequestCard {
    fn default() -> Self {
        Self::OrderTokenizedCardData(Default::default())
    }
}
