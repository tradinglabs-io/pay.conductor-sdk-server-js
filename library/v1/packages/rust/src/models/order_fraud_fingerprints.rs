...
pub struct OrderFraudFingerprints {
    /// ThreatMetrix fingerprint ID for fraud analysis
    #[serde(rename = "threatMetrixFingerprintId", skip_serializing_if = "Option::is_none")]
    pub threat_metrix_fingerprint_id: Option<String>,
}

impl OrderFraudFingerprints {
    /// Fraud analysis fingerprint data
    pub fn new() -> OrderFraudFingerprints {
        OrderFraudFingerprints {
            threat_metrix_fingerprint_id: None,
        }
    }
}
