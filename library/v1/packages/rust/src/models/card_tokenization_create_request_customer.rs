...
#[serde(untagged)]
pub enum CardTokenizationCreateRequestCustomer {
    CustomerCreateRequest(Box<models::CustomerCreateRequest>),
    CardTokenizationCustomerByIdData(Box<models::CardTokenizationCustomerByIdData>),
}

impl Default for CardTokenizationCreateRequestCustomer {
    fn default() -> Self {
        Self::CustomerCreateRequest(Default::default())
    }
}
