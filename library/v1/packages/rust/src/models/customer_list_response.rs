...
pub struct CustomerListResponse {
    /// List of customers
    #[serde(rename = "data")]
    pub data: Vec<models::CustomerReadResponse>,
    #[serde(rename = "pagination")]
    pub pagination: Box<models::CustomerListPagination>,
}

impl CustomerListResponse {
    /// Paginated list of customers
    pub fn new(data: Vec<models::CustomerReadResponse>, pagination: models::CustomerListPagination) -> CustomerListResponse {
