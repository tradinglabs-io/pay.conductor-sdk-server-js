...
impl CustomerAddressResponse {
    /// Customer address information
    pub fn new(id: String, street: String, number: String, neighborhood: String, city: String, state: String, zip_code: String, country: String) -> CustomerAddressResponse {
