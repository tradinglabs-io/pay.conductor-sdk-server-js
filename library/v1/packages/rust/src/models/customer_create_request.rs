...
pub struct CustomerCreateRequest {
    ...
    pub address: Option<Box<models::AddressCreateRequest>>,
...
impl CustomerCreateRequest {
    ...
    pub fn new(document_number: String, document_type: models::DocumentType, email: String, name: String) -> CustomerCreateRequest {
