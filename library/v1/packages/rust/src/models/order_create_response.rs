...
pub struct OrderCreateResponse {
    ...
    pub credit_card: Option<Box<models::OrderCreditCardInfo>>,
    #[serde(rename = "status")]
    ...
    pub order_items: Vec<models::OrderCreateResponseOrderItemsInner>,
    #[serde(rename = "session", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub session: Option<Option<Box<models::OrderCreateResponseSession>>>,
}
