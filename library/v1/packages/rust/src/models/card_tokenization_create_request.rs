...
pub struct CardTokenizationCreateRequest {
    #[serde(rename = "card")]
    pub card: Box<models::CardCreateRequest>,
    /// Indicates if the card should be saved for future use
    #[serde(rename = "saveCard")]
    pub save_card: bool,
    #[serde(rename = "customer")]
    pub customer: Box<models::CardTokenizationCreateRequestCustomer>,
}

impl CardTokenizationCreateRequest {
    /// Data for creating a customer card with customer information
    pub fn new(card: models::CardCreateRequest, save_card: bool, customer: models::CardTokenizationCreateRequestCustomer) -> CardTokenizationCreateRequest {
