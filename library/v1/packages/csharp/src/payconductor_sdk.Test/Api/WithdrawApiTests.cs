...
namespace payconductor_sdk.Test.Api
{
    ...
    /// </summary>
    public sealed class WithdrawApiTests : ApiTestsBase
    {
        private readonly IWithdrawApi _instance;

        public WithdrawApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IWithdrawApi>();
        }
        ...
        public async Task WithdrawCreateAsyncTest()
        {
            WithdrawCreateRequest withdrawCreateRequest = default!;
            var response = await _instance.WithdrawCreateAsync(withdrawCreateRequest);
            var model = response.Ok();
            Assert.IsType<WithdrawCreateResponse>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task WithdrawListAsyncTest()
        {
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task WithdrawReadAsyncTest()
        {
            string id = default!;
        }
    }
