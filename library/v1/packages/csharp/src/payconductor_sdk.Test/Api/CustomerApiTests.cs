...
namespace payconductor_sdk.Test.Api
{
    ...
    public sealed class CustomerApiTests : ApiTestsBase
    {
        ...
        public async Task CustomerCreateAsyncTest()
        {
            ...
            var response = await _instance.CustomerCreateAsync(customerCreateRequest);
            var model = response.Ok();
            Assert.IsType<CustomerReadResponse>(model);
        }

        /// <summary>
        /// Test CustomerListCustom
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CustomerListCustomAsyncTest()
        {
            ...
            var response = await _instance.CustomerListCustomAsync(page, pageSize, email, name, endDate, startDate);
            var model = response.Ok();
            Assert.IsType<CustomerListResponse>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CustomerReadAsyncTest()
        {
            string id = default!;
            var response = await _instance.CustomerReadAsync(id);
            var model = response.Ok();
            Assert.IsType<CustomerReadResponse>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CustomerUpdateAsyncTest()
        {
            string id = default!;
            CustomerUpdateRequest customerUpdateRequest = default!;
            var response = await _instance.CustomerUpdateAsync(id, customerUpdateRequest);
            var model = response.Ok();
            Assert.IsType<CustomerReadResponse>(model);
        }
    }
