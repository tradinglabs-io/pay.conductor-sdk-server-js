...
namespace payconductor_sdk.Model
{
    ...
    /// </summary>
    public partial class OrderNuPayPaymentRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderNuPayPaymentRequest" /> class.
        /// </summary>
        ...
        public OrderNuPayPaymentRequestNuPay NuPay { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="OrderNuPayPaymentRequest" />
    /// </summary>
    public class OrderNuPayPaymentRequestJsonConverter : JsonConverter<OrderNuPayPaymentRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="OrderNuPayPaymentRequest" />
        /// </summary>
        ...
        public override OrderNuPayPaymentRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!paymentMethod.IsSet)
                throw new ArgumentException("Property is required for class OrderNuPayPaymentRequest.", nameof(paymentMethod));

            if (!nuPay.IsSet)
                throw new ArgumentException("Property is required for class OrderNuPayPaymentRequest.", nameof(nuPay));

            if (paymentMethod.IsSet && paymentMethod.Value == null)
                throw new ArgumentNullException(nameof(paymentMethod), "Property is not nullable for class OrderNuPayPaymentRequest.");
        ...
        /// <summary>
        /// Serializes a <see cref="OrderNuPayPaymentRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="orderNuPayPaymentRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, OrderNuPayPaymentRequest orderNuPayPaymentRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, orderNuPayPaymentRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="OrderNuPayPaymentRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="orderNuPayPaymentRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
