...
namespace payconductor_sdk.Model
{
    ...
    /// NuPay payment data
    /// </summary>
    public partial class OrderNuPayInfo : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderNuPayInfo" /> class.
        /// </summary>
        /// <param name="paymentUrl">NuPay payment URL</param>
        [JsonConstructor]
        public OrderNuPayInfo(string paymentUrl)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="OrderNuPayInfo" />
    /// </summary>
    public class OrderNuPayInfoJsonConverter : JsonConverter<OrderNuPayInfo>
    {
        /// <summary>
        /// Deserializes json to <see cref="OrderNuPayInfo" />
        /// </summary>
        ...
        public override OrderNuPayInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!paymentUrl.IsSet)
                throw new ArgumentException("Property is required for class OrderNuPayInfo.", nameof(paymentUrl));

            if (paymentUrl.IsSet && paymentUrl.Value == null)
                throw new ArgumentNullException(nameof(paymentUrl), "Property is not nullable for class OrderNuPayInfo.");

            return new OrderNuPayInfo(paymentUrl.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="OrderNuPayInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="orderNuPayInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, OrderNuPayInfo orderNuPayInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, orderNuPayInfo, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="OrderNuPayInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="orderNuPayInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, OrderNuPayInfo orderNuPayInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            if (orderNuPayInfo.PaymentUrl == null)
                throw new ArgumentNullException(nameof(orderNuPayInfo.PaymentUrl), "Property is required for class OrderNuPayInfo.");

            writer.WriteString("paymentUrl", orderNuPayInfo.PaymentUrl);
        }
    }
}
