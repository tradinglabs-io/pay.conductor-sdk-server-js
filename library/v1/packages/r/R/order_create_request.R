#' Create a new OrderCreateRequest
#'
#' @description
...
#' @description OrderCreateRequest Class
...
#' @field customer  \link{CustomerCreateRequest}
#' @field discountAmount Discount amount numeric
#' @field externalId Order ID in your system character
#' @field fingerprints  \link{OrderFraudFingerprints} [optional]
#' @field items List of products or services in the order list(\link{OrderItemData}) [optional]
#' @field merchant  \link{MerchantInput} [optional]
#' @field payment  \link{OrderPaymentRequest}
...
#' @field session  \link{OrderCreateRequestSession} [optional]
...
OrderCreateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new OrderCreateRequest class.
    #'
    ...
    #'
    #' @return OrderCreateRequest as a base R list.
    #' @examples
    #' # convert array of OrderCreateRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert OrderCreateRequest to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      OrderCreateRequestObject <- list()
      if (!is.null(self$`chargeAmount`)) {
        OrderCreateRequestObject[["chargeAmount"]] <-
          self$`chargeAmount`
      }
      if (!is.null(self$`clientIp`)) {
        OrderCreateRequestObject[["clientIp"]] <-
          self$`clientIp`
      }
      if (!is.null(self$`customer`)) {
        OrderCreateRequestObject[["customer"]] <-
          self$extractSimpleType(self$`customer`)
      }
      if (!is.null(self$`discountAmount`)) {
        OrderCreateRequestObject[["discountAmount"]] <-
          self$`discountAmount`
      }
      if (!is.null(self$`externalId`)) {
        OrderCreateRequestObject[["externalId"]] <-
          self$`externalId`
      }
      if (!is.null(self$`fingerprints`)) {
        OrderCreateRequestObject[["fingerprints"]] <-
          self$extractSimpleType(self$`fingerprints`)
      }
      if (!is.null(self$`items`)) {
        OrderCreateRequestObject[["items"]] <-
          self$extractSimpleType(self$`items`)
      }
      if (!is.null(self$`merchant`)) {
        OrderCreateRequestObject[["merchant"]] <-
          self$extractSimpleType(self$`merchant`)
      }
      if (!is.null(self$`payment`)) {
        OrderCreateRequestObject[["payment"]] <-
          self$extractSimpleType(self$`payment`)
      }
      if (!is.null(self$`splitAmountTotal`)) {
        OrderCreateRequestObject[["splitAmountTotal"]] <-
          self$`splitAmountTotal`
      }
      if (!is.null(self$`session`)) {
        OrderCreateRequestObject[["session"]] <-
          self$extractSimpleType(self$`session`)
      }
      if (!is.null(self$`shippingFee`)) {
        OrderCreateRequestObject[["shippingFee"]] <-
          self$`shippingFee`
      }
      if (!is.null(self$`taxFee`)) {
        OrderCreateRequestObject[["taxFee"]] <-
          self$`taxFee`
      }
      if (!is.null(self$`metadata`)) {
        OrderCreateRequestObject[["metadata"]] <-
          self$`metadata`
      }
      return(OrderCreateRequestObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of OrderCreateRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of OrderCreateRequest
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`customer`)) {
        `customer_object` <- CustomerCreateRequest$new()
      ...
      if (!is.null(this_object$`fingerprints`)) {
        `fingerprints_object` <- OrderFraudFingerprints$new()
      ...
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[OrderItemData]", loadNamespace("payconductor_sdk"))
      }
      ...
      if (!is.null(this_object$`payment`)) {
        `payment_object` <- OrderPaymentRequest$new()
      ...
      if (!is.null(this_object$`session`)) {
        `session_object` <- OrderCreateRequestSession$new()
    ...
    #' @return OrderCreateRequest in JSON format
    ...
    fromJSONString = function(input_json) {
      ...
      self$`chargeAmount` <- this_object$`chargeAmount`
      self$`clientIp` <- this_object$`clientIp`
      self$`customer` <- CustomerCreateRequest$new()$fromJSON(jsonlite::toJSON(this_object$`customer`, auto_unbox = TRUE, digits = NA))
      self$`discountAmount` <- this_object$`discountAmount`
      self$`externalId` <- this_object$`externalId`
      self$`fingerprints` <- OrderFraudFingerprints$new()$fromJSON(jsonlite::toJSON(this_object$`fingerprints`, auto_unbox = TRUE, digits = NA))
      self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[OrderItemData]", loadNamespace("payconductor_sdk"))
      self$`merchant` <- MerchantInput$new()$fromJSON(jsonlite::toJSON(this_object$`merchant`, auto_unbox = TRUE, digits = NA))
      self$`payment` <- OrderPaymentRequest$new()$fromJSON(jsonlite::toJSON(this_object$`payment`, auto_unbox = TRUE, digits = NA))
      self$`splitAmountTotal` <- this_object$`splitAmountTotal`
      self$`session` <- OrderCreateRequestSession$new()$fromJSON(jsonlite::toJSON(this_object$`session`, auto_unbox = TRUE, digits = NA))
      self$`shippingFee` <- this_object$`shippingFee`
      self$`taxFee` <- this_object$`taxFee`
      self$`metadata` <- this_object$`metadata`
      self
    ...
    #' @description
    #' Validate JSON input with respect to OrderCreateRequest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`chargeAmount`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateRequest: the required field `chargeAmount` is missing."))
      }
      ...
      if (!is.null(input_json$`clientIp`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateRequest: the required field `clientIp` is missing."))
      }
      # check the required field `customer`
      if (!is.null(input_json$`customer`)) {
        stopifnot(R6::is.R6(input_json$`customer`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateRequest: the required field `customer` is missing."))
      }
      # check the required field `discountAmount`
      if (!is.null(input_json$`discountAmount`)) {
      } else {
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateRequest: the required field `discountAmount` is missing."))
      }
      ...
      if (!is.null(input_json$`externalId`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateRequest: the required field `externalId` is missing."))
      }
      # check the required field `payment`
      if (!is.null(input_json$`payment`)) {
        stopifnot(R6::is.R6(input_json$`payment`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateRequest: the required field `payment` is missing."))
      }
      # check the required field `shippingFee`
      if (!is.null(input_json$`shippingFee`)) {
      } else {
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateRequest: the required field `shippingFee` is missing."))
      }
      # check the required field `taxFee`
      if (!is.null(input_json$`taxFee`)) {
      } else {
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateRequest: the required field `taxFee` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of OrderCreateRequest
    toString = function() {
      self$toJSONString()
    },
...
# OrderCreateRequest$unlock()
#
## Below is an example to define the print function
# OrderCreateRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OrderCreateRequest$lock()
