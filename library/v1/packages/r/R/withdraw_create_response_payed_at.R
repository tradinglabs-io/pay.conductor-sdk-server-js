#' @docType class
#' @title WithdrawCreateResponsePayedAt
#'
#' @description WithdrawCreateResponsePayedAt Class
#'
...
#' @export
WithdrawCreateResponsePayedAt <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new WithdrawCreateResponsePayedAt.
    #'
    ...
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize WithdrawCreateResponsePayedAt with anyOf schemas Date, character, numeric. Provided class name: ",
                   get(class(instance)[[1]], pos = -1)$classname))
      }
    },

    #' @description
    #' Deserialize JSON string into an instance of WithdrawCreateResponsePayedAt.
    ...
    fromJSON = function(input) {
      ...
      # no match
      stop(paste("No match found when deserializing the input into WithdrawCreateResponsePayedAt with anyOf schemas Date, character, numeric. Details: >>",
    ...
    #' @description
    #' Convert WithdrawCreateResponsePayedAt to a base R type
    #'
    ...
    #' @description
    #' Serialize WithdrawCreateResponsePayedAt to JSON string.
    #'
    #' @param ... Parameters passed to `jsonlite::toJSON`
    #' @return JSON string representation of the WithdrawCreateResponsePayedAt.
    ...
    #' @description
    #' Validate the input JSON with respect to WithdrawCreateResponsePayedAt and
...
#WithdrawCreateResponsePayedAt$unlock()
#
## Below is an example to define the print function
#WithdrawCreateResponsePayedAt$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#WithdrawCreateResponsePayedAt$lock()
