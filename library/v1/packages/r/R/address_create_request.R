#' Create a new AddressCreateRequest
#'
#' @description
...
#' @description AddressCreateRequest Class
...
#' @export
AddressCreateRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AddressCreateRequest class.
    #'
    ...
    #'
    #' @return AddressCreateRequest as a base R list.
    #' @examples
    #' # convert array of AddressCreateRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AddressCreateRequest to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      AddressCreateRequestObject <- list()
      if (!is.null(self$`city`)) {
        AddressCreateRequestObject[["city"]] <-
          self$`city`
      }
      if (!is.null(self$`country`)) {
        AddressCreateRequestObject[["country"]] <-
          self$`country`
      }
      if (!is.null(self$`neighborhood`)) {
        AddressCreateRequestObject[["neighborhood"]] <-
          self$`neighborhood`
      }
      if (!is.null(self$`number`)) {
        AddressCreateRequestObject[["number"]] <-
          self$`number`
      }
      if (!is.null(self$`state`)) {
        AddressCreateRequestObject[["state"]] <-
          self$`state`
      }
      if (!is.null(self$`street`)) {
        AddressCreateRequestObject[["street"]] <-
          self$`street`
      }
      if (!is.null(self$`zipCode`)) {
        AddressCreateRequestObject[["zipCode"]] <-
          self$`zipCode`
      }
      return(AddressCreateRequestObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of AddressCreateRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of AddressCreateRequest
    ...
    #' @return AddressCreateRequest in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AddressCreateRequest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`city`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AddressCreateRequest: the required field `city` is missing."))
      }
      ...
      if (!is.null(input_json$`country`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AddressCreateRequest: the required field `country` is missing."))
      }
      ...
      if (!is.null(input_json$`neighborhood`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AddressCreateRequest: the required field `neighborhood` is missing."))
      }
      ...
      if (!is.null(input_json$`number`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AddressCreateRequest: the required field `number` is missing."))
      }
      ...
      if (!is.null(input_json$`state`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AddressCreateRequest: the required field `state` is missing."))
      }
      ...
      if (!is.null(input_json$`street`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AddressCreateRequest: the required field `street` is missing."))
      }
      ...
      if (!is.null(input_json$`zipCode`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AddressCreateRequest: the required field `zipCode` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of AddressCreateRequest
    toString = function() {
      self$toJSONString()
    },
...
# AddressCreateRequest$unlock()
#
## Below is an example to define the print function
# AddressCreateRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AddressCreateRequest$lock()
