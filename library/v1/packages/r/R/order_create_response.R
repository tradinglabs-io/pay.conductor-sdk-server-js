#' Create a new OrderCreateResponse
#'
#' @description
...
#' @description OrderCreateResponse Class
...
#' @field creditCard  \link{OrderCreditCardInfo} [optional]
...
#' @field orderItems  list(\link{OrderCreateResponseOrderItemsInner})
#' @field session  \link{OrderCreateResponseSession} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
OrderCreateResponse <- R6::R6Class(
  "OrderCreateResponse",
  public = list(
    `id` = NULL,
    `externalId` = NULL,
    ...
    #' @description
    #' Initialize a new OrderCreateResponse class.
    #'
    ...
    #'
    #' @return OrderCreateResponse as a base R list.
    #' @examples
    #' # convert array of OrderCreateResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert OrderCreateResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      OrderCreateResponseObject <- list()
      if (!is.null(self$`id`)) {
        OrderCreateResponseObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`externalId`)) {
        OrderCreateResponseObject[["externalId"]] <-
          self$`externalId`
      }
      if (!is.null(self$`externalIntegrationKey`)) {
        OrderCreateResponseObject[["externalIntegrationKey"]] <-
          self$`externalIntegrationKey`
      }
      if (!is.null(self$`externalIntegrationId`)) {
        OrderCreateResponseObject[["externalIntegrationId"]] <-
          self$`externalIntegrationId`
      }
      if (!is.null(self$`amount`)) {
        OrderCreateResponseObject[["amount"]] <-
          self$`amount`
      }
      if (!is.null(self$`costFee`)) {
        OrderCreateResponseObject[["costFee"]] <-
          self$`costFee`
      }
      if (!is.null(self$`pix`)) {
        OrderCreateResponseObject[["pix"]] <-
          self$extractSimpleType(self$`pix`)
      }
      if (!is.null(self$`bankSlip`)) {
        OrderCreateResponseObject[["bankSlip"]] <-
          self$extractSimpleType(self$`bankSlip`)
      }
      if (!is.null(self$`nuPay`)) {
        OrderCreateResponseObject[["nuPay"]] <-
          self$extractSimpleType(self$`nuPay`)
      }
      if (!is.null(self$`picPay`)) {
        OrderCreateResponseObject[["picPay"]] <-
          self$extractSimpleType(self$`picPay`)
      }
      if (!is.null(self$`creditCard`)) {
        OrderCreateResponseObject[["creditCard"]] <-
          self$extractSimpleType(self$`creditCard`)
      }
      if (!is.null(self$`status`)) {
        OrderCreateResponseObject[["status"]] <-
          self$extractSimpleType(self$`status`)
      }
      if (!is.null(self$`paymentMethod`)) {
        OrderCreateResponseObject[["paymentMethod"]] <-
          self$extractSimpleType(self$`paymentMethod`)
      }
      if (!is.null(self$`payedAt`)) {
        OrderCreateResponseObject[["payedAt"]] <-
          self$`payedAt`
      }
      if (!is.null(self$`errorCode`)) {
        OrderCreateResponseObject[["errorCode"]] <-
          self$`errorCode`
      }
      if (!is.null(self$`errorMessage`)) {
        OrderCreateResponseObject[["errorMessage"]] <-
          self$`errorMessage`
      }
      if (!is.null(self$`orderItems`)) {
        OrderCreateResponseObject[["orderItems"]] <-
          self$extractSimpleType(self$`orderItems`)
      }
      if (!is.null(self$`session`)) {
        OrderCreateResponseObject[["session"]] <-
          self$extractSimpleType(self$`session`)
      }
      return(OrderCreateResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of OrderCreateResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of OrderCreateResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`creditCard`)) {
        `creditcard_object` <- OrderCreditCardInfo$new()
      ...
      if (!is.null(this_object$`orderItems`)) {
        self$`orderItems` <- ApiClient$new()$deserializeObj(this_object$`orderItems`, "array[OrderCreateResponseOrderItemsInner]", loadNamespace("payconductor_sdk"))
      }
      if (!is.null(this_object$`session`)) {
        `session_object` <- OrderCreateResponseSession$new()
    ...
    #' @return OrderCreateResponse in JSON format
    ...
    fromJSONString = function(input_json) {
      ...
      self$`creditCard` <- OrderCreditCardInfo$new()$fromJSON(jsonlite::toJSON(this_object$`creditCard`, auto_unbox = TRUE, digits = NA))
      ...
      self$`errorMessage` <- this_object$`errorMessage`
      self$`orderItems` <- ApiClient$new()$deserializeObj(this_object$`orderItems`, "array[OrderCreateResponseOrderItemsInner]", loadNamespace("payconductor_sdk"))
      self$`session` <- OrderCreateResponseSession$new()$fromJSON(jsonlite::toJSON(this_object$`session`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to OrderCreateResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateResponse: the required field `id` is missing."))
      }
      ...
      if (!is.null(input_json$`externalId`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateResponse: the required field `externalId` is missing."))
      }
      ...
      if (!is.null(input_json$`externalIntegrationKey`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateResponse: the required field `externalIntegrationKey` is missing."))
      }
      ...
      if (!is.null(input_json$`externalIntegrationId`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateResponse: the required field `externalIntegrationId` is missing."))
      }
      # check the required field `amount`
      if (!is.null(input_json$`amount`)) {
      } else {
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateResponse: the required field `amount` is missing."))
      }
      # check the required field `costFee`
      if (!is.null(input_json$`costFee`)) {
      } else {
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateResponse: the required field `costFee` is missing."))
      }
      # check the required field `status`
      if (!is.null(input_json$`status`)) {
        stopifnot(R6::is.R6(input_json$`status`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateResponse: the required field `status` is missing."))
      }
      # check the required field `paymentMethod`
      if (!is.null(input_json$`paymentMethod`)) {
        stopifnot(R6::is.R6(input_json$`paymentMethod`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateResponse: the required field `paymentMethod` is missing."))
      }
      ...
      if (!is.null(input_json$`payedAt`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateResponse: the required field `payedAt` is missing."))
      }
      ...
      if (!is.null(input_json$`errorCode`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateResponse: the required field `errorCode` is missing."))
      }
      ...
      if (!is.null(input_json$`errorMessage`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateResponse: the required field `errorMessage` is missing."))
      }
      ...
      if (!is.null(input_json$`orderItems`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateResponse: the required field `orderItems` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of OrderCreateResponse
    toString = function() {
      self$toJSONString()
    },
...
# OrderCreateResponse$unlock()
#
## Below is an example to define the print function
# OrderCreateResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OrderCreateResponse$lock()
