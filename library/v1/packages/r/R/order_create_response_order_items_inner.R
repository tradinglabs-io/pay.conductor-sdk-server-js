#' Create a new OrderCreateResponseOrderItemsInner
#'
#' @description
#' OrderCreateResponseOrderItemsInner Class
#'
#' @docType class
#' @title OrderCreateResponseOrderItemsInner
#' @description OrderCreateResponseOrderItemsInner Class
...
#' @export
OrderCreateResponseOrderItemsInner <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new OrderCreateResponseOrderItemsInner class.
    #'
    ...
    #'
    #' @return OrderCreateResponseOrderItemsInner as a base R list.
    #' @examples
    #' # convert array of OrderCreateResponseOrderItemsInner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert OrderCreateResponseOrderItemsInner to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      OrderCreateResponseOrderItemsInnerObject <- list()
      if (!is.null(self$`externalId`)) {
        OrderCreateResponseOrderItemsInnerObject[["externalId"]] <-
          self$`externalId`
      }
      if (!is.null(self$`id`)) {
        OrderCreateResponseOrderItemsInnerObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`name`)) {
        OrderCreateResponseOrderItemsInnerObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`qty`)) {
        OrderCreateResponseOrderItemsInnerObject[["qty"]] <-
          self$`qty`
      }
      if (!is.null(self$`totalAmount`)) {
        OrderCreateResponseOrderItemsInnerObject[["totalAmount"]] <-
          self$`totalAmount`
      }
      if (!is.null(self$`totalNetAmount`)) {
        OrderCreateResponseOrderItemsInnerObject[["totalNetAmount"]] <-
          self$`totalNetAmount`
      }
      if (!is.null(self$`unityPrice`)) {
        OrderCreateResponseOrderItemsInnerObject[["unityPrice"]] <-
          self$`unityPrice`
      }
      return(OrderCreateResponseOrderItemsInnerObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of OrderCreateResponseOrderItemsInner
    #'
    #' @param input_json the JSON input
    #' @return the instance of OrderCreateResponseOrderItemsInner
    ...
    #' @return OrderCreateResponseOrderItemsInner in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to OrderCreateResponseOrderItemsInner and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`externalId`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateResponseOrderItemsInner: the required field `externalId` is missing."))
      }
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateResponseOrderItemsInner: the required field `id` is missing."))
      }
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateResponseOrderItemsInner: the required field `name` is missing."))
      }
      # check the required field `qty`
      if (!is.null(input_json$`qty`)) {
      } else {
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateResponseOrderItemsInner: the required field `qty` is missing."))
      }
      # check the required field `totalAmount`
      if (!is.null(input_json$`totalAmount`)) {
      } else {
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateResponseOrderItemsInner: the required field `totalAmount` is missing."))
      }
      # check the required field `totalNetAmount`
      if (!is.null(input_json$`totalNetAmount`)) {
      } else {
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateResponseOrderItemsInner: the required field `totalNetAmount` is missing."))
      }
      # check the required field `unityPrice`
      if (!is.null(input_json$`unityPrice`)) {
      } else {
        stop(paste("The JSON input `", input, "` is invalid for OrderCreateResponseOrderItemsInner: the required field `unityPrice` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of OrderCreateResponseOrderItemsInner
    toString = function() {
      self$toJSONString()
    },
...
# OrderCreateResponseOrderItemsInner$unlock()
#
## Below is an example to define the print function
# OrderCreateResponseOrderItemsInner$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OrderCreateResponseOrderItemsInner$lock()
