...
context("Test OrderCreateRequest")

model_instance <- OrderCreateRequest$new()
...
test_that("customer", {
  # tests for the property `customer` (CustomerCreateRequest)
...
test_that("fingerprints", {
  # tests for the property `fingerprints` (OrderFraudFingerprints)
...
test_that("items", {
  # tests for the property `items` (array[OrderItemData])
...
test_that("payment", {
  # tests for the property `payment` (OrderPaymentRequest)
...
test_that("session", {
  # tests for the property `session` (OrderCreateRequestSession)
