...
context("Test WithdrawCreateResponse")

model_instance <- WithdrawCreateResponse$new()
...
test_that("payedAt", {
  # tests for the property `payedAt` (WithdrawCreateResponsePayedAt)
...
test_that("payoutAccount", {
  # tests for the property `payoutAccount` (WithdrawCreateResponsePayoutAccount)
