...
context("Test OrderCreateResponse")

model_instance <- OrderCreateResponse$new()
...
test_that("creditCard", {
  # tests for the property `creditCard` (OrderCreditCardInfo)
...
test_that("orderItems", {
  # tests for the property `orderItems` (array[OrderCreateResponseOrderItemsInner])
...
test_that("session", {
  # tests for the property `session` (OrderCreateResponseSession)
