...
--[[
Unit tests for payconductor_sdk.model.withdraw_create_response_payed_at
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("withdraw_create_response_payed_at", function()
  local payconductor_sdk_withdraw_create_response_payed_at = require "payconductor_sdk.model.withdraw_create_response_payed_at"
