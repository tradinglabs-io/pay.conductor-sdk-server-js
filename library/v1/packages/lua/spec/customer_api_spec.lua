...
--[[
Unit tests for payconductor_sdk.api.customer_api
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("customer_api", function()
  local payconductor_sdk_customer_api = require "payconductor_sdk.api.customer_api"
  -- unit tests for customer_create
  describe("customer_create test", function()
  ...
  describe("customer_list_custom test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
  ...
  describe("customer_read test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
