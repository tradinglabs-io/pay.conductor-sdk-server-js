...
--[[
Unit tests for payconductor_sdk.model.customer_list_pagination
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("customer_list_pagination", function()
  local payconductor_sdk_customer_list_pagination = require "payconductor_sdk.model.customer_list_pagination"
  ...
  -- unit tests for the property 'total_items'
  describe("property total_items test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
