...
--[[
Unit tests for payconductor_sdk.api.withdraw_api
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("withdraw_api", function()
  local payconductor_sdk_withdraw_api = require "payconductor_sdk.api.withdraw_api"
  -- unit tests for withdraw_create
  describe("withdraw_create test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)

  -- unit tests for withdraw_list
  describe("withdraw_list test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)

  -- unit tests for withdraw_read
  describe("withdraw_read test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
