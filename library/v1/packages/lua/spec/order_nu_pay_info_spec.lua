...
--[[
Unit tests for payconductor_sdk.model.order_nu_pay_info
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("order_nu_pay_info", function()
  local payconductor_sdk_order_nu_pay_info = require "payconductor_sdk.model.order_nu_pay_info"
