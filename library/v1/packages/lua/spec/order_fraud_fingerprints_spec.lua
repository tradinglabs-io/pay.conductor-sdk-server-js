...
--[[
Unit tests for payconductor_sdk.model.order_fraud_fingerprints
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("order_fraud_fingerprints", function()
  local payconductor_sdk_order_fraud_fingerprints = require "payconductor_sdk.model.order_fraud_fingerprints"
