...
--[[
Unit tests for payconductor_sdk.model.order_pix_payment_request
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("order_pix_payment_request", function()
  local payconductor_sdk_order_pix_payment_request = require "payconductor_sdk.model.order_pix_payment_request"
