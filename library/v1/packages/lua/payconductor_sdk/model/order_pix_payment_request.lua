...
-- order_pix_payment_request class
local order_pix_payment_request = {}
local order_pix_payment_request_mt = {
	__name = "order_pix_payment_request";
	__index = order_pix_payment_request;
}

local function cast_order_pix_payment_request(t)
	return setmetatable(t, order_pix_payment_request_mt)
end

local function new_order_pix_payment_request(payment_method, expiration_in_seconds)
	return cast_order_pix_payment_request({
...
return {
	cast = cast_order_pix_payment_request;
	new = new_order_pix_payment_request;
}
