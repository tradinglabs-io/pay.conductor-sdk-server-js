...
-- order_nu_pay_payment_request_nu_pay class
local order_nu_pay_payment_request_nu_pay = {}
local order_nu_pay_payment_request_nu_pay_mt = {
	__name = "order_nu_pay_payment_request_nu_pay";
	__index = order_nu_pay_payment_request_nu_pay;
}

local function cast_order_nu_pay_payment_request_nu_pay(t)
	return setmetatable(t, order_nu_pay_payment_request_nu_pay_mt)
end

local function new_order_nu_pay_payment_request_nu_pay(cancel_url, merchant_name, return_url, store_name)
	return cast_order_nu_pay_payment_request_nu_pay({
...
return {
	cast = cast_order_nu_pay_payment_request_nu_pay;
	new = new_order_nu_pay_payment_request_nu_pay;
}
