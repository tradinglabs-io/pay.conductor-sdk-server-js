...
-- card_tokenization_customer_by_id_data class
local card_tokenization_customer_by_id_data = {}
local card_tokenization_customer_by_id_data_mt = {
	__name = "card_tokenization_customer_by_id_data";
	__index = card_tokenization_customer_by_id_data;
}

local function cast_card_tokenization_customer_by_id_data(t)
	return setmetatable(t, card_tokenization_customer_by_id_data_mt)
end

local function new_card_tokenization_customer_by_id_data(id)
	return cast_card_tokenization_customer_by_id_data({
		["id"] = id;
	})
end

return {
	cast = cast_card_tokenization_customer_by_id_data;
	new = new_card_tokenization_customer_by_id_data;
}
