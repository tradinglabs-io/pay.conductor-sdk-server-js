...
-- order_nu_pay_info class
local order_nu_pay_info = {}
local order_nu_pay_info_mt = {
	__name = "order_nu_pay_info";
	__index = order_nu_pay_info;
}

local function cast_order_nu_pay_info(t)
	return setmetatable(t, order_nu_pay_info_mt)
end

local function new_order_nu_pay_info(payment_url)
	return cast_order_nu_pay_info({
		["paymentUrl"] = payment_url;
	})
end

return {
	cast = cast_order_nu_pay_info;
	new = new_order_nu_pay_info;
}
