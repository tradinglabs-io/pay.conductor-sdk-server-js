...
-- card_tokenization_create_response class
local card_tokenization_create_response = {}
local card_tokenization_create_response_mt = {
	__name = "card_tokenization_create_response";
	__index = card_tokenization_create_response;
}

local function cast_card_tokenization_create_response(t)
	return setmetatable(t, card_tokenization_create_response_mt)
end

local function new_card_tokenization_create_response(customer_id, token)
	return cast_card_tokenization_create_response({
...
return {
	cast = cast_card_tokenization_create_response;
	new = new_card_tokenization_create_response;
}
