...
-- order_fraud_fingerprints class
local order_fraud_fingerprints = {}
local order_fraud_fingerprints_mt = {
	__name = "order_fraud_fingerprints";
	__index = order_fraud_fingerprints;
}

local function cast_order_fraud_fingerprints(t)
	return setmetatable(t, order_fraud_fingerprints_mt)
end

local function new_order_fraud_fingerprints(threat_metrix_fingerprint_id)
	return cast_order_fraud_fingerprints({
		["threatMetrixFingerprintId"] = threat_metrix_fingerprint_id;
	})
end

return {
	cast = cast_order_fraud_fingerprints;
	new = new_order_fraud_fingerprints;
}
