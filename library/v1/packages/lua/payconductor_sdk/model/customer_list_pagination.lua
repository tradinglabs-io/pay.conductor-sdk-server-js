...
-- customer_list_pagination class
local customer_list_pagination = {}
local customer_list_pagination_mt = {
	__name = "customer_list_pagination";
	__index = customer_list_pagination;
}

local function cast_customer_list_pagination(t)
	return setmetatable(t, customer_list_pagination_mt)
end

local function new_customer_list_pagination(current_page, page_size, total_items, total_pages)
	return cast_customer_list_pagination({
...
return {
	cast = cast_customer_list_pagination;
	new = new_customer_list_pagination;
}
