...
-- customer_list_response class
local customer_list_response = {}
local customer_list_response_mt = {
	__name = "customer_list_response";
	__index = customer_list_response;
}

local function cast_customer_list_response(t)
	return setmetatable(t, customer_list_response_mt)
end

local function new_customer_list_response(data, pagination)
	return cast_customer_list_response({
		["data"] = data;
...
return {
	cast = cast_customer_list_response;
	new = new_customer_list_response;
}
