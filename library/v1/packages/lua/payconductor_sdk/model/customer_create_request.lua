...
-- customer_create_request class
local customer_create_request = {}
local customer_create_request_mt = {
	__name = "customer_create_request";
	__index = customer_create_request;
}

local function cast_customer_create_request(t)
	return setmetatable(t, customer_create_request_mt)
end

local function new_customer_create_request(address, document_number, document_type, email, name, phone_number)
	return cast_customer_create_request({
		["address"] = address;
...
return {
	cast = cast_customer_create_request;
	new = new_customer_create_request;
}
