...
-- withdraw_create_request class
local withdraw_create_request = {}
local withdraw_create_request_mt = {
	__name = "withdraw_create_request";
	__index = withdraw_create_request;
}

local function cast_withdraw_create_request(t)
	return setmetatable(t, withdraw_create_request_mt)
end

local function new_withdraw_create_request(amount, external_id, merchant, payout_account)
	return cast_withdraw_create_request({
		["amount"] = amount;
...
return {
	cast = cast_withdraw_create_request;
	new = new_withdraw_create_request;
}
