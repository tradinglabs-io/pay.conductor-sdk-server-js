...
-- customer_read_response class
local customer_read_response = {}
local customer_read_response_mt = {
	__name = "customer_read_response";
	__index = customer_read_response;
}

local function cast_customer_read_response(t)
	return setmetatable(t, customer_read_response_mt)
end

local function new_customer_read_response(id, name, email, document_type, document_number, phone_number, address, created_at, updated_at)
	return cast_customer_read_response({
		["id"] = id;
		["name"] = name;
		["email"] = email;
...
return {
	cast = cast_customer_read_response;
	new = new_customer_read_response;
}
