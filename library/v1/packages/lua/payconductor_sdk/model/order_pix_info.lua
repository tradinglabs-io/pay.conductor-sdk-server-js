...
-- order_pix_info class
local order_pix_info = {}
local order_pix_info_mt = {
	__name = "order_pix_info";
	__index = order_pix_info;
}

local function cast_order_pix_info(t)
	return setmetatable(t, order_pix_info_mt)
end

local function new_order_pix_info(copy_and_paste_code, qr_code_url, end_to_end_id)
	return cast_order_pix_info({
...
return {
	cast = cast_order_pix_info;
	new = new_order_pix_info;
}
