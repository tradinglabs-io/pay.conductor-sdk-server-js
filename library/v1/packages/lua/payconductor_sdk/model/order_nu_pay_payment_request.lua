...
-- order_nu_pay_payment_request class
local order_nu_pay_payment_request = {}
local order_nu_pay_payment_request_mt = {
	__name = "order_nu_pay_payment_request";
	__index = order_nu_pay_payment_request;
}

local function cast_order_nu_pay_payment_request(t)
	return setmetatable(t, order_nu_pay_payment_request_mt)
end

local function new_order_nu_pay_payment_request(payment_method, nu_pay)
	return cast_order_nu_pay_payment_request({
...
return {
	cast = cast_order_nu_pay_payment_request;
	new = new_order_nu_pay_payment_request;
}
