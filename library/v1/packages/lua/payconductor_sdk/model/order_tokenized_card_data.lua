...
-- order_tokenized_card_data class
local order_tokenized_card_data = {}
local order_tokenized_card_data_mt = {
	__name = "order_tokenized_card_data";
	__index = order_tokenized_card_data;
}

local function cast_order_tokenized_card_data(t)
	return setmetatable(t, order_tokenized_card_data_mt)
end

local function new_order_tokenized_card_data(first_six_card_number, token)
	return cast_order_tokenized_card_data({
...
return {
	cast = cast_order_tokenized_card_data;
	new = new_order_tokenized_card_data;
}
