...
-- withdraw_create_response_payout_account class
local withdraw_create_response_payout_account = {}
local withdraw_create_response_payout_account_mt = {
	__name = "withdraw_create_response_payout_account";
	__index = withdraw_create_response_payout_account;
}

local function cast_withdraw_create_response_payout_account(t)
	return setmetatable(t, withdraw_create_response_payout_account_mt)
end

local function new_withdraw_create_response_payout_account(id, owner_document, owner_name, pix_key, pix_type)
	return cast_withdraw_create_response_payout_account({
		["id"] = id;
...
return {
	cast = cast_withdraw_create_response_payout_account;
	new = new_withdraw_create_response_payout_account;
}
