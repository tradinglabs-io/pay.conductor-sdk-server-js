...
-- order_pic_pay_payment_request class
local order_pic_pay_payment_request = {}
local order_pic_pay_payment_request_mt = {
	__name = "order_pic_pay_payment_request";
	__index = order_pic_pay_payment_request;
}

local function cast_order_pic_pay_payment_request(t)
	return setmetatable(t, order_pic_pay_payment_request_mt)
end

local function new_order_pic_pay_payment_request(payment_method)
	return cast_order_pic_pay_payment_request({
		["paymentMethod"] = payment_method;
	})
end

return {
	cast = cast_order_pic_pay_payment_request;
	new = new_order_pic_pay_payment_request;
}
