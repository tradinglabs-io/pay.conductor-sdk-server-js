...
-- order_create_response_order_items_inner class
local order_create_response_order_items_inner = {}
local order_create_response_order_items_inner_mt = {
	__name = "order_create_response_order_items_inner";
	__index = order_create_response_order_items_inner;
}

local function cast_order_create_response_order_items_inner(t)
	return setmetatable(t, order_create_response_order_items_inner_mt)
end

local function new_order_create_response_order_items_inner(external_id, id, name, qty, total_amount, total_net_amount, unity_price)
	return cast_order_create_response_order_items_inner({
...
return {
	cast = cast_order_create_response_order_items_inner;
	new = new_order_create_response_order_items_inner;
}
