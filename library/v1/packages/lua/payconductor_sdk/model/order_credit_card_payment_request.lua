...
-- order_credit_card_payment_request class
local order_credit_card_payment_request = {}
local order_credit_card_payment_request_mt = {
	__name = "order_credit_card_payment_request";
	__index = order_credit_card_payment_request;
}

local function cast_order_credit_card_payment_request(t)
	return setmetatable(t, order_credit_card_payment_request_mt)
end

local function new_order_credit_card_payment_request(payment_method, card, installments, soft_descriptor)
	return cast_order_credit_card_payment_request({
...
return {
	cast = cast_order_credit_card_payment_request;
	new = new_order_credit_card_payment_request;
}
