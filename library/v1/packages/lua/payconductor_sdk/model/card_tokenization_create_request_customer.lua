...
-- card_tokenization_create_request_customer class
local card_tokenization_create_request_customer = {}
local card_tokenization_create_request_customer_mt = {
	__name = "card_tokenization_create_request_customer";
	__index = card_tokenization_create_request_customer;
}

local function cast_card_tokenization_create_request_customer(t)
	return setmetatable(t, card_tokenization_create_request_customer_mt)
end

local function new_card_tokenization_create_request_customer(address, document_number, document_type, email, name, phone_number, id)
	return cast_card_tokenization_create_request_customer({
		["address"] = address;
...
return {
	cast = cast_card_tokenization_create_request_customer;
	new = new_card_tokenization_create_request_customer;
}
