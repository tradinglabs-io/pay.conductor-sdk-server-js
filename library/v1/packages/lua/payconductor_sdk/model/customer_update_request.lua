...
-- customer_update_request class
local customer_update_request = {}
local customer_update_request_mt = {
	__name = "customer_update_request";
	__index = customer_update_request;
}

local function cast_customer_update_request(t)
	return setmetatable(t, customer_update_request_mt)
end

local function new_customer_update_request(address, document_number, document_type, email, name, phone_number)
	return cast_customer_update_request({
		["address"] = address;
...
return {
	cast = cast_customer_update_request;
	new = new_customer_update_request;
}
