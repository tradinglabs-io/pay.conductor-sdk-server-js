...
-- customer_address_response class
local customer_address_response = {}
local customer_address_response_mt = {
	__name = "customer_address_response";
	__index = customer_address_response;
}

local function cast_customer_address_response(t)
	return setmetatable(t, customer_address_response_mt)
end

local function new_customer_address_response(id, street, Number_, neighborhood, city, state, zip_code, country)
	return cast_customer_address_response({
		["id"] = id;
		["street"] = street;
		["number"] = Number_;
...
return {
	cast = cast_customer_address_response;
	new = new_customer_address_response;
}
