...
-- withdraw_create_response_payed_at class
local withdraw_create_response_payed_at = {}
local withdraw_create_response_payed_at_mt = {
	__name = "withdraw_create_response_payed_at";
	__index = withdraw_create_response_payed_at;
}

local function cast_withdraw_create_response_payed_at(t)
	return setmetatable(t, withdraw_create_response_payed_at_mt)
end

local function new_withdraw_create_response_payed_at()
	return cast_withdraw_create_response_payed_at({
	})
end

return {
	cast = cast_withdraw_create_response_payed_at;
	new = new_withdraw_create_response_payed_at;
}
