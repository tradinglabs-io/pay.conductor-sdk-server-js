...
-- order_create_response_session class
local order_create_response_session = {}
local order_create_response_session_mt = {
	__name = "order_create_response_session";
	__index = order_create_response_session;
}

local function cast_order_create_response_session(t)
	return setmetatable(t, order_create_response_session_mt)
end

local function new_order_create_response_session(session_id)
	return cast_order_create_response_session({
		["sessionId"] = session_id;
	})
end

return {
	cast = cast_order_create_response_session;
	new = new_order_create_response_session;
}
