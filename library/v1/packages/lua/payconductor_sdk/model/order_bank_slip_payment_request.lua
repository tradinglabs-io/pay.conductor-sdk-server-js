...
-- order_bank_slip_payment_request class
local order_bank_slip_payment_request = {}
local order_bank_slip_payment_request_mt = {
	__name = "order_bank_slip_payment_request";
	__index = order_bank_slip_payment_request;
}

local function cast_order_bank_slip_payment_request(t)
	return setmetatable(t, order_bank_slip_payment_request_mt)
end

local function new_order_bank_slip_payment_request(payment_method, expiration_in_days)
	return cast_order_bank_slip_payment_request({
...
return {
	cast = cast_order_bank_slip_payment_request;
	new = new_order_bank_slip_payment_request;
}
