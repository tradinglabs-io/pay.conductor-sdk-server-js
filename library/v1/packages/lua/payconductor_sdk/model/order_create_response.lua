...
-- order_create_response class
local order_create_response = {}
local order_create_response_mt = {
	__name = "order_create_response";
	__index = order_create_response;
}

local function cast_order_create_response(t)
	return setmetatable(t, order_create_response_mt)
end

local function new_order_create_response(id, external_id, external_integration_key, external_integration_id, amount, cost_fee, pix, bank_slip, nu_pay, pic_pay, credit_card, status, payment_method, payed_at, error_code, error_message, order_items, session)
	return cast_order_create_response({
		["id"] = id;
...
return {
	cast = cast_order_create_response;
	new = new_order_create_response;
}
