...
-- order_bank_slip_info class
local order_bank_slip_info = {}
local order_bank_slip_info_mt = {
	__name = "order_bank_slip_info";
	__index = order_bank_slip_info;
}

local function cast_order_bank_slip_info(t)
	return setmetatable(t, order_bank_slip_info_mt)
end

local function new_order_bank_slip_info(bar_code, digitable_line, pdf_url)
	return cast_order_bank_slip_info({
		["barCode"] = bar_code;
...
return {
	cast = cast_order_bank_slip_info;
	new = new_order_bank_slip_info;
}
