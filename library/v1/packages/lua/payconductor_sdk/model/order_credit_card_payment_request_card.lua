...
-- order_credit_card_payment_request_card class
local order_credit_card_payment_request_card = {}
local order_credit_card_payment_request_card_mt = {
	__name = "order_credit_card_payment_request_card";
	__index = order_credit_card_payment_request_card;
}

local function cast_order_credit_card_payment_request_card(t)
	return setmetatable(t, order_credit_card_payment_request_card_mt)
end

local function new_order_credit_card_payment_request_card(first_six_card_number, token, cvv, expiration, holder_name, Number_)
	return cast_order_credit_card_payment_request_card({
...
return {
	cast = cast_order_credit_card_payment_request_card;
	new = new_order_credit_card_payment_request_card;
}
