...
-- card_tokenization_create_request class
local card_tokenization_create_request = {}
local card_tokenization_create_request_mt = {
	__name = "card_tokenization_create_request";
	__index = card_tokenization_create_request;
}

local function cast_card_tokenization_create_request(t)
	return setmetatable(t, card_tokenization_create_request_mt)
end

local function new_card_tokenization_create_request(card, save_card, customer)
	return cast_card_tokenization_create_request({
		["card"] = card;
		["saveCard"] = save_card;
		["customer"] = customer;
	})
...
return {
	cast = cast_card_tokenization_create_request;
	new = new_card_tokenization_create_request;
}
