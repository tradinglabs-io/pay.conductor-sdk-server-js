...
-- order_payment_request class
local order_payment_request = {}
local order_payment_request_mt = {
	__name = "order_payment_request";
	__index = order_payment_request;
}

local function cast_order_payment_request(t)
	return setmetatable(t, order_payment_request_mt)
end

local function new_order_payment_request(payment_method, expiration_in_seconds, card, installments, soft_descriptor, expiration_in_days, nu_pay, available_payment_methods)
	return cast_order_payment_request({
...
return {
	cast = cast_order_payment_request;
	new = new_order_payment_request;
}
