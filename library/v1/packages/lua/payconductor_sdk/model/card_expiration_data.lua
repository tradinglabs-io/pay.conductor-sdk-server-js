...
-- card_expiration_data class
local card_expiration_data = {}
local card_expiration_data_mt = {
	__name = "card_expiration_data";
	__index = card_expiration_data;
}

local function cast_card_expiration_data(t)
	return setmetatable(t, card_expiration_data_mt)
end

local function new_card_expiration_data(month, year)
	return cast_card_expiration_data({
		["month"] = month;
		["year"] = year;
	})
end
...
return {
	cast = cast_card_expiration_data;
	new = new_card_expiration_data;
}
