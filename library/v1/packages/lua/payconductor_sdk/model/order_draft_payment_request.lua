...
-- order_draft_payment_request class
local order_draft_payment_request = {}
local order_draft_payment_request_mt = {
	__name = "order_draft_payment_request";
	__index = order_draft_payment_request;
}

local function cast_order_draft_payment_request(t)
	return setmetatable(t, order_draft_payment_request_mt)
end

local function new_order_draft_payment_request(payment_method, expiration_in_seconds, available_payment_methods)
	return cast_order_draft_payment_request({
...
return {
	cast = cast_order_draft_payment_request;
	new = new_order_draft_payment_request;
}
