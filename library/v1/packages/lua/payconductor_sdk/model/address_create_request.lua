...
-- address_create_request class
local address_create_request = {}
local address_create_request_mt = {
	__name = "address_create_request";
	__index = address_create_request;
}

local function cast_address_create_request(t)
	return setmetatable(t, address_create_request_mt)
end

local function new_address_create_request(city, country, neighborhood, Number_, state, street, zip_code)
	return cast_address_create_request({
		["city"] = city;
		["country"] = country;
...
return {
	cast = cast_address_create_request;
	new = new_address_create_request;
}
