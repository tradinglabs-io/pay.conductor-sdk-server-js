...
-- order_create_request_session class
local order_create_request_session = {}
local order_create_request_session_mt = {
	__name = "order_create_request_session";
	__index = order_create_request_session;
}

local function cast_order_create_request_session(t)
	return setmetatable(t, order_create_request_session_mt)
end

local function new_order_create_request_session(expires_in_minutes, checkout_url, session_id, external_session_id)
	return cast_order_create_request_session({
...
return {
	cast = cast_order_create_request_session;
	new = new_order_create_request_session;
}
