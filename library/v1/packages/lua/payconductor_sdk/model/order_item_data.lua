...
-- order_item_data class
local order_item_data = {}
local order_item_data_mt = {
	__name = "order_item_data";
	__index = order_item_data;
}

local function cast_order_item_data(t)
	return setmetatable(t, order_item_data_mt)
end

local function new_order_item_data(id, is_physical, name, qty, unit_price)
	return cast_order_item_data({
		["id"] = id;
...
return {
	cast = cast_order_item_data;
	new = new_order_item_data;
}
