...
-- order_credit_card_info class
local order_credit_card_info = {}
local order_credit_card_info_mt = {
	__name = "order_credit_card_info";
	__index = order_credit_card_info;
}

local function cast_order_credit_card_info(t)
	return setmetatable(t, order_credit_card_info_mt)
end

local function new_order_credit_card_info(authorization_code)
	return cast_order_credit_card_info({
		["authorizationCode"] = authorization_code;
	})
end

return {
	cast = cast_order_credit_card_info;
	new = new_order_credit_card_info;
}
