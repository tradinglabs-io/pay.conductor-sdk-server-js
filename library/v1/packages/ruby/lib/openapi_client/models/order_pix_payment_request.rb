...
module OpenapiClient
  class OrderPIXPaymentRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::OrderPIXPaymentRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::OrderPIXPaymentRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'expiration_in_seconds')
        ...
        self.expiration_in_seconds = 3600
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@expiration_in_seconds.nil? && @expiration_in_seconds < 3600
        invalid_properties.push('invalid value for "expiration_in_seconds", must be greater than or equal to 3600.')
      end
    ...
    def valid?
      ...
      return false if !@expiration_in_seconds.nil? && @expiration_in_seconds < 3600
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] expiration_in_seconds Value to be assigned
    def expiration_in_seconds=(expiration_in_seconds)
      if expiration_in_seconds.nil?
        fail ArgumentError, 'expiration_in_seconds cannot be nil'
      end

      if expiration_in_seconds < 3600
        fail ArgumentError, 'invalid value for "expiration_in_seconds", must be greater than or equal to 3600.'
      end
