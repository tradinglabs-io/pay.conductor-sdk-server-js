...
module OpenapiClient
  class OrderBankSlipPaymentRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::OrderBankSlipPaymentRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::OrderBankSlipPaymentRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@expiration_in_days.nil? && @expiration_in_days < 1
        invalid_properties.push('invalid value for "expiration_in_days", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@expiration_in_days.nil? && @expiration_in_days < 1
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] expiration_in_days Value to be assigned
    def expiration_in_days=(expiration_in_days)
      if expiration_in_days.nil?
        fail ArgumentError, 'expiration_in_days cannot be nil'
      end

      if expiration_in_days < 1
        fail ArgumentError, 'invalid value for "expiration_in_days", must be greater than or equal to 1.'
      end
