...
# Unit tests for OpenapiClient::CustomerCreateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CustomerCreateRequest do
  #let(:instance) { OpenapiClient::CustomerCreateRequest.new }

  describe 'test an instance of CustomerCreateRequest' do
    it 'should create an instance of CustomerCreateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CustomerCreateRequest)
    end
  end
