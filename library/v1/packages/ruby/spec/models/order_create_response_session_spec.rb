...
# Unit tests for OpenapiClient::OrderCreateResponseSession
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrderCreateResponseSession do
  #let(:instance) { OpenapiClient::OrderCreateResponseSession.new }

  describe 'test an instance of OrderCreateResponseSession' do
    it 'should create an instance of OrderCreateResponseSession' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OrderCreateResponseSession)
    end
  end
