...
# Unit tests for OpenapiClient::CustomerReadResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CustomerReadResponse do
  #let(:instance) { OpenapiClient::CustomerReadResponse.new }

  describe 'test an instance of CustomerReadResponse' do
    it 'should create an instance of CustomerReadResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CustomerReadResponse)
    end
  end
