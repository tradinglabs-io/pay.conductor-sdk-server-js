...
# Unit tests for OpenapiClient::OrderItemData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrderItemData do
  #let(:instance) { OpenapiClient::OrderItemData.new }

  describe 'test an instance of OrderItemData' do
    it 'should create an instance of OrderItemData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OrderItemData)
    end
  end
