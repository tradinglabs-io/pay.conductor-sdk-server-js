...
# Unit tests for OpenapiClient::OrderDraftPaymentRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrderDraftPaymentRequest do
  #let(:instance) { OpenapiClient::OrderDraftPaymentRequest.new }

  describe 'test an instance of OrderDraftPaymentRequest' do
    it 'should create an instance of OrderDraftPaymentRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OrderDraftPaymentRequest)
    end
  end
