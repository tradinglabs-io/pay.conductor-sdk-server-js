...
# Unit tests for OpenapiClient::OrderCreateResponseOrderItemsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrderCreateResponseOrderItemsInner do
  #let(:instance) { OpenapiClient::OrderCreateResponseOrderItemsInner.new }

  describe 'test an instance of OrderCreateResponseOrderItemsInner' do
    it 'should create an instance of OrderCreateResponseOrderItemsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OrderCreateResponseOrderItemsInner)
    end
  end
