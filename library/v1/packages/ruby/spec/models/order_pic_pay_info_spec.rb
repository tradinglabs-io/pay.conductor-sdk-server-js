...
# Unit tests for OpenapiClient::OrderPicPayInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrderPicPayInfo do
  #let(:instance) { OpenapiClient::OrderPicPayInfo.new }

  describe 'test an instance of OrderPicPayInfo' do
    it 'should create an instance of OrderPicPayInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OrderPicPayInfo)
    end
  end
