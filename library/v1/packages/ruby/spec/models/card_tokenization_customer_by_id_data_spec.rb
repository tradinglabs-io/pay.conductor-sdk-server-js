...
# Unit tests for OpenapiClient::CardTokenizationCustomerByIdData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CardTokenizationCustomerByIdData do
  #let(:instance) { OpenapiClient::CardTokenizationCustomerByIdData.new }

  describe 'test an instance of CardTokenizationCustomerByIdData' do
    it 'should create an instance of CardTokenizationCustomerByIdData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CardTokenizationCustomerByIdData)
    end
  end
