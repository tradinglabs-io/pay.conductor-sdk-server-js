...
# Unit tests for OpenapiClient::AddressCreateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AddressCreateRequest do
  #let(:instance) { OpenapiClient::AddressCreateRequest.new }

  describe 'test an instance of AddressCreateRequest' do
    it 'should create an instance of AddressCreateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AddressCreateRequest)
    end
  end
