...
# Unit tests for OpenapiClient::CardTokenizationCreateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CardTokenizationCreateRequest do
  #let(:instance) { OpenapiClient::CardTokenizationCreateRequest.new }

  describe 'test an instance of CardTokenizationCreateRequest' do
    it 'should create an instance of CardTokenizationCreateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CardTokenizationCreateRequest)
    end
  end
  ...
  describe 'test attribute "save_card"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
