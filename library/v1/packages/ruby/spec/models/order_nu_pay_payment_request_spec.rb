...
# Unit tests for OpenapiClient::OrderNuPayPaymentRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrderNuPayPaymentRequest do
  #let(:instance) { OpenapiClient::OrderNuPayPaymentRequest.new }

  describe 'test an instance of OrderNuPayPaymentRequest' do
    it 'should create an instance of OrderNuPayPaymentRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OrderNuPayPaymentRequest)
    end
  end
