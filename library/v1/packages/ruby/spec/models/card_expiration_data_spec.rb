...
# Unit tests for OpenapiClient::CardExpirationData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CardExpirationData do
  #let(:instance) { OpenapiClient::CardExpirationData.new }

  describe 'test an instance of CardExpirationData' do
    it 'should create an instance of CardExpirationData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CardExpirationData)
    end
  end
