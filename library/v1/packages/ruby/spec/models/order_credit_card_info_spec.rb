...
# Unit tests for OpenapiClient::OrderCreditCardInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrderCreditCardInfo do
  #let(:instance) { OpenapiClient::OrderCreditCardInfo.new }

  describe 'test an instance of OrderCreditCardInfo' do
    it 'should create an instance of OrderCreditCardInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OrderCreditCardInfo)
    end
  end
