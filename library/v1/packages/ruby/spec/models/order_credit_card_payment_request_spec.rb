...
# Unit tests for OpenapiClient::OrderCreditCardPaymentRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrderCreditCardPaymentRequest do
  #let(:instance) { OpenapiClient::OrderCreditCardPaymentRequest.new }

  describe 'test an instance of OrderCreditCardPaymentRequest' do
    it 'should create an instance of OrderCreditCardPaymentRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OrderCreditCardPaymentRequest)
    end
  end
