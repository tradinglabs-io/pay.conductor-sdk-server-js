...
# Unit tests for OpenapiClient::OrderNuPayInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrderNuPayInfo do
  #let(:instance) { OpenapiClient::OrderNuPayInfo.new }

  describe 'test an instance of OrderNuPayInfo' do
    it 'should create an instance of OrderNuPayInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OrderNuPayInfo)
    end
  end
