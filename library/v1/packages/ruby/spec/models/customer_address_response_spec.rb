...
# Unit tests for OpenapiClient::CustomerAddressResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CustomerAddressResponse do
  #let(:instance) { OpenapiClient::CustomerAddressResponse.new }

  describe 'test an instance of CustomerAddressResponse' do
    it 'should create an instance of CustomerAddressResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CustomerAddressResponse)
    end
  end
