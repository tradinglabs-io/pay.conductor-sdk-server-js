...
# Unit tests for OpenapiClient::OrderPicPayPaymentRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrderPicPayPaymentRequest do
  #let(:instance) { OpenapiClient::OrderPicPayPaymentRequest.new }

  describe 'test an instance of OrderPicPayPaymentRequest' do
    it 'should create an instance of OrderPicPayPaymentRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OrderPicPayPaymentRequest)
    end
  end
