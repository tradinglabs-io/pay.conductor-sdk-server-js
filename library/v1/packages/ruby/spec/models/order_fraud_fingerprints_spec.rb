...
# Unit tests for OpenapiClient::OrderFraudFingerprints
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrderFraudFingerprints do
  #let(:instance) { OpenapiClient::OrderFraudFingerprints.new }

  describe 'test an instance of OrderFraudFingerprints' do
    it 'should create an instance of OrderFraudFingerprints' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OrderFraudFingerprints)
    end
  end
