...
# Unit tests for OpenapiClient::CustomerUpdateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CustomerUpdateRequest do
  #let(:instance) { OpenapiClient::CustomerUpdateRequest.new }

  describe 'test an instance of CustomerUpdateRequest' do
    it 'should create an instance of CustomerUpdateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CustomerUpdateRequest)
    end
  end
