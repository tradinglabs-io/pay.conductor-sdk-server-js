...
# Unit tests for OpenapiClient::OrderTokenizedCardData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrderTokenizedCardData do
  #let(:instance) { OpenapiClient::OrderTokenizedCardData.new }

  describe 'test an instance of OrderTokenizedCardData' do
    it 'should create an instance of OrderTokenizedCardData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OrderTokenizedCardData)
    end
  end
