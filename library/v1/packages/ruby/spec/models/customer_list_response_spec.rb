...
# Unit tests for OpenapiClient::CustomerListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CustomerListResponse do
  #let(:instance) { OpenapiClient::CustomerListResponse.new }

  describe 'test an instance of CustomerListResponse' do
    it 'should create an instance of CustomerListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CustomerListResponse)
    end
  end
