...
# Unit tests for OpenapiClient::CustomerListPagination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CustomerListPagination do
  #let(:instance) { OpenapiClient::CustomerListPagination.new }

  describe 'test an instance of CustomerListPagination' do
    it 'should create an instance of CustomerListPagination' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CustomerListPagination)
    end
  end
