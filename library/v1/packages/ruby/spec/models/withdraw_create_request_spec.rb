...
# Unit tests for OpenapiClient::WithdrawCreateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WithdrawCreateRequest do
  #let(:instance) { OpenapiClient::WithdrawCreateRequest.new }

  describe 'test an instance of WithdrawCreateRequest' do
    it 'should create an instance of WithdrawCreateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::WithdrawCreateRequest)
    end
  end
