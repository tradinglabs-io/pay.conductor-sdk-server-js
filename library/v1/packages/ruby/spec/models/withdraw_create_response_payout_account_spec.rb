...
# Unit tests for OpenapiClient::WithdrawCreateResponsePayoutAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WithdrawCreateResponsePayoutAccount do
  #let(:instance) { OpenapiClient::WithdrawCreateResponsePayoutAccount.new }

  describe 'test an instance of WithdrawCreateResponsePayoutAccount' do
    it 'should create an instance of WithdrawCreateResponsePayoutAccount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::WithdrawCreateResponsePayoutAccount)
    end
  end
