...
# Unit tests for OpenapiClient::OrderBankSlipInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrderBankSlipInfo do
  #let(:instance) { OpenapiClient::OrderBankSlipInfo.new }

  describe 'test an instance of OrderBankSlipInfo' do
    it 'should create an instance of OrderBankSlipInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OrderBankSlipInfo)
    end
  end
