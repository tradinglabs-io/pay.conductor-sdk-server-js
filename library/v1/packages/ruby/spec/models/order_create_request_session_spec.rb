...
# Unit tests for OpenapiClient::OrderCreateRequestSession
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrderCreateRequestSession do
  #let(:instance) { OpenapiClient::OrderCreateRequestSession.new }

  describe 'test an instance of OrderCreateRequestSession' do
    it 'should create an instance of OrderCreateRequestSession' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OrderCreateRequestSession)
    end
  end

  describe 'test attribute "expires_in_minutes"' do
    it 'should work' do
  ...
  describe 'test attribute "external_session_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
