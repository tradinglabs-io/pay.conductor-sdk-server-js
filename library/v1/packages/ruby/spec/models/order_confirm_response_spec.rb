...
# Unit tests for OpenapiClient::OrderConfirmResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrderConfirmResponse do
  #let(:instance) { OpenapiClient::OrderConfirmResponse.new }

  describe 'test an instance of OrderConfirmResponse' do
    it 'should create an instance of OrderConfirmResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OrderConfirmResponse)
    end
  end
