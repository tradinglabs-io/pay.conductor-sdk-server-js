...
# Unit tests for OpenapiClient::CardCreateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CardCreateRequest do
  #let(:instance) { OpenapiClient::CardCreateRequest.new }

  describe 'test an instance of CardCreateRequest' do
    it 'should create an instance of CardCreateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CardCreateRequest)
    end
  end
