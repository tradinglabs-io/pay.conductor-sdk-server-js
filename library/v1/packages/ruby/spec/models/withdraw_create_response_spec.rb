...
# Unit tests for OpenapiClient::WithdrawCreateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WithdrawCreateResponse do
  #let(:instance) { OpenapiClient::WithdrawCreateResponse.new }

  describe 'test an instance of WithdrawCreateResponse' do
    it 'should create an instance of WithdrawCreateResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::WithdrawCreateResponse)
    end
  end
