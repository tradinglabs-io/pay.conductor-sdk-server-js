...
# Unit tests for OpenapiClient::OrderPIXInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrderPIXInfo do
  #let(:instance) { OpenapiClient::OrderPIXInfo.new }

  describe 'test an instance of OrderPIXInfo' do
    it 'should create an instance of OrderPIXInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OrderPIXInfo)
    end
  end
