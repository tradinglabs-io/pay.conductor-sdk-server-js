...
# Unit tests for OpenapiClient::OrderBankSlipPaymentRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrderBankSlipPaymentRequest do
  #let(:instance) { OpenapiClient::OrderBankSlipPaymentRequest.new }

  describe 'test an instance of OrderBankSlipPaymentRequest' do
    it 'should create an instance of OrderBankSlipPaymentRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OrderBankSlipPaymentRequest)
    end
  end
  ...
  describe 'test attribute "expiration_in_days"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
