...
# Unit tests for OpenapiClient::WithdrawPayoutAccountData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WithdrawPayoutAccountData do
  #let(:instance) { OpenapiClient::WithdrawPayoutAccountData.new }

  describe 'test an instance of WithdrawPayoutAccountData' do
    it 'should create an instance of WithdrawPayoutAccountData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::WithdrawPayoutAccountData)
    end
  end
