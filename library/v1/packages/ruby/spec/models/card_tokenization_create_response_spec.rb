...
# Unit tests for OpenapiClient::CardTokenizationCreateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CardTokenizationCreateResponse do
  #let(:instance) { OpenapiClient::CardTokenizationCreateResponse.new }

  describe 'test an instance of CardTokenizationCreateResponse' do
    it 'should create an instance of CardTokenizationCreateResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CardTokenizationCreateResponse)
    end
  end
