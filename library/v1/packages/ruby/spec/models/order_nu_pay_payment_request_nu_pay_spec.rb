...
# Unit tests for OpenapiClient::OrderNuPayPaymentRequestNuPay
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrderNuPayPaymentRequestNuPay do
  #let(:instance) { OpenapiClient::OrderNuPayPaymentRequestNuPay.new }

  describe 'test an instance of OrderNuPayPaymentRequestNuPay' do
    it 'should create an instance of OrderNuPayPaymentRequestNuPay' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OrderNuPayPaymentRequestNuPay)
    end
  end
