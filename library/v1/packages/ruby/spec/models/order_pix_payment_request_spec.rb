...
# Unit tests for OpenapiClient::OrderPIXPaymentRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrderPIXPaymentRequest do
  #let(:instance) { OpenapiClient::OrderPIXPaymentRequest.new }

  describe 'test an instance of OrderPIXPaymentRequest' do
    it 'should create an instance of OrderPIXPaymentRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OrderPIXPaymentRequest)
    end
  end
