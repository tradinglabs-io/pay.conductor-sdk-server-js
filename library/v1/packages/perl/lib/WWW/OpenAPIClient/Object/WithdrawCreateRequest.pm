...
#
package WWW::OpenAPIClient::Object::WithdrawCreateRequest;
...
__PACKAGE__->class_documentation({description => 'Withdrawal or transfer request data',
...
__PACKAGE__->method_documentation({
    ...
    'payout_account' => {
        datatype => 'WithdrawPayoutAccountData',
