...
#
package WWW::OpenAPIClient::Object::WithdrawCreateResponse;
...
__PACKAGE__->class_documentation({description => 'Response after creating a withdrawal or transfer',
...
__PACKAGE__->method_documentation({
    ...
    'payed_at' => {
        datatype => 'WithdrawCreateResponsePayedAt',
        base_name => 'payedAt',
        description => '',
        format => '',
        read_only => '',
    ...
    'payout_account' => {
        datatype => 'WithdrawCreateResponsePayoutAccount',
