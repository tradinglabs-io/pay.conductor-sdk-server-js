...
#
package WWW::OpenAPIClient::Object::OrderPaymentRequest;
...
__PACKAGE__->method_documentation({
    ...
    'card' => {
        datatype => 'OrderCreditCardPaymentRequestCard',
        base_name => 'card',
        description => '',
        format => '',
        read_only => '',
    ...
    'nu_pay' => {
        datatype => 'OrderNuPayPaymentRequestNuPay',
        base_name => 'nuPay',
        description => '',
        format => '',
        read_only => '',
