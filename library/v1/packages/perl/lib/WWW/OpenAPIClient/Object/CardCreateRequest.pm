...
#
package WWW::OpenAPIClient::Object::CardCreateRequest;
...
__PACKAGE__->class_documentation({description => 'Complete card data for payment processing',
