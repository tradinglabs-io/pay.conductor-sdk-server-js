...
#
package WWW::OpenAPIClient::Object::CustomerUpdateRequest;
...
__PACKAGE__->class_documentation({description => 'Schema for updating customer information',
