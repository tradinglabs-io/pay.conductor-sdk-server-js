...
#
package WWW::OpenAPIClient::Object::OrderCreateRequest;
...
__PACKAGE__->class_documentation({description => 'Order data for payment processing',
...
__PACKAGE__->method_documentation({
    ...
    'customer' => {
        datatype => 'CustomerCreateRequest',
        base_name => 'customer',
        description => '',
        format => '',
        read_only => '',
    ...
    'fingerprints' => {
        datatype => 'OrderFraudFingerprints',
    ...
    'session' => {
        datatype => 'OrderCreateRequestSession',
        base_name => 'session',
        description => '',
        format => '',
        read_only => '',
