...
#
package WWW::OpenAPIClient::Object::CardTokenizationCreateResponse;
...
__PACKAGE__->class_documentation({description => 'Response containing customer ID and card token',
