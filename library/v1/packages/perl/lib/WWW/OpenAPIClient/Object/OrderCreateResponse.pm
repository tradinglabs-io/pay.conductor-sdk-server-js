...
#
package WWW::OpenAPIClient::Object::OrderCreateResponse;
...
__PACKAGE__->class_documentation({description => 'Response after creating an order',
...
__PACKAGE__->method_documentation({
    ...
    'order_items' => {
        datatype => 'ARRAY[OrderCreateResponseOrderItemsInner]',
    ...
    'session' => {
        datatype => 'OrderCreateResponseSession',
        base_name => 'session',
        description => '',
        format => '',
        read_only => '',
