...
#
package WWW::OpenAPIClient::Object::CardTokenizationCreateRequest;
...
__PACKAGE__->class_documentation({description => 'Data for creating a customer card with customer information',
...
__PACKAGE__->method_documentation({
    ...
    'customer' => {
        datatype => 'CardTokenizationCreateRequestCustomer',
        base_name => 'customer',
        description => '',
        format => '',
        read_only => '',
