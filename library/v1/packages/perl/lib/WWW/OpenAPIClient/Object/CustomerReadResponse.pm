...
#
package WWW::OpenAPIClient::Object::CustomerReadResponse;
...
__PACKAGE__->class_documentation({description => 'Customer response with complete information',
...
__PACKAGE__->method_documentation({
    ...
    'address' => {
        datatype => 'CustomerAddressResponse',
        base_name => 'address',
        description => '',
        format => '',
        read_only => '',
