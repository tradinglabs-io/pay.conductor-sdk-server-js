...
#
package WWW::OpenAPIClient::Object::CustomerListResponse;
...
__PACKAGE__->class_documentation({description => 'Paginated list of customers',
...
__PACKAGE__->method_documentation({
    'data' => {
        datatype => 'ARRAY[CustomerReadResponse]',
        base_name => 'data',
    ...
    'pagination' => {
        datatype => 'CustomerListPagination',
