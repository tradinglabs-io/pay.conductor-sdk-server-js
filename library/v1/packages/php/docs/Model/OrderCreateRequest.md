...
**customer** | [**\OpenAPI\Client\Model\CustomerCreateRequest**](CustomerCreateRequest.md) |  |
**discount_amount** | **float** | Discount amount | [default to 0]
**external_id** | **string** | Order ID in your system |
**fingerprints** | [**\OpenAPI\Client\Model\OrderFraudFingerprints**](OrderFraudFingerprints.md) |  | [optional]
**items** | [**\OpenAPI\Client\Model\OrderItemData[]**](OrderItemData.md) | List of products or services in the order | [optional]
**merchant** | [**\OpenAPI\Client\Model\MerchantInput**](MerchantInput.md) |  | [optional]
**payment** | [**\OpenAPI\Client\Model\OrderPaymentRequest**](OrderPaymentRequest.md) |  |
...
**session** | [**\OpenAPI\Client\Model\OrderCreateRequestSession**](OrderCreateRequestSession.md) |  | [optional]
