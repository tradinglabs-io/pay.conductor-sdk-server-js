...
/**
 * CardTokenizationCreateResponse Class Doc Comment
 *
 * @category Class
 * @description Response containing customer ID and card token
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CardTokenizationCreateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Card_Tokenization_Create_Response';
    ...
    */
     ...
     * Sets customer_id
     *
     * @param string $customer_id ID of the customer associated with the created card
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string $token Token of the created card for future transactions
     *
     * @return self
     */
