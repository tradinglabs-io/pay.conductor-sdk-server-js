...
/**
 * OrderPIXInfo Class Doc Comment
 *
 * @category Class
 * @description PIX payment data and QR code information
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrderPIXInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Order_PIX_Info';
    ...
    protected static $attributeMap = [
        'copy_and_paste_code' => 'copyAndPasteCode',
    ...
    protected static $setters = [
        'copy_and_paste_code' => 'setCopyAndPasteCode',
    ...
    protected static $getters = [
        'copy_and_paste_code' => 'getCopyAndPasteCode',
    ...
    {
        $this->setIfExists('copy_and_paste_code', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['copy_and_paste_code'] === null) {
            $invalidProperties[] = "'copy_and_paste_code' can't be null";
        }
        if ($this->container['qr_code_url'] === null) {
            $invalidProperties[] = "'qr_code_url' can't be null";
        }
        if ($this->container['end_to_end_id'] === null && !$this->isNullableSetToNull('end_to_end_id')) {
    ...
    /**
     * Gets copy_and_paste_code
     *
     * @return string
     */
    public function getCopyAndPasteCode()
    {
        return $this->container['copy_and_paste_code'];
    }

    /**
     * Sets copy_and_paste_code
     *
     * @param string $copy_and_paste_code PIX copy and paste code
     *
     * @return self
     */
    public function setCopyAndPasteCode($copy_and_paste_code)
    {
        if (is_null($copy_and_paste_code)) {
            throw new \InvalidArgumentException('non-nullable copy_and_paste_code cannot be null');
        }
        $this->container['copy_and_paste_code'] = $copy_and_paste_code;
     ...
     * Sets qr_code_url
     *
     * @param string $qr_code_url PIX QR Code image URL
     *
     * @return self
     */
     ...
     * Sets end_to_end_id
     *
     * @param string|null $end_to_end_id PIX E2E ID
     *
     * @return self
     */
