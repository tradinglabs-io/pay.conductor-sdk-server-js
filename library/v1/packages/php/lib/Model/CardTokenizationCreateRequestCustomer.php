...
/**
 * CardTokenizationCreateRequestCustomer Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CardTokenizationCreateRequestCustomer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Card_Tokenization_Create_Request_customer';
    ...
    protected static $openAPITypes = [
        'address' => '\OpenAPI\Client\Model\AddressCreateRequest',
    ...
    */
     ...
     * Gets address
     *
     * @return \OpenAPI\Client\Model\AddressCreateRequest|null
     */
     ...
     * Sets address
     *
     * @param \OpenAPI\Client\Model\AddressCreateRequest|null $address address
     *
     * @return self
     */
    ...
    public function setDocumentNumber($document_number)
    {
        ...
        if ((!preg_match("/^\\d{11}$|^\\d{14}$/", ObjectSerializer::toString($document_number)))) {
            throw new \InvalidArgumentException("invalid value for \$document_number when calling CardTokenizationCreateRequestCustomer., must conform to the pattern /^\\d{11}$|^\\d{14}$/.");
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if ((!preg_match("/^\\+(\\d{1,2}) (\\d{2}) (\\d{8,9})$/", ObjectSerializer::toString($phone_number)))) {
            throw new \InvalidArgumentException("invalid value for \$phone_number when calling CardTokenizationCreateRequestCustomer., must conform to the pattern /^\\+(\\d{1,2}) (\\d{2}) (\\d{8,9})$/.");
        }
     ...
     * Sets id
     *
     * @param string $id ID of an existing customer
     *
     * @return self
     */
