...
/**
 * CardExpirationData Class Doc Comment
 *
 * @category Class
 ...
 */
class CardExpirationData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Card_Expiration_Data';
    ...
    */
    ...
    public function setMonth($month)
    {
        ...
        if (($month > 12)) {
            throw new \InvalidArgumentException('invalid value for $month when calling CardExpirationData., must be smaller than or equal to 12.');
        }
        if (($month < 1)) {
            throw new \InvalidArgumentException('invalid value for $month when calling CardExpirationData., must be bigger than or equal to 1.');
        }
    ...
    public function setYear($year)
    {
        ...
        if (($year > 2046)) {
            throw new \InvalidArgumentException('invalid value for $year when calling CardExpirationData., must be smaller than or equal to 2046.');
        }
        if (($year < 2025)) {
            throw new \InvalidArgumentException('invalid value for $year when calling CardExpirationData., must be bigger than or equal to 2025.');
        }
