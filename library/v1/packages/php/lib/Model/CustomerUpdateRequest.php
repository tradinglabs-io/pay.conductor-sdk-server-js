...
class CustomerUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Customer_Update_Request';
    ...
    */
    ...
    public function setDocumentNumber($document_number)
    {
        ...
        if ((!preg_match("/^\\d{11}$|^\\d{14}$/", ObjectSerializer::toString($document_number)))) {
            throw new \InvalidArgumentException("invalid value for \$document_number when calling CustomerUpdateRequest., must conform to the pattern /^\\d{11}$|^\\d{14}$/.");
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if ((!preg_match("/^\\+(\\d{1,2}) (\\d{2}) (\\d{8,9})$/", ObjectSerializer::toString($phone_number)))) {
            throw new \InvalidArgumentException("invalid value for \$phone_number when calling CustomerUpdateRequest., must conform to the pattern /^\\+(\\d{1,2}) (\\d{2}) (\\d{8,9})$/.");
        }
