...
/**
 * OrderItemData Class Doc Comment
 *
 * @category Class
 * @description Product or service item in the order
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrderItemData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Order_Item_Data';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Product or service ID in your system
     *
     * @return self
     */
     ...
     * Sets is_physical
     *
     * @param bool $is_physical Defines if the item is a physical product or a service
     *
     * @return self
     */
     ...
     * Sets qty
     *
     * @param float $qty Quantity of the product or service
     *
     * @return self
     */
