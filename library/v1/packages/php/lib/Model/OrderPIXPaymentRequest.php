...
/**
 * OrderPIXPaymentRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrderPIXPaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderPIXPaymentRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['expiration_in_seconds']) && ($this->container['expiration_in_seconds'] < 3600)) {
            $invalidProperties[] = "invalid value for 'expiration_in_seconds', must be bigger than or equal to 3600.";
        }
     ...
     *
     * @param float|null $expiration_in_seconds PIX expiration time in seconds
     *
     * @return self
     */
    public function setExpirationInSeconds($expiration_in_seconds)
    {
        ...
        if (($expiration_in_seconds < 3600)) {
            throw new \InvalidArgumentException('invalid value for $expiration_in_seconds when calling OrderPIXPaymentRequest., must be bigger than or equal to 3600.');
        }
