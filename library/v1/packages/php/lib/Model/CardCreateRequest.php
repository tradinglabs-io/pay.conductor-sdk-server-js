 ...
 *
 * @category Class
 * @description Complete card data for payment processing
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class CardCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Card_Create_Request';
    ...
    */
    ...
    public function setCvv($cvv)
    {
        ...
        if ((mb_strlen($cvv) > 4)) {
            throw new \InvalidArgumentException('invalid length for $cvv when calling CardCreateRequest., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($cvv) < 3)) {
            throw new \InvalidArgumentException('invalid length for $cvv when calling CardCreateRequest., must be bigger than or equal to 3.');
        }
