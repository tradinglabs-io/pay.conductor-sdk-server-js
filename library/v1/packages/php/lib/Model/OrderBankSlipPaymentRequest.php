...
/**
 * OrderBankSlipPaymentRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrderBankSlipPaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderBankSlipPaymentRequest';
    ...
    */
    ...
    public function setExpirationInDays($expiration_in_days)
    {
        ...
        if (($expiration_in_days < 1)) {
            throw new \InvalidArgumentException('invalid value for $expiration_in_days when calling OrderBankSlipPaymentRequest., must be bigger than or equal to 1.');
        }
