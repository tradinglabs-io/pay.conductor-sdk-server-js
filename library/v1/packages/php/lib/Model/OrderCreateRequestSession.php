...
/**
 * OrderCreateRequestSession Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderCreateRequestSession implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Order_Create_Request_session';
    ...
    */
    ...
    public function setExpiresInMinutes($expires_in_minutes)
    {
        ...
        if (($expires_in_minutes < 15)) {
            throw new \InvalidArgumentException('invalid value for $expires_in_minutes when calling OrderCreateRequestSession., must be bigger than or equal to 15.');
        }
    ...
    public function setExternalSessionId($external_session_id)
    {
        ...
        if ((mb_strlen($external_session_id) < 16)) {
            throw new \InvalidArgumentException('invalid length for $external_session_id when calling OrderCreateRequestSession., must be bigger than or equal to 16.');
        }
