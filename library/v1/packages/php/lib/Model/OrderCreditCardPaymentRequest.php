 ...
 */
class OrderCreditCardPaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderCreditCardPaymentRequest';
    ...
    */
    ...
    public function setInstallments($installments)
    {
        ...
        if (($installments > 12)) {
            throw new \InvalidArgumentException('invalid value for $installments when calling OrderCreditCardPaymentRequest., must be smaller than or equal to 12.');
        }
        if (($installments < 1)) {
            throw new \InvalidArgumentException('invalid value for $installments when calling OrderCreditCardPaymentRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSoftDescriptor($soft_descriptor)
    {
        ...
        if ((mb_strlen($soft_descriptor) > 22)) {
            throw new \InvalidArgumentException('invalid length for $soft_descriptor when calling OrderCreditCardPaymentRequest., must be smaller than or equal to 22.');
        }
        if ((mb_strlen($soft_descriptor) < 1)) {
            throw new \InvalidArgumentException('invalid length for $soft_descriptor when calling OrderCreditCardPaymentRequest., must be bigger than or equal to 1.');
        }
