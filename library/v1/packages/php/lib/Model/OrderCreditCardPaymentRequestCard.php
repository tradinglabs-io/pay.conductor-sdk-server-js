...
/**
 * OrderCreditCardPaymentRequestCard Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrderCreditCardPaymentRequestCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderCreditCardPaymentRequest_card';
    ...
    protected static $openAPITypes = [
        ...
        'token' => 'string',
        'cvv' => 'string',
        'expiration' => '\OpenAPI\Client\Model\CardExpirationData',
        'holder_name' => 'string',
        'number' => 'string'
    ];
    ...
    */
    ...
    public function setCvv($cvv)
    {
        ...
        if ((mb_strlen($cvv) > 4)) {
            throw new \InvalidArgumentException('invalid length for $cvv when calling OrderCreditCardPaymentRequestCard., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($cvv) < 3)) {
            throw new \InvalidArgumentException('invalid length for $cvv when calling OrderCreditCardPaymentRequestCard., must be bigger than or equal to 3.');
        }
     ...
     * Gets expiration
     *
     * @return \OpenAPI\Client\Model\CardExpirationData
     */
     ...
     * Sets expiration
     *
     * @param \OpenAPI\Client\Model\CardExpirationData $expiration expiration
     *
     * @return self
     */
