...
/**
 * WithdrawCreateResponsePayoutAccount Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WithdrawCreateResponsePayoutAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Withdraw_Create_Response_payoutAccount';
    ...
    */
    ...
    public function setOwnerDocument($owner_document)
    {
        ...
        if ((!preg_match("/^\\d{11}$|^\\d{14}$/", ObjectSerializer::toString($owner_document)))) {
            throw new \InvalidArgumentException("invalid value for \$owner_document when calling WithdrawCreateResponsePayoutAccount., must conform to the pattern /^\\d{11}$|^\\d{14}$/.");
        }
