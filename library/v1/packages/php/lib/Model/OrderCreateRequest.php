...
class OrderCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Order_Create_Request';
    ...
    protected static $openAPITypes = [
        'charge_amount' => 'float',
        'client_ip' => 'string',
        'customer' => '\OpenAPI\Client\Model\CustomerCreateRequest',
        'discount_amount' => 'float',
        'external_id' => 'string',
        'fingerprints' => '\OpenAPI\Client\Model\OrderFraudFingerprints',
        'items' => '\OpenAPI\Client\Model\OrderItemData[]',
        'merchant' => '\OpenAPI\Client\Model\MerchantInput',
        'payment' => '\OpenAPI\Client\Model\OrderPaymentRequest',
        'split_amount_total' => 'float',
        'session' => '\OpenAPI\Client\Model\OrderCreateRequestSession',
        'shipping_fee' => 'float',
        'tax_fee' => 'float',
        'metadata' => 'object'
    ];
    ...
    */
     ...
     * Gets customer
     *
     * @return \OpenAPI\Client\Model\CustomerCreateRequest
     */
     ...
     * Sets customer
     *
     * @param \OpenAPI\Client\Model\CustomerCreateRequest $customer customer
     *
     * @return self
     */
     ...
     * Gets fingerprints
     *
     * @return \OpenAPI\Client\Model\OrderFraudFingerprints|null
     */
     ...
     * Sets fingerprints
     *
     * @param \OpenAPI\Client\Model\OrderFraudFingerprints|null $fingerprints fingerprints
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\OrderItemData[]|null
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\OrderItemData[]|null $items List of products or services in the order
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if ((count($items) > 20)) {
            throw new \InvalidArgumentException('invalid value for $items when calling OrderCreateRequest., number of items must be less than or equal to 20.');
        }
     ...
     * Gets payment
     *
     * @return \OpenAPI\Client\Model\OrderPaymentRequest
     */
     ...
     * Sets payment
     *
     * @param \OpenAPI\Client\Model\OrderPaymentRequest $payment payment
     *
     * @return self
     */
    ...
    public function setSplitAmountTotal($split_amount_total)
    {
        ...
        if (($split_amount_total < 0)) {
            throw new \InvalidArgumentException('invalid value for $split_amount_total when calling OrderCreateRequest., must be bigger than or equal to 0.');
        }
     ...
     * Gets session
     *
     * @return \OpenAPI\Client\Model\OrderCreateRequestSession|null
     */
     ...
     * Sets session
     *
     * @param \OpenAPI\Client\Model\OrderCreateRequestSession|null $session session
     *
     * @return self
     */
