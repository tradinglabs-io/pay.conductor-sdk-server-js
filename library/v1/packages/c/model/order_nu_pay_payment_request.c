...
cJSON *order_nu_pay_payment_request_convertToJSON(order_nu_pay_payment_request_t *order_nu_pay_payment_request) {
    ...
    if (payconductor_api_payment_method__NULL == order_nu_pay_payment_request->payment_method) {
        goto fail;
    }
    cJSON *payment_method_local_JSON = payment_method_convertToJSON(order_nu_pay_payment_request->payment_method);
...
order_nu_pay_payment_request_t *order_nu_pay_payment_request_parseFromJSON(cJSON *order_nu_pay_payment_requestJSON){
    ...
    // define the local variable for order_nu_pay_payment_request->payment_method
